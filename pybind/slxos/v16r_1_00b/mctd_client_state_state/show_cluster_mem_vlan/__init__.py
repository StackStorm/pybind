...
class show_cluster_mem_vlan(PybindBase):
  ...
  from YANG module brocade-mct-operational - based on the path /mctd-client-state-state/show-cluster-mem-vlan. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__num_vlans = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="num-vlans", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mct-operational', defining_module='brocade-mct-operational', yang_type='uint32', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'mctd-client-state-state', u'show-cluster-mem-vlan']
  ...
  def _get_cluster_id(self):
    """
    Getter method for cluster_id, mapped from YANG variable /mctd_client_state_state/show_cluster_mem_vlan/cluster_id (uint32)
  ...
  def _set_cluster_id(self, v, load=False):
    """
    Setter method for cluster_id, mapped from YANG variable /mctd_client_state_state/show_cluster_mem_vlan/cluster_id (uint32)
  ...
  def _get_num_vlans(self):
    """
    Getter method for num_vlans, mapped from YANG variable /mctd_client_state_state/show_cluster_mem_vlan/num_vlans (uint32)
  ...
  def _set_num_vlans(self, v, load=False):
    """
    Setter method for num_vlans, mapped from YANG variable /mctd_client_state_state/show_cluster_mem_vlan/num_vlans (uint32)
    If this variable is read-only (config: false) in the
    ...
    """
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="num-vlans", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mct-operational', defining_module='brocade-mct-operational', yang_type='uint32', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """num_vlans must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="num-vlans", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mct-operational', defining_module='brocade-mct-operational', yang_type='uint32', is_config=False)""",
        })
  ...
  def _get_vlan_label_info(self):
    """
    Getter method for vlan_label_info, mapped from YANG variable /mctd_client_state_state/show_cluster_mem_vlan/vlan_label_info (container)
  ...
  def _set_vlan_label_info(self, v, load=False):
    """
    Setter method for vlan_label_info, mapped from YANG variable /mctd_client_state_state/show_cluster_mem_vlan/vlan_label_info (container)
    If this variable is read-only (config: false) in the
