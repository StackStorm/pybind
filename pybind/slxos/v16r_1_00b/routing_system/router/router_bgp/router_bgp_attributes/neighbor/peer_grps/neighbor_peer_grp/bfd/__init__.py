...
class bfd(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/router-bgp-attributes/neighbor/peer-grps/neighbor-peer-grp/bfd. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'router-bgp-attributes', u'neighbor', u'peer-grps', u'neighbor-peer-grp', u'bfd']
  ...
  def _get_bfd_enable(self):
    """
    Getter method for bfd_enable, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/bfd/bfd_enable (empty)
    """
    return self.__bfd_enable
      
  def _set_bfd_enable(self, v, load=False):
    """
    Setter method for bfd_enable, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/bfd/bfd_enable (empty)
  ...
  def _get_holdover_interval(self):
    """
    Getter method for holdover_interval, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/bfd/holdover_interval (bfd:bfd-holdover-interval)
    """
    return self.__holdover_interval
      
  def _set_holdover_interval(self, v, load=False):
    """
    Setter method for holdover_interval, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/bfd/holdover_interval (bfd:bfd-holdover-interval)
    If this variable is read-only (config: false) in the
  ...
  def _get_interval(self):
    """
    Getter method for interval, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/bfd/interval (container)
  ...
  def _set_interval(self, v, load=False):
    """
    Setter method for interval, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/bfd/interval (container)
    If this variable is read-only (config: false) in the
