...
class update_source(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/router-bgp-attributes/neighbor/peer-grps/neighbor-peer-grp/update-source. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'router-bgp-attributes', u'neighbor', u'peer-grps', u'neighbor-peer-grp', u'update-source']
  ...
  def _set_sip_ipv4_address(self, v, load=False):
    """
    Setter method for sip_ipv4_address, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/update_source/sip_ipv4_address (sip-ipv4-address)
  ...
  def _set_ethernet_interface(self, v, load=False):
    """
    Setter method for ethernet_interface, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/update_source/ethernet_interface (container)
    If this variable is read-only (config: false) in the
  ...
  def _set_loopback(self, v, load=False):
    """
    Setter method for loopback, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/update_source/loopback (loopback-interface)
    If this variable is read-only (config: false) in the
  ...
  def _set_ve_interface(self, v, load=False):
    """
    Setter method for ve_interface, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/update_source/ve_interface (interface:ve-type)
    If this variable is read-only (config: false) in the
