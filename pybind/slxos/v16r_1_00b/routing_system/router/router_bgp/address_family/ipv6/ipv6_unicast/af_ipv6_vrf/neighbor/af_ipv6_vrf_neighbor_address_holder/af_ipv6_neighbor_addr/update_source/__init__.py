...
class update_source(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv6/ipv6-unicast/af-ipv6-vrf/neighbor/af-ipv6-vrf-neighbor-address-holder/af-ipv6-neighbor-addr/update-source. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__sip_ipv6_address','__ethernet_interface','__loopback','__ve_interface',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'ipv6', u'ipv6-unicast', u'af-ipv6-vrf', u'neighbor', u'af-ipv6-vrf-neighbor-address-holder', u'af-ipv6-neighbor-addr', u'update-source']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'ipv6', u'unicast', u'vrf', u'neighbor', u'update-source']

  def _get_sip_ipv6_address(self):
    """
    Getter method for sip_ipv6_address, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/update_source/sip_ipv6_address (sip-ipv6-address)
    """
    return self.__sip_ipv6_address
      
  def _set_sip_ipv6_address(self, v, load=False):
    """
    Setter method for sip_ipv6_address, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/update_source/sip_ipv6_address (sip-ipv6-address)
  ...
  def _get_ethernet_interface(self):
    """
    Getter method for ethernet_interface, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/update_source/ethernet_interface (container)
    """
    return self.__ethernet_interface
      
  def _set_ethernet_interface(self, v, load=False):
    """
    Setter method for ethernet_interface, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/update_source/ethernet_interface (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_loopback(self):
    """
    Getter method for loopback, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/update_source/loopback (loopback-interface)
    """
    return self.__loopback
      
  def _set_loopback(self, v, load=False):
    """
    Setter method for loopback, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/update_source/loopback (loopback-interface)
    If this variable is read-only (config: false) in the
  ...
  def _get_ve_interface(self):
    """
    Getter method for ve_interface, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/update_source/ve_interface (interface:ve-type)
    """
    return self.__ve_interface
      
  def _set_ve_interface(self, v, load=False):
    """
    Setter method for ve_interface, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/update_source/ve_interface (interface:ve-type)
    If this variable is read-only (config: false) in the
  ...
  __choices__ = {u'ch-update-source': {u'ca-eth': [u'ethernet_interface'], u'ca-ipv6': [u'sip_ipv6_address'], u'ca-ve': [u've_interface'], u'ca-loopback': [u'loopback']}}
  _pyangbind_elements = {'sip_ipv6_address': sip_ipv6_address, 'ethernet_interface': ethernet_interface, 'loopback': loopback, 've_interface': ve_interface, }
