...
class snooping(PybindBase):
  ...
  from YANG module brocade-mld-snooping - based on the path /mld-snooping/ipv6/mld/snooping. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'mld-snooping', u'ipv6', u'mld', u'snooping']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'ipv6', u'mld', u'snooping']

  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /mld_snooping/ipv6/mld/snooping/enable (empty)
    """
    return self.__enable
      
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /mld_snooping/ipv6/mld/snooping/enable (empty)
