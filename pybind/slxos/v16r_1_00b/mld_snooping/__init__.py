...
import __builtin__
import ipv6
class mld_snooping(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mld-snooping - based on the path /mld-snooping. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__ipv6',)

  _yang_name = 'mld-snooping'
  ...
  def _get_ipv6(self):
    """
    Getter method for ipv6, mapped from YANG variable /mld_snooping/ipv6 (container)
    """
    return self.__ipv6
      
  def _set_ipv6(self, v, load=False):
    """
    Setter method for ipv6, mapped from YANG variable /mld_snooping/ipv6 (container)
