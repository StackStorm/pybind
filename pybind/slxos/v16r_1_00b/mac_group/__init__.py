...
import __builtin__
import mac_group_entry
class mac_group(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mac-address-table - based on the path /mac-group. Each member element of
  ...
  def _get_mac_group_id(self):
    """
    Getter method for mac_group_id, mapped from YANG variable /mac_group/mac_group_id (interface:mac-group-id-type)
    """
    return self.__mac_group_id
      
  def _set_mac_group_id(self, v, load=False):
    """
    Setter method for mac_group_id, mapped from YANG variable /mac_group/mac_group_id (interface:mac-group-id-type)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_mac_group_id is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_mac_group_id() directly.
    """
  ...
  def _get_mac_group_entry(self):
    """
    Getter method for mac_group_entry, mapped from YANG variable /mac_group/mac_group_entry (list)
    """
    return self.__mac_group_entry
  ...
  _pyangbind_elements = {'mac_group_id': mac_group_id, 'mac_group_entry': mac_group_entry, }
