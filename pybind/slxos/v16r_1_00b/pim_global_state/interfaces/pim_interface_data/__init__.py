...
class pim_interface_data(PybindBase):
  ...
  _pyangbind_elements = {'interface_name': interface_name, 'interface_type': interface_type, 'enable_status': enable_status, 'local_ip_addr': local_ip_addr, 'pim_version': pim_version, 'mode': mode, 'dr_info': dr_info, 'ttl_threshold': ttl_threshold, 'multicast_boundry': multicast_boundry, 'dr_priority': dr_priority, }
