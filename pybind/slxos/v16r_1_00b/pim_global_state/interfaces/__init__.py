...
class interfaces(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__interface_name','__pim_interface_data',)
  ...
  def _get_interface_name(self):
    """
    Getter method for interface_name, mapped from YANG variable /pim_global_state/interfaces/interface_name (string)
  ...
  def _set_interface_name(self, v, load=False):
    """
    Setter method for interface_name, mapped from YANG variable /pim_global_state/interfaces/interface_name (string)
  ...
  _pyangbind_elements = {'interface_name': interface_name, 'pim_interface_data': pim_interface_data, }
