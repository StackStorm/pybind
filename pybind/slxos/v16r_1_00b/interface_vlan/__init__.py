...
elements of this managed device.
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /interface_vlan/vlan (list)
...
to this list.
  ...
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /interface_vlan/vlan (list)
