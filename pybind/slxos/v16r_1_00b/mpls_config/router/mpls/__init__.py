...
import __builtin__
import mpls_cmds_holder
class mpls(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls - based on the path /mpls-config/router/mpls. Each member element of
  ...
  def _get_mpls_cmds_holder(self):
    """
    Getter method for mpls_cmds_holder, mapped from YANG variable /mpls_config/router/mpls/mpls_cmds_holder (container)
    """
    return self.__mpls_cmds_holder
      
  def _set_mpls_cmds_holder(self, v, load=False):
    """
    Setter method for mpls_cmds_holder, mapped from YANG variable /mpls_config/router/mpls/mpls_cmds_holder (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_mpls_cmds_holder is considered as a private
  ...
  _pyangbind_elements = {'mpls_cmds_holder': mpls_cmds_holder, }
