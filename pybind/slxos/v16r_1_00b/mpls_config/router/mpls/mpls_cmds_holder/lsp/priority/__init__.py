...
class priority(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /mpls-config/router/mpls/mpls-cmds-holder/lsp/priority. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__lsp_setup_priority','__lsp_hold_priority',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'mpls-config', u'router', u'mpls', u'mpls-cmds-holder', u'lsp', u'priority']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'mpls', u'lsp', u'priority']

  def _get_lsp_setup_priority(self):
    """
    Getter method for lsp_setup_priority, mapped from YANG variable /mpls_config/router/mpls/mpls_cmds_holder/lsp/priority/lsp_setup_priority (uint32)
    """
    return self.__lsp_setup_priority
      
  def _set_lsp_setup_priority(self, v, load=False):
    """
    Setter method for lsp_setup_priority, mapped from YANG variable /mpls_config/router/mpls/mpls_cmds_holder/lsp/priority/lsp_setup_priority (uint32)
  ...
  def _get_lsp_hold_priority(self):
    """
    Getter method for lsp_hold_priority, mapped from YANG variable /mpls_config/router/mpls/mpls_cmds_holder/lsp/priority/lsp_hold_priority (uint32)
    """
    return self.__lsp_hold_priority
      
  def _set_lsp_hold_priority(self, v, load=False):
    """
    Setter method for lsp_hold_priority, mapped from YANG variable /mpls_config/router/mpls/mpls_cmds_holder/lsp/priority/lsp_hold_priority (uint32)
    If this variable is read-only (config: false) in the
