...
class bundle_message(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /mpls-config/router/mpls/mpls-cmds-holder/mpls-interface/rsvp/interface-refresh-reduction/bundle-message. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'mpls-config', u'router', u'mpls', u'mpls-cmds-holder', u'mpls-interface', u'rsvp', u'interface-refresh-reduction', u'bundle-message']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'mpls', u'mpls-interface', u'rsvp', u'refresh-reduction', u'bundle-message']

  def _get_bundle_send_delay(self):
    """
    Getter method for bundle_send_delay, mapped from YANG variable /mpls_config/router/mpls/mpls_cmds_holder/mpls_interface/rsvp/interface_refresh_reduction/bundle_message/bundle_send_delay (uint32)
    """
    return self.__bundle_send_delay
      
  def _set_bundle_send_delay(self, v, load=False):
    """
    Setter method for bundle_send_delay, mapped from YANG variable /mpls_config/router/mpls/mpls_cmds_holder/mpls_interface/rsvp/interface_refresh_reduction/bundle_message/bundle_send_delay (uint32)
