...
class soft_preemption(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__cleanup_timer',)

  _yang_name = 'soft-preemption'
  _rest_name = 'soft-preemption'
