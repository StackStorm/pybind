...
class router(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /mpls-config/router. Each member element of
  ...
  def _get_mpls(self):
    """
    Getter method for mpls, mapped from YANG variable /mpls_config/router/mpls (container)
    """
    return self.__mpls
      
  def _set_mpls(self, v, load=False):
    """
    Setter method for mpls, mapped from YANG variable /mpls_config/router/mpls (container)
