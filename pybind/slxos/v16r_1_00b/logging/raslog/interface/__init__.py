...
class interface(PybindBase):
  ...
  from YANG module brocade-ras - based on the path /logging/raslog/interface. Each member element of
  ...
  def _get_description(self):
    """
    Getter method for description, mapped from YANG variable /logging/raslog/interface/description (empty)
    """
    return self.__description
      
  def _set_description(self, v, load=False):
    """
    Setter method for description, mapped from YANG variable /logging/raslog/interface/description (empty)
  ...
  _pyangbind_elements = {'description': description, }
