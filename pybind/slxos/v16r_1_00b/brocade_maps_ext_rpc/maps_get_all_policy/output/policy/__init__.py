...
class policy(PybindBase):
  ...
  from YANG module brocade-maps-ext - based on the path /brocade_maps_ext_rpc/maps-get-all-policy/output/policy. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__policyname',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_maps_ext_rpc', u'maps-get-all-policy', u'output', u'policy']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'maps-get-all-policy', u'output', u'policy']

  def _get_policyname(self):
    """
    Getter method for policyname, mapped from YANG variable /brocade_maps_ext_rpc/maps_get_all_policy/output/policy/policyname (string)
  ...
  def _set_policyname(self, v, load=False):
    """
    Setter method for policyname, mapped from YANG variable /brocade_maps_ext_rpc/maps_get_all_policy/output/policy/policyname (string)
  ...
  _pyangbind_elements = {'policyname': policyname, }
