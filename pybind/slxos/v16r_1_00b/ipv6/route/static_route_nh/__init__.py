...
class static_route_nh(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /ipv6/route/static-route-nh. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'ipv6', u'route', u'static-route-nh']
  ...
  def _set_static_route_dest(self, v, load=False):
    """
    Setter method for static_route_dest, mapped from YANG variable /ipv6/route/static_route_nh/static_route_dest (inet:ipv6-prefix)
  ...
  def _set_static_route_next_hop(self, v, load=False):
    """
    Setter method for static_route_next_hop, mapped from YANG variable /ipv6/route/static_route_nh/static_route_next_hop (inet:ipv6-address)
    If this variable is read-only (config: false) in the
  ...
  def _set_route_attributes(self, v, load=False):
    """
    Setter method for route_attributes, mapped from YANG variable /ipv6/route/static_route_nh/route_attributes (container)
    If this variable is read-only (config: false) in the
