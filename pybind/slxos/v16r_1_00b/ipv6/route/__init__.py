...
class route(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /ipv6/route. Each member element of
  ...
  def _set_static_route_nh(self, v, load=False):
    """
    Setter method for static_route_nh, mapped from YANG variable /ipv6/route/static_route_nh (list)
  ...
  def _set_static_route_oif(self, v, load=False):
    """
    Setter method for static_route_oif, mapped from YANG variable /ipv6/route/static_route_oif (list)
    If this variable is read-only (config: false) in the
  ...
  def _set_link_local_static_route_nh(self, v, load=False):
    """
    Setter method for link_local_static_route_nh, mapped from YANG variable /ipv6/route/link_local_static_route_nh (list)
    If this variable is read-only (config: false) in the
  ...
  def _set_static_route_nh_vrf(self, v, load=False):
    """
    Setter method for static_route_nh_vrf, mapped from YANG variable /ipv6/route/static_route_nh_vrf (list)
    If this variable is read-only (config: false) in the
  ...
  def _set_link_local_static_route_nh_vrf(self, v, load=False):
    """
    Setter method for link_local_static_route_nh_vrf, mapped from YANG variable /ipv6/route/link_local_static_route_nh_vrf (list)
    If this variable is read-only (config: false) in the
  ...
  def _set_ipv6_static_route_oif_vrf(self, v, load=False):
    """
    Setter method for ipv6_static_route_oif_vrf, mapped from YANG variable /ipv6/route/ipv6_static_route_oif_vrf (list)
    If this variable is read-only (config: false) in the
  ...
  def _set_static(self, v, load=False):
    """
    Setter method for static, mapped from YANG variable /ipv6/route/static (container)
    If this variable is read-only (config: false) in the
