...
class rx_queue(PybindBase):
  ...
  from YANG module brocade-qos-mls - based on the path /qos/rx-queue. Each member element of
  ...
  def _get_rx_queue_limit(self):
    """
    Getter method for rx_queue_limit, mapped from YANG variable /qos/rx_queue/rx_queue_limit (uint32)
    """
    return self.__rx_queue_limit
      
  def _set_rx_queue_limit(self, v, load=False):
    """
    Setter method for rx_queue_limit, mapped from YANG variable /qos/rx_queue/rx_queue_limit (uint32)
  ...
  _pyangbind_elements = {'rx_queue_limit': rx_queue_limit, }
