...
import __builtin__
import to
class dscp_to_cos_mapping(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-qos-mls - based on the path /qos/map/dscp-cos/dscp-to-cos-mapping. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__dscp_in_values','__to',)

  _yang_name = 'dscp-to-cos-mapping'
  _rest_name = 'map'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'map', u'dscp-cos', u'dscp-to-cos-mapping']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'map', u'dscp-cos', u'map']
  ...
  def _set_dscp_in_values(self, v, load=False):
    """
    Setter method for dscp_in_values, mapped from YANG variable /qos/map/dscp_cos/dscp_to_cos_mapping/dscp_in_values (dscp-id-range-type)
  ...
  def _set_to(self, v, load=False):
    """
    Setter method for to, mapped from YANG variable /qos/map/dscp_cos/dscp_to_cos_mapping/to (container)
    If this variable is read-only (config: false) in the
