...
class to(PybindBase):
  ...
  from YANG module brocade-qos-mls - based on the path /qos/map/dscp-cos/dscp-to-cos-mapping/to. Each member element of
  ...
  def _set_to_value(self, v, load=False):
    """
    Setter method for to_value, mapped from YANG variable /qos/map/dscp_cos/dscp_to_cos_mapping/to/to_value (cos-id-type)
