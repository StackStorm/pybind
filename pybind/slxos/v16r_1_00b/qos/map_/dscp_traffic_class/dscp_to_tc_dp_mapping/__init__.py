...
import __builtin__
import to
class dscp_to_tc_dp_mapping(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-qos-mls - based on the path /qos/map/dscp-traffic-class/dscp-to-tc-dp-mapping. Each member element of
  ...
  def _get_dscp_in_values(self):
    """
    Getter method for dscp_in_values, mapped from YANG variable /qos/map/dscp_traffic_class/dscp_to_tc_dp_mapping/dscp_in_values (dscp-id-range-type)
    """
    return self.__dscp_in_values
      
  def _set_dscp_in_values(self, v, load=False):
    """
    Setter method for dscp_in_values, mapped from YANG variable /qos/map/dscp_traffic_class/dscp_to_tc_dp_mapping/dscp_in_values (dscp-id-range-type)
  ...
  def _get_to(self):
    """
    Getter method for to, mapped from YANG variable /qos/map/dscp_traffic_class/dscp_to_tc_dp_mapping/to (container)
    """
    return self.__to
      
  def _set_to(self, v, load=False):
    """
    Setter method for to, mapped from YANG variable /qos/map/dscp_traffic_class/dscp_to_tc_dp_mapping/to (container)
    If this variable is read-only (config: false) in the
