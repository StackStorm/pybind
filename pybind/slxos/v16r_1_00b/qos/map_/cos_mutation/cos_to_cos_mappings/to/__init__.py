...
class to(PybindBase):
  ...
  from YANG module brocade-qos-mls - based on the path /qos/map/cos-mutation/cos-to-cos-mappings/to. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__to_cos',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'map', u'cos-mutation', u'cos-to-cos-mappings', u'to']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'map', u'cos-mutation', u'map', u'to']
  ...
  def _set_to_cos(self, v, load=False):
    """
    Setter method for to_cos, mapped from YANG variable /qos/map/cos_mutation/cos_to_cos_mappings/to/to_cos (cos-id-type)
