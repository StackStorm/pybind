...
import __builtin__
import to
class cos_to_cos_mappings(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-qos-mls - based on the path /qos/map/cos-mutation/cos-to-cos-mappings. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__from_cos','__to',)

  _yang_name = 'cos-to-cos-mappings'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'map', u'cos-mutation', u'cos-to-cos-mappings']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'map', u'cos-mutation', u'map']
  ...
  def _set_from_cos(self, v, load=False):
    """
    Setter method for from_cos, mapped from YANG variable /qos/map/cos_mutation/cos_to_cos_mappings/from_cos (cos-id-type)
  ...
  def _set_to(self, v, load=False):
    """
    Setter method for to, mapped from YANG variable /qos/map/cos_mutation/cos_to_cos_mappings/to (container)
    If this variable is read-only (config: false) in the
