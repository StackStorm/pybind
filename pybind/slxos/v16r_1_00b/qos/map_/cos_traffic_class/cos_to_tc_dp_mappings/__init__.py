...
import __builtin__
import to
class cos_to_tc_dp_mappings(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-qos-mls - based on the path /qos/map/cos-traffic-class/cos-to-tc-dp-mappings. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__from_cos','__to',)

  _yang_name = 'cos-to-tc-dp-mappings'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'map', u'cos-traffic-class', u'cos-to-tc-dp-mappings']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'map', u'cos-traffic-class', u'map']
  ...
  def _get_from_cos(self):
    ...
    """
    return self.__from_cos
      
  def _set_from_cos(self, v, load=False):
    """
    Setter method for from_cos, mapped from YANG variable /qos/map/cos_traffic_class/cos_to_tc_dp_mappings/from_cos (cos-id-type)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_from_cos is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_from_cos() directly.
    """
    ...
    try:
      ...
      raise ValueError({
          'error-string': """from_cos must be of a type compatible with cos-id-type""",
  ...
  def _set_to(self, v, load=False):
    """
    Setter method for to, mapped from YANG variable /qos/map/cos_traffic_class/cos_to_tc_dp_mappings/to (container)
    If this variable is read-only (config: false) in the
  ...
  from_cos = __builtin__.property(_get_from_cos, _set_from_cos)
  to = __builtin__.property(_get_to, _set_to)


  _pyangbind_elements = {'from_cos': from_cos, 'to': to, }
