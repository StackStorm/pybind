...
import __builtin__
import to
class dscp_to_dscp_mapping(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-qos-mls - based on the path /qos/map/dscp-mutation/dscp-to-dscp-mapping. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__dscp_in_values','__to',)

  _yang_name = 'dscp-to-dscp-mapping'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'map', u'dscp-mutation', u'dscp-to-dscp-mapping']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'map', u'dscp-mutation', u'map']
  ...
  def _set_dscp_in_values(self, v, load=False):
    """
    Setter method for dscp_in_values, mapped from YANG variable /qos/map/dscp_mutation/dscp_to_dscp_mapping/dscp_in_values (dscp-id-range-type)
  ...
  def _set_to(self, v, load=False):
    """
    Setter method for to, mapped from YANG variable /qos/map/dscp_mutation/dscp_to_dscp_mapping/to (container)
    If this variable is read-only (config: false) in the
