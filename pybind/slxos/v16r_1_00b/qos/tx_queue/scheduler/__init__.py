...
class scheduler(PybindBase):
  ...
  from YANG module brocade-qos-mls - based on the path /qos/tx-queue/scheduler. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'tx-queue', u'scheduler']
  ...
  def _get_strict_priority(self):
    """
    Getter method for strict_priority, mapped from YANG variable /qos/tx_queue/scheduler/strict_priority (container)
    """
    return self.__strict_priority
      
  def _set_strict_priority(self, v, load=False):
    """
    Setter method for strict_priority, mapped from YANG variable /qos/tx_queue/scheduler/strict_priority (container)
