...
import __builtin__
import module
class heavy(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-bprate-limit - based on the path /bp-rate-limit/heavy. Each member element of
  ...
  def _get_module(self):
    """
    Getter method for module, mapped from YANG variable /bp_rate_limit/heavy/module (container)
    """
    return self.__module
      
  def _set_module(self, v, load=False):
    """
    Setter method for module, mapped from YANG variable /bp_rate_limit/heavy/module (container)
