...
class bp_rate_limit(PybindBase):
  ...
  from YANG module brocade-bprate-limit - based on the path /bp-rate-limit. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__heavy',)
  ...
  def _get_heavy(self):
    """
    Getter method for heavy, mapped from YANG variable /bp_rate_limit/heavy (container)
    """
    return self.__heavy
      
  def _set_heavy(self, v, load=False):
    """
    Setter method for heavy, mapped from YANG variable /bp_rate_limit/heavy (container)
  ...
  _pyangbind_elements = {'heavy': heavy, }
