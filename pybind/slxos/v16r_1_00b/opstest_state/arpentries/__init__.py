...
import __builtin__
import arpe
class arpentries(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-opstest - based on the path /opstest-state/arpentries. Each member element of
  ...
  def _get_arpe(self):
    """
    Getter method for arpe, mapped from YANG variable /opstest_state/arpentries/arpe (list)
    """
    return self.__arpe
      
  def _set_arpe(self, v, load=False):
    """
    Setter method for arpe, mapped from YANG variable /opstest_state/arpentries/arpe (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_arpe is considered as a private
