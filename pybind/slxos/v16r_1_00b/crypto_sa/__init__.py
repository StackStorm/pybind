...
import __builtin__
import crypto
class crypto_sa(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-crypto - based on the path /crypto-sa. Each member element of
  ...
  def _get_crypto(self):
    """
    Getter method for crypto, mapped from YANG variable /crypto_sa/crypto (container)
    """
    return self.__crypto
      
  def _set_crypto(self, v, load=False):
    """
    Setter method for crypto, mapped from YANG variable /crypto_sa/crypto (container)
