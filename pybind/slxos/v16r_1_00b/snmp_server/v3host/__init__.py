...
class v3host(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__hostip','__username','__udp_port','__notifytype','__engineid','__severity_level','__use_vrf',)
  ...
  _pyangbind_elements = {'hostip': hostip, 'username': username, 'udp_port': udp_port, 'notifytype': notifytype, 'engineid': engineid, 'severity_level': severity_level, 'use_vrf': use_vrf, }
