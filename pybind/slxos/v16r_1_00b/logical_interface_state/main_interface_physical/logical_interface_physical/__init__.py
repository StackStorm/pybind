...
class logical_interface_physical(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__logical_interface_name','__source_type','__protocol_status','__admin_status','__lif_index','__bridge_domain_index','__interface_name','__is_binded','__outer_vlan_id','__inner_vlan_id','__intf_type','__is_tagged',)
