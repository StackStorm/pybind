...
class alias(PybindBase):
  ...
  from YANG module brocade-zone - based on the path /zoning/defined-configuration/alias. Each member element of
  ...
  def _get_alias_name(self):
    """
    Getter method for alias_name, mapped from YANG variable /zoning/defined_configuration/alias/alias_name (string)
    """
    return self.__alias_name
      
  def _set_alias_name(self, v, load=False):
    """
    Setter method for alias_name, mapped from YANG variable /zoning/defined_configuration/alias/alias_name (string)
  ...
  def _get_member_entry(self):
    """
    Getter method for member_entry, mapped from YANG variable /zoning/defined_configuration/alias/member_entry (list)
    """
    return self.__member_entry
      
  def _set_member_entry(self, v, load=False):
    """
    Setter method for member_entry, mapped from YANG variable /zoning/defined_configuration/alias/member_entry (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'alias_name': alias_name, 'member_entry': member_entry, }
