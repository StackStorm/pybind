...
class vc_assigned_lsp(PybindBase):
  ...
  from YANG module brocade-pwm-operational - based on the path /vc-peer-state/vc-peer-data/vc-assigned-lsp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vc-peer-state', u'vc-peer-data', u'vc-assigned-lsp']
  ...
  def _get_vc_lsp_name(self):
    """
    Getter method for vc_lsp_name, mapped from YANG variable /vc_peer_state/vc_peer_data/vc_assigned_lsp/vc_lsp_name (string)
  ...
  def _set_vc_lsp_name(self, v, load=False):
    """
    Setter method for vc_lsp_name, mapped from YANG variable /vc_peer_state/vc_peer_data/vc_assigned_lsp/vc_lsp_name (string)
