...
import __builtin__
import show_mpls_lsp_extensive_info
class bypass_lsp(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-bypass-lsp-name-extensive/output/bypass-lsp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-bypass-lsp-name-extensive', u'output', u'bypass-lsp']
  ...
  def _get_show_mpls_lsp_extensive_info(self):
    """
    Getter method for show_mpls_lsp_extensive_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_lsp_name_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info (container)
    """
    return self.__show_mpls_lsp_extensive_info
      
  def _set_show_mpls_lsp_extensive_info(self, v, load=False):
    """
    Setter method for show_mpls_lsp_extensive_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_lsp_name_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info (container)
  ...
  _pyangbind_elements = {'show_mpls_lsp_extensive_info': show_mpls_lsp_extensive_info, }
