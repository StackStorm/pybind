...
class output(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-bypass-lsp-name-extensive/output. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-bypass-lsp-name-extensive', u'output']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'show-mpls-bypass-lsp-name-extensive', u'output']

  def _get_bypass_lsp(self):
    """
    Getter method for bypass_lsp, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_lsp_name_extensive/output/bypass_lsp (container)
    """
    return self.__bypass_lsp
      
  def _set_bypass_lsp(self, v, load=False):
    """
    Setter method for bypass_lsp, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_lsp_name_extensive/output/bypass_lsp (container)
