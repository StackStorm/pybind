...
class lsp_rsvp_session_rro_hops(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-lsp-detail/output/lsp/show-mpls-lsp-detail-info/show-mpls-lsp-instances-info/lsp-instances/lsp-rsvp-session-rro-hops. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-lsp-detail', u'output', u'lsp', u'show-mpls-lsp-detail-info', u'show-mpls-lsp-instances-info', u'lsp-instances', u'lsp-rsvp-session-rro-hops']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'show-mpls-lsp-detail', u'output', u'lsp', u'lsp-instances', u'lsp-rsvp-session-rro-hops']

  def _get_show_mpls_lsp_hop_list(self):
    """
    Getter method for show_mpls_lsp_hop_list, mapped from YANG variable /brocade_mpls_rpc/show_mpls_lsp_detail/output/lsp/show_mpls_lsp_detail_info/show_mpls_lsp_instances_info/lsp_instances/lsp_rsvp_session_rro_hops/show_mpls_lsp_hop_list (container)
    """
    return self.__show_mpls_lsp_hop_list
      
  def _set_show_mpls_lsp_hop_list(self, v, load=False):
    """
    Setter method for show_mpls_lsp_hop_list, mapped from YANG variable /brocade_mpls_rpc/show_mpls_lsp_detail/output/lsp/show_mpls_lsp_detail_info/show_mpls_lsp_instances_info/lsp_instances/lsp_rsvp_session_rro_hops/show_mpls_lsp_hop_list (container)
