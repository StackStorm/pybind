...
class lsp_admin_group(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-bypass-lsp-name-detail/output/bypass-lsp/show-mpls-lsp-detail-info/show-mpls-lsp-instances-info/lsp-instances/lsp-config-admin-groups/lsp-admin-group. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-bypass-lsp-name-detail', u'output', u'bypass-lsp', u'show-mpls-lsp-detail-info', u'show-mpls-lsp-instances-info', u'lsp-instances', u'lsp-config-admin-groups', u'lsp-admin-group']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'show-mpls-bypass-lsp-name-detail', u'output', u'bypass-lsp', u'lsp-instances', u'lsp-config-admin-groups']

  def _get_lsp_admin_group_exclude_any(self):
    """
    Getter method for lsp_admin_group_exclude_any, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_lsp_name_detail/output/bypass_lsp/show_mpls_lsp_detail_info/show_mpls_lsp_instances_info/lsp_instances/lsp_config_admin_groups/lsp_admin_group/lsp_admin_group_exclude_any (list)
    """
    return self.__lsp_admin_group_exclude_any
      
  def _set_lsp_admin_group_exclude_any(self, v, load=False):
    """
    Setter method for lsp_admin_group_exclude_any, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_lsp_name_detail/output/bypass_lsp/show_mpls_lsp_detail_info/show_mpls_lsp_instances_info/lsp_instances/lsp_config_admin_groups/lsp_admin_group/lsp_admin_group_exclude_any (list)
  ...
  def _get_lsp_admin_group_include_any(self):
    """
    Getter method for lsp_admin_group_include_any, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_lsp_name_detail/output/bypass_lsp/show_mpls_lsp_detail_info/show_mpls_lsp_instances_info/lsp_instances/lsp_config_admin_groups/lsp_admin_group/lsp_admin_group_include_any (list)
    """
    return self.__lsp_admin_group_include_any
      
  def _set_lsp_admin_group_include_any(self, v, load=False):
    """
    Setter method for lsp_admin_group_include_any, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_lsp_name_detail/output/bypass_lsp/show_mpls_lsp_detail_info/show_mpls_lsp_instances_info/lsp_instances/lsp_config_admin_groups/lsp_admin_group/lsp_admin_group_include_any (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_lsp_admin_group_include_all(self):
    """
    Getter method for lsp_admin_group_include_all, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_lsp_name_detail/output/bypass_lsp/show_mpls_lsp_detail_info/show_mpls_lsp_instances_info/lsp_instances/lsp_config_admin_groups/lsp_admin_group/lsp_admin_group_include_all (list)
    """
    return self.__lsp_admin_group_include_all
      
  def _set_lsp_admin_group_include_all(self, v, load=False):
    """
    Setter method for lsp_admin_group_include_all, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_lsp_name_detail/output/bypass_lsp/show_mpls_lsp_detail_info/show_mpls_lsp_instances_info/lsp_instances/lsp_config_admin_groups/lsp_admin_group/lsp_admin_group_include_all (list)
    If this variable is read-only (config: false) in the
