...
import __builtin__
import clear_mpls_bypass_lsp_out
class output(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/clear-mpls-bypass-lsp/output. Each member element of
  ...
  def _get_clear_mpls_bypass_lsp_out(self):
    ...
    """
    return self.__clear_mpls_bypass_lsp_out
      
  def _set_clear_mpls_bypass_lsp_out(self, v, load=False):
    """
    Setter method for clear_mpls_bypass_lsp_out, mapped from YANG variable /brocade_mpls_rpc/clear_mpls_bypass_lsp/output/clear_mpls_bypass_lsp_out (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_clear_mpls_bypass_lsp_out is considered as a private
  ...
  _pyangbind_elements = {'clear_mpls_bypass_lsp_out': clear_mpls_bypass_lsp_out, }
