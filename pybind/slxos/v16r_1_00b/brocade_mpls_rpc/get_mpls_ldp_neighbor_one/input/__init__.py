...
import __builtin__
import mpls_ldp_neighbor_one_input
class input(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/get-mpls-ldp-neighbor-one/input. Each member element of
  ...
  def _get_mpls_ldp_neighbor_one_input(self):
    """
    Getter method for mpls_ldp_neighbor_one_input, mapped from YANG variable /brocade_mpls_rpc/get_mpls_ldp_neighbor_one/input/mpls_ldp_neighbor_one_input (container)
    """
    return self.__mpls_ldp_neighbor_one_input
      
  def _set_mpls_ldp_neighbor_one_input(self, v, load=False):
    """
    Setter method for mpls_ldp_neighbor_one_input, mapped from YANG variable /brocade_mpls_rpc/get_mpls_ldp_neighbor_one/input/mpls_ldp_neighbor_one_input (container)
  ...
  _pyangbind_elements = {'mpls_ldp_neighbor_one_input': mpls_ldp_neighbor_one_input, }
