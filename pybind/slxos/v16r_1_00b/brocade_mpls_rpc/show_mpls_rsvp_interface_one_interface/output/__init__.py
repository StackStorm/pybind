...
class output(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-rsvp-interface-one-interface/output. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__mpls_rsvp_interface_detail',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__mpls_rsvp_interface_detail = YANGDynClass(base=mpls_rsvp_interface_detail.mpls_rsvp_interface_detail, is_container='container', yang_name="mpls-rsvp-interface-detail", rest_name="mpls-rsvp-interface-detail", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls', defining_module='brocade-mpls', yang_type='container', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-rsvp-interface-one-interface', u'output']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'show-mpls-rsvp-interface-one-interface', u'output']

  def _get_mpls_rsvp_interface_detail(self):
    """
    Getter method for mpls_rsvp_interface_detail, mapped from YANG variable /brocade_mpls_rpc/show_mpls_rsvp_interface_one_interface/output/mpls_rsvp_interface_detail (container)
    """
    return self.__mpls_rsvp_interface_detail
      
  def _set_mpls_rsvp_interface_detail(self, v, load=False):
    """
    Setter method for mpls_rsvp_interface_detail, mapped from YANG variable /brocade_mpls_rpc/show_mpls_rsvp_interface_one_interface/output/mpls_rsvp_interface_detail (container)
