...
class mpls_rsvp_session_wide(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-rsvp-session-wide/output/mpls-rsvp-session-wide. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__show_mpls_session_brief',)

  _yang_name = 'mpls-rsvp-session-wide'
  _rest_name = 'mpls-rsvp-session-wide'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-rsvp-session-wide', u'output', u'mpls-rsvp-session-wide']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'show-mpls-rsvp-session-wide', u'output', u'mpls-rsvp-session-wide']

  def _get_show_mpls_session_brief(self):
    """
    Getter method for show_mpls_session_brief, mapped from YANG variable /brocade_mpls_rpc/show_mpls_rsvp_session_wide/output/mpls_rsvp_session_wide/show_mpls_session_brief (container)
    """
    return self.__show_mpls_session_brief
      
  def _set_show_mpls_session_brief(self, v, load=False):
    """
    Setter method for show_mpls_session_brief, mapped from YANG variable /brocade_mpls_rpc/show_mpls_rsvp_session_wide/output/mpls_rsvp_session_wide/show_mpls_session_brief (container)
  ...
  _pyangbind_elements = {'show_mpls_session_brief': show_mpls_session_brief, }
