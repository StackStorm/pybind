...
class input(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-lsp-name-extensive/input. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__show_lsp_input_info',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-lsp-name-extensive', u'input']
  ...
  def _get_show_lsp_input_info(self):
    """
    Getter method for show_lsp_input_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_lsp_name_extensive/input/show_lsp_input_info (container)
    """
    return self.__show_lsp_input_info
      
  def _set_show_lsp_input_info(self, v, load=False):
    """
    Setter method for show_lsp_input_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_lsp_name_extensive/input/show_lsp_input_info (container)
