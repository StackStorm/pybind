...
class lsp(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-lsp-name-debug/output/lsp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-lsp-name-debug', u'output', u'lsp']
  ...
  def _get_show_mpls_lsp_extensive_info(self):
    """
    Getter method for show_mpls_lsp_extensive_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_lsp_name_debug/output/lsp/show_mpls_lsp_extensive_info (container)
    """
    return self.__show_mpls_lsp_extensive_info
      
  def _set_show_mpls_lsp_extensive_info(self, v, load=False):
    """
    Setter method for show_mpls_lsp_extensive_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_lsp_name_debug/output/lsp/show_mpls_lsp_extensive_info (container)
