...
class input(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-ldp-fec-prefix-prefix-filter/input. Each member element of
  ...
  def _get_ldp_fec_prefix_filter(self):
    """
    Getter method for ldp_fec_prefix_filter, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_fec_prefix_prefix_filter/input/ldp_fec_prefix_filter (boolean)

    YANG Description: Filter fec display using prefix-list
    """
    return self.__ldp_fec_prefix_filter
      
  def _set_ldp_fec_prefix_filter(self, v, load=False):
    """
    Setter method for ldp_fec_prefix_filter, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_fec_prefix_prefix_filter/input/ldp_fec_prefix_filter (boolean)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_ldp_fec_prefix_filter is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_ldp_fec_prefix_filter() directly.
  ...
  def _get_ldp_fec_prefix_filter_string(self):
    """
    Getter method for ldp_fec_prefix_filter_string, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_fec_prefix_prefix_filter/input/ldp_fec_prefix_filter_string (string)

    YANG Description: Prefix List name to filter display
    """
    return self.__ldp_fec_prefix_filter_string
      
  def _set_ldp_fec_prefix_filter_string(self, v, load=False):
    """
    Setter method for ldp_fec_prefix_filter_string, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_fec_prefix_prefix_filter/input/ldp_fec_prefix_filter_string (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_ldp_fec_prefix_filter_string is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_ldp_fec_prefix_filter_string() directly.
  ...
  _pyangbind_elements = {'ldp_fec_prefix_filter': ldp_fec_prefix_filter, 'ldp_fec_prefix_filter_string': ldp_fec_prefix_filter_string, }
