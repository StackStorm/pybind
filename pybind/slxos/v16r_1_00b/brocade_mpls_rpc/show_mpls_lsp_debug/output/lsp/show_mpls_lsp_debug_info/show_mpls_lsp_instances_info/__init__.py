...
class show_mpls_lsp_instances_info(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-lsp-debug/output/lsp/show-mpls-lsp-debug-info/show-mpls-lsp-instances-info. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-lsp-debug', u'output', u'lsp', u'show-mpls-lsp-debug-info', u'show-mpls-lsp-instances-info']
  ...
  def _get_lsp_instances(self):
    """
    Getter method for lsp_instances, mapped from YANG variable /brocade_mpls_rpc/show_mpls_lsp_debug/output/lsp/show_mpls_lsp_debug_info/show_mpls_lsp_instances_info/lsp_instances (list)
    """
    return self.__lsp_instances
      
  def _set_lsp_instances(self, v, load=False):
    """
    Setter method for lsp_instances, mapped from YANG variable /brocade_mpls_rpc/show_mpls_lsp_debug/output/lsp/show_mpls_lsp_debug_info/show_mpls_lsp_instances_info/lsp_instances (list)
