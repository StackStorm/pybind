...
class input(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/mpls-adjust-bandwidth-lsp/input. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'mpls-adjust-bandwidth-lsp', u'input']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'mpls-adjust-bandwidth-lsp', u'input']

  def _get_lsp_name(self):
    """
    Getter method for lsp_name, mapped from YANG variable /brocade_mpls_rpc/mpls_adjust_bandwidth_lsp/input/lsp_name (string)
  ...
  def _set_lsp_name(self, v, load=False):
    """
    Setter method for lsp_name, mapped from YANG variable /brocade_mpls_rpc/mpls_adjust_bandwidth_lsp/input/lsp_name (string)
