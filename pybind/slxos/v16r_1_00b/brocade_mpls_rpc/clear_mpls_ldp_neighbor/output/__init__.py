...
class output(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__clear_mpls_ldp_neighbor_out',)
  ...
  def _set_clear_mpls_ldp_neighbor_out(self, v, load=False):
    ...
    """
    try:
      t = YANGDynClass(v,base=clear_mpls_ldp_neighbor_out.clear_mpls_ldp_neighbor_out, is_container='container', yang_name="clear-mpls-ldp-neighbor-out", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls', defining_module='brocade-mpls', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """clear_mpls_ldp_neighbor_out must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=clear_mpls_ldp_neighbor_out.clear_mpls_ldp_neighbor_out, is_container='container', yang_name="clear-mpls-ldp-neighbor-out", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls', defining_module='brocade-mpls', yang_type='container', is_config=True)""",
        })
