...
class ldp_peer_brief_rec_list(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ldp_peer_id','__ldp_peer_lblspid','__ldp_peer_state',)

  _yang_name = 'ldp-peer-brief-rec-list'
  _rest_name = 'ldp-peer-brief-rec-list'
