...
import __builtin__
class ldp_peer_brief_rec_list(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-ldp-peer-br/output/ldp-peer-brief-rec-list. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__ldp_peer_id','__ldp_peer_lblspid','__ldp_peer_state',)

  _yang_name = 'ldp-peer-brief-rec-list'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-ldp-peer-br', u'output', u'ldp-peer-brief-rec-list']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'show-mpls-ldp-peer-br', u'output', u'ldp-peer-brief-rec-list']

  def _get_ldp_peer_id(self):
    """
    Getter method for ldp_peer_id, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_br/output/ldp_peer_brief_rec_list/ldp_peer_id (inet:ipv4-address)
  ...
  def _set_ldp_peer_id(self, v, load=False):
    """
    Setter method for ldp_peer_id, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_br/output/ldp_peer_brief_rec_list/ldp_peer_id (inet:ipv4-address)
  ...
  def _get_ldp_peer_lblspid(self):
    """
    Getter method for ldp_peer_lblspid, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_br/output/ldp_peer_brief_rec_list/ldp_peer_lblspid (uint32)
  ...
  def _set_ldp_peer_lblspid(self, v, load=False):
    """
    Setter method for ldp_peer_lblspid, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_br/output/ldp_peer_brief_rec_list/ldp_peer_lblspid (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_ldp_peer_state(self):
    """
    Getter method for ldp_peer_state, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_br/output/ldp_peer_brief_rec_list/ldp_peer_state (ldp-state-name)
  ...
  def _set_ldp_peer_state(self, v, load=False):
    """
    Setter method for ldp_peer_state, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_br/output/ldp_peer_brief_rec_list/ldp_peer_state (ldp-state-name)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'ldp_peer_id': ldp_peer_id, 'ldp_peer_lblspid': ldp_peer_lblspid, 'ldp_peer_state': ldp_peer_state, }
