...
import input
import output
class show_mpls_ldp_fec_vc_id(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-ldp-fec-vc-id. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__input','__output',)

  _yang_name = 'show-mpls-ldp-fec-vc-id'
  _rest_name = 'show-mpls-ldp-fec-vc-id'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-ldp-fec-vc-id']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'show-mpls-ldp-fec-vc-id']
  ...
  def _set_input(self, v, load=False):
    """
    Setter method for input, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_fec_vc_id/input (input)
  ...
  def _set_output(self, v, load=False):
    """
    Setter method for output, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_fec_vc_id/output (output)
    If this variable is read-only (config: false) in the
