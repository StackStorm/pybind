...
class input(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-ldp-fec-vc-id/input. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ldp_fec_vc_id',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-ldp-fec-vc-id', u'input']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'show-mpls-ldp-fec-vc-id', u'input']

  def _get_ldp_fec_vc_id(self):
    """
    Getter method for ldp_fec_vc_id, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_fec_vc_id/input/ldp_fec_vc_id (uint32)
  ...
  def _set_ldp_fec_vc_id(self, v, load=False):
    """
    Setter method for ldp_fec_vc_id, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_fec_vc_id/input/ldp_fec_vc_id (uint32)
  ...
  _pyangbind_elements = {'ldp_fec_vc_id': ldp_fec_vc_id, }
