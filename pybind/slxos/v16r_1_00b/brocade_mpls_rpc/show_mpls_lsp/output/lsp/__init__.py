...
class lsp(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-lsp/output/lsp. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__show_mpls_lsp_basic_info',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-lsp', u'output', u'lsp']
  ...
  def _get_show_mpls_lsp_basic_info(self):
    """
    Getter method for show_mpls_lsp_basic_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_lsp/output/lsp/show_mpls_lsp_basic_info (container)
    """
    return self.__show_mpls_lsp_basic_info
      
  def _set_show_mpls_lsp_basic_info(self, v, load=False):
    """
    Setter method for show_mpls_lsp_basic_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_lsp/output/lsp/show_mpls_lsp_basic_info (container)
  ...
  _pyangbind_elements = {'show_mpls_lsp_basic_info': show_mpls_lsp_basic_info, }
