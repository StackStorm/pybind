...
class input(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-lsp-name-detail/input. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-lsp-name-detail', u'input']
  ...
  def _get_show_lsp_input_info(self):
    """
    Getter method for show_lsp_input_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_lsp_name_detail/input/show_lsp_input_info (container)
    """
    return self.__show_lsp_input_info
      
  def _set_show_lsp_input_info(self, v, load=False):
    """
    Setter method for show_lsp_input_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_lsp_name_detail/input/show_lsp_input_info (container)
