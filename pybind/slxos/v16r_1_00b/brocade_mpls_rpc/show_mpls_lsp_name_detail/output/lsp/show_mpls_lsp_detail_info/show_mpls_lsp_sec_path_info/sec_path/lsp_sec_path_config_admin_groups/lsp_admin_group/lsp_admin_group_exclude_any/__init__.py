...
class lsp_admin_group_exclude_any(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-lsp-name-detail/output/lsp/show-mpls-lsp-detail-info/show-mpls-lsp-sec-path-info/sec-path/lsp-sec-path-config-admin-groups/lsp-admin-group/lsp-admin-group-exclude-any. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-lsp-name-detail', u'output', u'lsp', u'show-mpls-lsp-detail-info', u'show-mpls-lsp-sec-path-info', u'sec-path', u'lsp-sec-path-config-admin-groups', u'lsp-admin-group', u'lsp-admin-group-exclude-any']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'show-mpls-lsp-name-detail', u'output', u'lsp', u'sec-path', u'lsp-sec-path-config-admin-groups', u'lsp-admin-group-exclude-any']

  def _get_lsp_admin_group_exclude_any_group_id(self):
    """
    Getter method for lsp_admin_group_exclude_any_group_id, mapped from YANG variable /brocade_mpls_rpc/show_mpls_lsp_name_detail/output/lsp/show_mpls_lsp_detail_info/show_mpls_lsp_sec_path_info/sec_path/lsp_sec_path_config_admin_groups/lsp_admin_group/lsp_admin_group_exclude_any/lsp_admin_group_exclude_any_group_id (uint32)
