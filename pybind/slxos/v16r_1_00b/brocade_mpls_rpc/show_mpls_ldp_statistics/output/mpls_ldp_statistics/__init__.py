...
class mpls_ldp_statistics(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-ldp-statistics/output/mpls-ldp-statistics. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__g_mpls_prot_statistics_pkt_types','__g_mpls_prot_statistics_errors',)

  _yang_name = 'mpls-ldp-statistics'
  _rest_name = 'mpls-ldp-statistics'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-ldp-statistics', u'output', u'mpls-ldp-statistics']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'show-mpls-ldp-statistics', u'output', u'mpls-ldp-statistics']

  def _get_g_mpls_prot_statistics_pkt_types(self):
    """
    Getter method for g_mpls_prot_statistics_pkt_types, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_statistics/output/mpls_ldp_statistics/g_mpls_prot_statistics_pkt_types (list)
  ...
  def _set_g_mpls_prot_statistics_pkt_types(self, v, load=False):
    """
    Setter method for g_mpls_prot_statistics_pkt_types, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_statistics/output/mpls_ldp_statistics/g_mpls_prot_statistics_pkt_types (list)
  ...
  def _get_g_mpls_prot_statistics_errors(self):
    """
    Getter method for g_mpls_prot_statistics_errors, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_statistics/output/mpls_ldp_statistics/g_mpls_prot_statistics_errors (list)
  ...
  def _set_g_mpls_prot_statistics_errors(self, v, load=False):
    """
    Setter method for g_mpls_prot_statistics_errors, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_statistics/output/mpls_ldp_statistics/g_mpls_prot_statistics_errors (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'g_mpls_prot_statistics_pkt_types': g_mpls_prot_statistics_pkt_types, 'g_mpls_prot_statistics_errors': g_mpls_prot_statistics_errors, }
