...
class lsp_config_frr_admin_groups(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-bypass-lsp-detail/output/bypass-lsp/show-mpls-lsp-detail-info/show-mpls-lsp-common-info/lsp-config-frr-admin-groups. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-bypass-lsp-detail', u'output', u'bypass-lsp', u'show-mpls-lsp-detail-info', u'show-mpls-lsp-common-info', u'lsp-config-frr-admin-groups']
  ...
  def _get_lsp_admin_group(self):
    """
    Getter method for lsp_admin_group, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_lsp_detail/output/bypass_lsp/show_mpls_lsp_detail_info/show_mpls_lsp_common_info/lsp_config_frr_admin_groups/lsp_admin_group (container)
    """
    return self.__lsp_admin_group
      
  def _set_lsp_admin_group(self, v, load=False):
    """
    Setter method for lsp_admin_group, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_lsp_detail/output/bypass_lsp/show_mpls_lsp_detail_info/show_mpls_lsp_common_info/lsp_config_frr_admin_groups/lsp_admin_group (container)
