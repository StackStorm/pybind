...
class show_mpls_lsp_sec_path_info(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-bypass-lsp-debug/output/bypass-lsp/show-mpls-lsp-debug-info/show-mpls-lsp-sec-path-info. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-bypass-lsp-debug', u'output', u'bypass-lsp', u'show-mpls-lsp-debug-info', u'show-mpls-lsp-sec-path-info']
  ...
  def _get_sec_path(self):
    """
    Getter method for sec_path, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_lsp_debug/output/bypass_lsp/show_mpls_lsp_debug_info/show_mpls_lsp_sec_path_info/sec_path (list)
    """
    return self.__sec_path
      
  def _set_sec_path(self, v, load=False):
    """
    Setter method for sec_path, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_lsp_debug/output/bypass_lsp/show_mpls_lsp_debug_info/show_mpls_lsp_sec_path_info/sec_path (list)
