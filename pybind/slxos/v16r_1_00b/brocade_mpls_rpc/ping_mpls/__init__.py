...
import input
import output
class ping_mpls(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/ping-mpls. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__input','__output',)

  _yang_name = 'ping-mpls'
  _rest_name = 'ping-mpls'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'ping-mpls']
  ...
  def _get_input(self):
    """
    Getter method for input, mapped from YANG variable /brocade_mpls_rpc/ping_mpls/input (input)
    """
    return self.__input
      
  def _set_input(self, v, load=False):
    """
    Setter method for input, mapped from YANG variable /brocade_mpls_rpc/ping_mpls/input (input)
  ...
  def _get_output(self):
    """
    Getter method for output, mapped from YANG variable /brocade_mpls_rpc/ping_mpls/output (output)
    """
    return self.__output
      
  def _set_output(self, v, load=False):
    """
    Setter method for output, mapped from YANG variable /brocade_mpls_rpc/ping_mpls/output (output)
    If this variable is read-only (config: false) in the
