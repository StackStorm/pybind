...
import __builtin__
class ldp_peer_detail_rec_list(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-ldp-peer-det/output/ldp-peer-detail-rec-list. Each member element of
  ...
  _yang_name = 'ldp-peer-detail-rec-list'
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__ldp_peer_id = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ldp-peer-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-mpls', defining_module='brocade-mpls', yang_type='inet:ipv4-address', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-ldp-peer-det', u'output', u'ldp-peer-detail-rec-list']
  ...
  def _get_ldp_peer_id(self):
    """
    Getter method for ldp_peer_id, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_peer_id (inet:ipv4-address)
  ...
  def _set_ldp_peer_id(self, v, load=False):
    """
    Setter method for ldp_peer_id, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_peer_id (inet:ipv4-address)
    ...
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ldp-peer-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-mpls', defining_module='brocade-mpls', yang_type='inet:ipv4-address', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ldp_peer_id must be of a type compatible with inet:ipv4-address""",
          'defined-type': "inet:ipv4-address",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ldp-peer-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-mpls', defining_module='brocade-mpls', yang_type='inet:ipv4-address', is_config=True)""",
        })
  ...
  def _get_ldp_peer_lblspid(self):
    """
    Getter method for ldp_peer_lblspid, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_peer_lblspid (uint32)
  ...
  def _set_ldp_peer_lblspid(self, v, load=False):
    """
    Setter method for ldp_peer_lblspid, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_peer_lblspid (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_ldp_local_id(self):
    """
    Getter method for ldp_local_id, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_local_id (inet:ipv4-address)
  ...
  def _set_ldp_local_id(self, v, load=False):
    """
    Setter method for ldp_local_id, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_local_id (inet:ipv4-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_ldp_local_lblspid(self):
    """
    Getter method for ldp_local_lblspid, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_local_lblspid (uint32)
  ...
  def _set_ldp_local_lblspid(self, v, load=False):
    """
    Setter method for ldp_local_lblspid, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_local_lblspid (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_ldp_peer_state(self):
    """
    Getter method for ldp_peer_state, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_peer_state (ldp-state-name)
  ...
  def _set_ldp_peer_state(self, v, load=False):
    """
    Setter method for ldp_peer_state, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_peer_state (ldp-state-name)
    If this variable is read-only (config: false) in the
  ...
  def _get_ldp_peer_session_status(self):
    """
    Getter method for ldp_peer_session_status, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_peer_session_status (up-down)
  ...
  def _set_ldp_peer_session_status(self, v, load=False):
    """
    Setter method for ldp_peer_session_status, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_peer_session_status (up-down)
    If this variable is read-only (config: false) in the
  ...
  def _get_ldp_entity_index(self):
    """
    Getter method for ldp_entity_index, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_entity_index (uint32)
  ...
  def _set_ldp_entity_index(self, v, load=False):
    """
    Setter method for ldp_entity_index, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_entity_index (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_ldp_peer_targeted(self):
    """
    Getter method for ldp_peer_targeted, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_peer_targeted (yes-no)
  ...
  def _set_ldp_peer_targeted(self, v, load=False):
    """
    Setter method for ldp_peer_targeted, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_peer_targeted (yes-no)
    If this variable is read-only (config: false) in the
  ...
  def _get_ldp_peer_targeted_adj_added(self):
    """
    Getter method for ldp_peer_targeted_adj_added, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_peer_targeted_adj_added (yes-no)
  ...
  def _set_ldp_peer_targeted_adj_added(self, v, load=False):
    """
    Setter method for ldp_peer_targeted_adj_added, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_peer_det/output/ldp_peer_detail_rec_list/ldp_peer_targeted_adj_added (yes-no)
    If this variable is read-only (config: false) in the
