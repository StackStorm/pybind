...
class show_mpls_lsp_extensive_info(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-bypass-bypass-lsp-extensive/output/bypass-lsp/show-mpls-lsp-extensive-info. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__show_mpls_lsp_basic_info','__show_mpls_lsp_common_info','__show_mpls_lsp_instances_info','__show_mpls_lsp_forwarding_info','__show_mpls_lsp_sec_path_info','__show_mpls_lsp_frr_info','__show_mpls_lsp_backup_info','__show_mpls_lsp_history_info',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__show_mpls_lsp_history_info = YANGDynClass(base=show_mpls_lsp_history_info.show_mpls_lsp_history_info, is_container='container', yang_name="show-mpls-lsp-history-info", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-mpls', defining_module='brocade-mpls', yang_type='container', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-bypass-bypass-lsp-extensive', u'output', u'bypass-lsp', u'show-mpls-lsp-extensive-info']
  ...
  def _get_show_mpls_lsp_basic_info(self):
    """
    Getter method for show_mpls_lsp_basic_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_bypass_lsp_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info/show_mpls_lsp_basic_info (container)
    """
    return self.__show_mpls_lsp_basic_info
      
  def _set_show_mpls_lsp_basic_info(self, v, load=False):
    """
    Setter method for show_mpls_lsp_basic_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_bypass_lsp_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info/show_mpls_lsp_basic_info (container)
  ...
  def _get_show_mpls_lsp_common_info(self):
    """
    Getter method for show_mpls_lsp_common_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_bypass_lsp_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info/show_mpls_lsp_common_info (container)
    """
    return self.__show_mpls_lsp_common_info
      
  def _set_show_mpls_lsp_common_info(self, v, load=False):
    """
    Setter method for show_mpls_lsp_common_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_bypass_lsp_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info/show_mpls_lsp_common_info (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_show_mpls_lsp_instances_info(self):
    """
    Getter method for show_mpls_lsp_instances_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_bypass_lsp_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info/show_mpls_lsp_instances_info (container)
    """
    return self.__show_mpls_lsp_instances_info
      
  def _set_show_mpls_lsp_instances_info(self, v, load=False):
    """
    Setter method for show_mpls_lsp_instances_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_bypass_lsp_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info/show_mpls_lsp_instances_info (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_show_mpls_lsp_forwarding_info(self):
    """
    Getter method for show_mpls_lsp_forwarding_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_bypass_lsp_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info/show_mpls_lsp_forwarding_info (container)
    """
    return self.__show_mpls_lsp_forwarding_info
      
  def _set_show_mpls_lsp_forwarding_info(self, v, load=False):
    """
    Setter method for show_mpls_lsp_forwarding_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_bypass_lsp_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info/show_mpls_lsp_forwarding_info (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_show_mpls_lsp_sec_path_info(self):
    """
    Getter method for show_mpls_lsp_sec_path_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_bypass_lsp_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info/show_mpls_lsp_sec_path_info (container)
    """
    return self.__show_mpls_lsp_sec_path_info
      
  def _set_show_mpls_lsp_sec_path_info(self, v, load=False):
    """
    Setter method for show_mpls_lsp_sec_path_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_bypass_lsp_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info/show_mpls_lsp_sec_path_info (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_show_mpls_lsp_frr_info(self):
    """
    Getter method for show_mpls_lsp_frr_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_bypass_lsp_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info/show_mpls_lsp_frr_info (container)
    """
    return self.__show_mpls_lsp_frr_info
      
  def _set_show_mpls_lsp_frr_info(self, v, load=False):
    """
    Setter method for show_mpls_lsp_frr_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_bypass_lsp_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info/show_mpls_lsp_frr_info (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_show_mpls_lsp_backup_info(self):
    """
    Getter method for show_mpls_lsp_backup_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_bypass_lsp_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info/show_mpls_lsp_backup_info (container)
    """
    return self.__show_mpls_lsp_backup_info
      
  def _set_show_mpls_lsp_backup_info(self, v, load=False):
    """
    Setter method for show_mpls_lsp_backup_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_bypass_lsp_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info/show_mpls_lsp_backup_info (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_show_mpls_lsp_history_info(self):
    """
    Getter method for show_mpls_lsp_history_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_bypass_lsp_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info/show_mpls_lsp_history_info (container)
    """
    return self.__show_mpls_lsp_history_info
      
  def _set_show_mpls_lsp_history_info(self, v, load=False):
    """
    Setter method for show_mpls_lsp_history_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_bypass_lsp_extensive/output/bypass_lsp/show_mpls_lsp_extensive_info/show_mpls_lsp_history_info (container)
    If this variable is read-only (config: false) in the
