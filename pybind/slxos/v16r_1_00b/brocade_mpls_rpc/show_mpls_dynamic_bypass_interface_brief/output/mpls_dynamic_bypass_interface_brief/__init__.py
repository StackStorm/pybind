...
class mpls_dynamic_bypass_interface_brief(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-dynamic-bypass-interface-brief/output/mpls-dynamic-bypass-interface-brief. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__show_mpls_dynamic_bypass_interface_brief',)

  _yang_name = 'mpls-dynamic-bypass-interface-brief'
  _rest_name = 'mpls-dynamic-bypass-interface-brief'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-dynamic-bypass-interface-brief', u'output', u'mpls-dynamic-bypass-interface-brief']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'show-mpls-dynamic-bypass-interface-brief', u'output', u'mpls-dynamic-bypass-interface-brief']
  ...
  def _set_show_mpls_dynamic_bypass_interface_brief(self, v, load=False):
    """
    Setter method for show_mpls_dynamic_bypass_interface_brief, mapped from YANG variable /brocade_mpls_rpc/show_mpls_dynamic_bypass_interface_brief/output/mpls_dynamic_bypass_interface_brief/show_mpls_dynamic_bypass_interface_brief (container)
    ...
    try:
      ...
      raise ValueError({
          'error-string': """show_mpls_dynamic_bypass_interface_brief must be of a type compatible with container""",
  ...
  _pyangbind_elements = {'show_mpls_dynamic_bypass_interface_brief': show_mpls_dynamic_bypass_interface_brief, }
