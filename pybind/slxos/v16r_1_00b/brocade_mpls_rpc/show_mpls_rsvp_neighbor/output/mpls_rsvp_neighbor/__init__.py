...
class mpls_rsvp_neighbor(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-rsvp-neighbor/output/mpls-rsvp-neighbor. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__show_mpls_neighbor_brief',)

  _yang_name = 'mpls-rsvp-neighbor'
  _rest_name = 'mpls-rsvp-neighbor'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-rsvp-neighbor', u'output', u'mpls-rsvp-neighbor']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'show-mpls-rsvp-neighbor', u'output', u'mpls-rsvp-neighbor']

  def _get_show_mpls_neighbor_brief(self):
    """
    Getter method for show_mpls_neighbor_brief, mapped from YANG variable /brocade_mpls_rpc/show_mpls_rsvp_neighbor/output/mpls_rsvp_neighbor/show_mpls_neighbor_brief (container)
    """
    return self.__show_mpls_neighbor_brief
      
  def _set_show_mpls_neighbor_brief(self, v, load=False):
    """
    Setter method for show_mpls_neighbor_brief, mapped from YANG variable /brocade_mpls_rpc/show_mpls_rsvp_neighbor/output/mpls_rsvp_neighbor/show_mpls_neighbor_brief (container)
  ...
  _pyangbind_elements = {'show_mpls_neighbor_brief': show_mpls_neighbor_brief, }
