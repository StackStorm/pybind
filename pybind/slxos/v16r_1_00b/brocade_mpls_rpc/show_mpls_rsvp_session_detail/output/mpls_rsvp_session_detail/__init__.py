...
class mpls_rsvp_session_detail(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__show_mpls_session_brief','__show_mpls_session_detail',)

  _yang_name = 'mpls-rsvp-session-detail'
  _rest_name = 'mpls-rsvp-session-detail'
