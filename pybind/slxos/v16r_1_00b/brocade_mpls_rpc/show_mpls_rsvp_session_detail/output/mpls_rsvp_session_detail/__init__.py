...
class mpls_rsvp_session_detail(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-rsvp-session-detail/output/mpls-rsvp-session-detail. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__show_mpls_session_brief','__show_mpls_session_detail',)

  _yang_name = 'mpls-rsvp-session-detail'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-rsvp-session-detail', u'output', u'mpls-rsvp-session-detail']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'show-mpls-rsvp-session-detail', u'output', u'mpls-rsvp-session-detail']

  def _get_show_mpls_session_brief(self):
    """
    Getter method for show_mpls_session_brief, mapped from YANG variable /brocade_mpls_rpc/show_mpls_rsvp_session_detail/output/mpls_rsvp_session_detail/show_mpls_session_brief (container)
    """
    return self.__show_mpls_session_brief
      
  def _set_show_mpls_session_brief(self, v, load=False):
    """
    Setter method for show_mpls_session_brief, mapped from YANG variable /brocade_mpls_rpc/show_mpls_rsvp_session_detail/output/mpls_rsvp_session_detail/show_mpls_session_brief (container)
  ...
  def _get_show_mpls_session_detail(self):
    """
    Getter method for show_mpls_session_detail, mapped from YANG variable /brocade_mpls_rpc/show_mpls_rsvp_session_detail/output/mpls_rsvp_session_detail/show_mpls_session_detail (container)
    """
    return self.__show_mpls_session_detail
      
  def _set_show_mpls_session_detail(self, v, load=False):
    """
    Setter method for show_mpls_session_detail, mapped from YANG variable /brocade_mpls_rpc/show_mpls_rsvp_session_detail/output/mpls_rsvp_session_detail/show_mpls_session_detail (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'show_mpls_session_brief': show_mpls_session_brief, 'show_mpls_session_detail': show_mpls_session_detail, }
