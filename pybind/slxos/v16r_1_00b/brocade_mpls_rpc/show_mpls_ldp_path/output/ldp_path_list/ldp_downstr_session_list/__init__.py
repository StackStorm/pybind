...
class ldp_downstr_session_list(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-ldp-path/output/ldp-path-list/ldp-downstr-session-list. Each member element of
  ...
  def _get_ldp_downstr_session_ip(self):
    """
    Getter method for ldp_downstr_session_ip, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_path/output/ldp_path_list/ldp_downstr_session_list/ldp_downstr_session_ip (string)
  ...
  def _set_ldp_downstr_session_ip(self, v, load=False):
    """
    Setter method for ldp_downstr_session_ip, mapped from YANG variable /brocade_mpls_rpc/show_mpls_ldp_path/output/ldp_path_list/ldp_downstr_session_list/ldp_downstr_session_ip (string)
