...
class input(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-bypass-lsp-name-debug/input. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-bypass-lsp-name-debug', u'input']
  ...
  def _set_show_lsp_input_info(self, v, load=False):
    """
    Setter method for show_lsp_input_info, mapped from YANG variable /brocade_mpls_rpc/show_mpls_bypass_lsp_name_debug/input/show_lsp_input_info (container)
