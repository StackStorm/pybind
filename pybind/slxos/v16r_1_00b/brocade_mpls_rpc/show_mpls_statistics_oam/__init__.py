...
import __builtin__
import output
class show_mpls_statistics_oam(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-statistics-oam. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__output',)

  _yang_name = 'show-mpls-statistics-oam'
  _rest_name = 'show-mpls-statistics-oam'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mpls_rpc', u'show-mpls-statistics-oam']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'show-mpls-statistics-oam']

  def _get_output(self):
    """
    Getter method for output, mapped from YANG variable /brocade_mpls_rpc/show_mpls_statistics_oam/output (output)
    """
    return self.__output
      
  def _set_output(self, v, load=False):
    """
    Setter method for output, mapped from YANG variable /brocade_mpls_rpc/show_mpls_statistics_oam/output (output)
