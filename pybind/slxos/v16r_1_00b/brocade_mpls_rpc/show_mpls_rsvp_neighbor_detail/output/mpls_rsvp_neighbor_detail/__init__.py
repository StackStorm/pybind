...
class mpls_rsvp_neighbor_detail(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /brocade_mpls_rpc/show-mpls-rsvp-neighbor-detail/output/mpls-rsvp-neighbor-detail. Each member element of
  ...
  def _get_show_mpls_neighbor_brief(self):
    """
    Getter method for show_mpls_neighbor_brief, mapped from YANG variable /brocade_mpls_rpc/show_mpls_rsvp_neighbor_detail/output/mpls_rsvp_neighbor_detail/show_mpls_neighbor_brief (container)
    """
    return self.__show_mpls_neighbor_brief
      
  def _set_show_mpls_neighbor_brief(self, v, load=False):
    """
    Setter method for show_mpls_neighbor_brief, mapped from YANG variable /brocade_mpls_rpc/show_mpls_rsvp_neighbor_detail/output/mpls_rsvp_neighbor_detail/show_mpls_neighbor_brief (container)
  ...
  def _get_show_mpls_neighbor_detail(self):
    """
    Getter method for show_mpls_neighbor_detail, mapped from YANG variable /brocade_mpls_rpc/show_mpls_rsvp_neighbor_detail/output/mpls_rsvp_neighbor_detail/show_mpls_neighbor_detail (container)
    """
    return self.__show_mpls_neighbor_detail
      
  def _set_show_mpls_neighbor_detail(self, v, load=False):
    """
    Setter method for show_mpls_neighbor_detail, mapped from YANG variable /brocade_mpls_rpc/show_mpls_rsvp_neighbor_detail/output/mpls_rsvp_neighbor_detail/show_mpls_neighbor_detail (container)
    If this variable is read-only (config: false) in the
