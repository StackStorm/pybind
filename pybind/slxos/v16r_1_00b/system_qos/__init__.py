...
import __builtin__
import qos
class system_qos(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-qos-mqc - based on the path /system-qos. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__qos',)

  _yang_name = 'system-qos'
  ...
  def _set_qos(self, v, load=False):
    """
    Setter method for qos, mapped from YANG variable /system_qos/qos (container)
