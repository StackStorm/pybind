...
import __builtin__
class adj_area(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-isis-operational - based on the path /adj-neighbor-entries-state/adj-neighbor/adj-area. Each member element of
  ...
  def _get_adj_asi_area_name(self):
    """
    Getter method for adj_asi_area_name, mapped from YANG variable /adj_neighbor_entries_state/adj_neighbor/adj_area/adj_asi_area_name (string)

    YANG Description: Area Address
    """
    return self.__adj_asi_area_name
      
  def _set_adj_asi_area_name(self, v, load=False):
    """
    Setter method for adj_asi_area_name, mapped from YANG variable /adj_neighbor_entries_state/adj_neighbor/adj_area/adj_asi_area_name (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_adj_asi_area_name is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_adj_asi_area_name() directly.
  ...
  _pyangbind_elements = {'adj_asi_area_name': adj_asi_area_name, }
