...
import __builtin__
import show_cluster
class mct_state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-nsm-operational - based on the path /mct-state. Each member element of
  ...
  def _get_show_cluster(self):
    """
    Getter method for show_cluster, mapped from YANG variable /mct_state/show_cluster (list)
    """
    return self.__show_cluster
      
  def _set_show_cluster(self, v, load=False):
    """
    Setter method for show_cluster, mapped from YANG variable /mct_state/show_cluster (list)
  ...
  _pyangbind_elements = {'show_cluster': show_cluster, }
