...
class show_cluster(PybindBase):
  ...
  def _get_active_vlan_list(self):
    """
    Getter method for active_vlan_list, mapped from YANG variable /mct_state/show_cluster/active_vlan_list (container)
    """
    return self.__active_vlan_list
      
  def _set_active_vlan_list(self, v, load=False):
    """
    Setter method for active_vlan_list, mapped from YANG variable /mct_state/show_cluster/active_vlan_list (container)
    If this variable is read-only (config: false) in the
