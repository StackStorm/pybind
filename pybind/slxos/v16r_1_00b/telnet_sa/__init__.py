...
import __builtin__
import telnet
class telnet_sa(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-sec-services - based on the path /telnet-sa. Each member element of
  ...
  def _get_telnet(self):
    """
    Getter method for telnet, mapped from YANG variable /telnet_sa/telnet (container)
    """
    return self.__telnet
      
  def _set_telnet(self, v, load=False):
    """
    Setter method for telnet, mapped from YANG variable /telnet_sa/telnet (container)
  ...
  _pyangbind_elements = {'telnet': telnet, }
