...
class client(PybindBase):
  ...
  from YANG module brocade-sec-services - based on the path /telnet-sa/telnet/client. Each member element of
  ...
  def _get_source_interface(self):
    """
    Getter method for source_interface, mapped from YANG variable /telnet_sa/telnet/client/source_interface (container)
    """
    return self.__source_interface
      
  def _set_source_interface(self, v, load=False):
    """
    Setter method for source_interface, mapped from YANG variable /telnet_sa/telnet/client/source_interface (container)
  ...
  _pyangbind_elements = {'source_interface': source_interface, }
