...
import __builtin__
import host
class tacacs_server(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-aaa - based on the path /tacacs-server. Each member element of
  ...
  def _get_host(self):
    """
    Getter method for host, mapped from YANG variable /tacacs_server/host (list)
    """
    return self.__host
      
  def _set_host(self, v, load=False):
    """
    Setter method for host, mapped from YANG variable /tacacs_server/host (list)
  ...
  def _get_tacacs_source_ip(self):
    """
    Getter method for tacacs_source_ip, mapped from YANG variable /tacacs_server/tacacs_source_ip (srcip_type)
    """
    return self.__tacacs_source_ip
      
  def _set_tacacs_source_ip(self, v, load=False):
    """
    Setter method for tacacs_source_ip, mapped from YANG variable /tacacs_server/tacacs_source_ip (srcip_type)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_tacacs_source_ip is considered as a private
    method. Backends looking to populate this variable should
  ...
  _pyangbind_elements = {'host': host, 'tacacs_source_ip': tacacs_source_ip, }
