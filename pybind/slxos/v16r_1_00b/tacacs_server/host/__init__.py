...
class host(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__hostname','__use_vrf','__tacacs_server_options',)
  ...
  def _get_tacacs_server_options(self):
    """
    Getter method for tacacs_server_options, mapped from YANG variable /tacacs_server/host/tacacs_server_options (container)
    """
    return self.__tacacs_server_options
      
  def _set_tacacs_server_options(self, v, load=False):
    """
    Setter method for tacacs_server_options, mapped from YANG variable /tacacs_server/host/tacacs_server_options (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_tacacs_server_options is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_tacacs_server_options() directly.
    """
    try:
  ...
  tacacs_server_options = __builtin__.property(_get_tacacs_server_options, _set_tacacs_server_options)


  _pyangbind_elements = {'hostname': hostname, 'use_vrf': use_vrf, 'tacacs_server_options': tacacs_server_options, }
