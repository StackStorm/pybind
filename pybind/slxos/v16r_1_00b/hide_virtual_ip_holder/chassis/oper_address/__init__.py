...
class oper_address(PybindBase):
  ...
  from YANG module brocade-chassis - based on the path /hide-virtual-ip-holder/chassis/oper-address. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__virtual_oper_Vip_address','__virtual_oper_VipV6_address',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'hide-virtual-ip-holder', u'chassis', u'oper-address']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'chassis', u'virtual-ip']

  def _get_virtual_oper_Vip_address(self):
    """
    Getter method for virtual_oper_Vip_address, mapped from YANG variable /hide_virtual_ip_holder/chassis/oper_address/virtual_oper_Vip_address (common-def:ipv4-address-prefix-type)
  ...
  def _set_virtual_oper_Vip_address(self, v, load=False):
    """
    Setter method for virtual_oper_Vip_address, mapped from YANG variable /hide_virtual_ip_holder/chassis/oper_address/virtual_oper_Vip_address (common-def:ipv4-address-prefix-type)
  ...
  def _get_virtual_oper_VipV6_address(self):
    """
    Getter method for virtual_oper_VipV6_address, mapped from YANG variable /hide_virtual_ip_holder/chassis/oper_address/virtual_oper_VipV6_address (string)
  ...
  def _set_virtual_oper_VipV6_address(self, v, load=False):
    """
    Setter method for virtual_oper_VipV6_address, mapped from YANG variable /hide_virtual_ip_holder/chassis/oper_address/virtual_oper_VipV6_address (string)
    If this variable is read-only (config: false) in the
