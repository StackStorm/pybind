...
class cpu_info_state(PybindBase):
  ...
  def _get_cpu_info_egid(self):
    """
    Getter method for cpu_info_egid, mapped from YANG variable /cpu_info_state/cpu_info_egid (list)

    YANG Description: CPU EGID and Group ID mapping
    """
    return self.__cpu_info_egid
      
  def _set_cpu_info_egid(self, v, load=False):
    """
    Setter method for cpu_info_egid, mapped from YANG variable /cpu_info_state/cpu_info_egid (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_cpu_info_egid is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_cpu_info_egid() directly.
  ...
  _pyangbind_elements = {'cpu_info_egid': cpu_info_egid, }
