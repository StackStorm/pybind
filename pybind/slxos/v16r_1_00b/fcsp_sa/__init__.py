...
import __builtin__
import fcsp
class fcsp_sa(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-fc-auth - based on the path /fcsp-sa. Each member element of
  ...
  def _get_fcsp(self):
    """
    Getter method for fcsp, mapped from YANG variable /fcsp_sa/fcsp (container)
    """
    return self.__fcsp
      
  def _set_fcsp(self, v, load=False):
    """
    Setter method for fcsp, mapped from YANG variable /fcsp_sa/fcsp (container)
