...
class fcsp(PybindBase):
  ...
  from YANG module brocade-fc-auth - based on the path /fcsp-sa/fcsp. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__auth',)
  ...
  def _get_auth(self):
    """
    Getter method for auth, mapped from YANG variable /fcsp_sa/fcsp/auth (container)
    """
    return self.__auth
      
  def _set_auth(self, v, load=False):
    """
    Setter method for auth, mapped from YANG variable /fcsp_sa/fcsp/auth (container)
