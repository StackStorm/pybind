...
import __builtin__
import qos_mpls
class traffic_class_exp_state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-qos-operational - based on the path /traffic-class-exp-state. Each member element of
  ...
  _yang_name = 'traffic-class-exp-state'
  _rest_name = 'traffic-class-exp-state'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'traffic-class-exp-state']
  ...
  def _set_qos_mpls(self, v, load=False):
    """
    Setter method for qos_mpls, mapped from YANG variable /traffic_class_exp_state/qos_mpls (list)
