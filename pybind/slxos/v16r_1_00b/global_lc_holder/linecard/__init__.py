...
class linecard(PybindBase):
  ...
  from YANG module brocade-linecard-management - based on the path /global-lc-holder/linecard. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__linecards',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'global-lc-holder', u'linecard']
  ...
  def _get_linecards(self):
    """
    Getter method for linecards, mapped from YANG variable /global_lc_holder/linecard/linecards (list)
    """
    return self.__linecards
      
  def _set_linecards(self, v, load=False):
    """
    Setter method for linecards, mapped from YANG variable /global_lc_holder/linecard/linecards (list)
