...
import __builtin__
import linecard
class global_lc_holder(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-linecard-management - based on the path /global-lc-holder. Each member element of
  ...
  def _get_linecard(self):
    """
    Getter method for linecard, mapped from YANG variable /global_lc_holder/linecard (container)
    """
  ...
  _pyangbind_elements = {'linecard': linecard, }
