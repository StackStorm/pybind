...
class port_security(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__port_sec_max','__port_sec_violation','__port_secutiry_mac_address','__sticky','__shutdown_time',)
