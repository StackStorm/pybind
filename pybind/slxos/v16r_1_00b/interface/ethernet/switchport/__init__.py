...
class switchport(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__mode','__port_security','__access','__access_mac_vlan_classification','__access_mac_group_vlan_classification','__trunk','__access_mac_rspan_vlan_classification','__access_mac_group_rspan_vlan_classification',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__access_mac_rspan_vlan_classification = YANGDynClass(base=access_mac_rspan_vlan_classification.access_mac_rspan_vlan_classification, is_container='container', yang_name="access-mac-rspan-vlan-classification", rest_name="access-mac-rspan-vlan-classification", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'hidden': u'full'}}, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='container', is_config=True)
...
interface.
  ...
  _pyangbind_elements = {'mode': mode, 'port_security': port_security, 'access': access, 'access_mac_vlan_classification': access_mac_vlan_classification, 'access_mac_group_vlan_classification': access_mac_group_vlan_classification, 'trunk': trunk, 'access_mac_rspan_vlan_classification': access_mac_rspan_vlan_classification, 'access_mac_group_rspan_vlan_classification': access_mac_group_rspan_vlan_classification, }
