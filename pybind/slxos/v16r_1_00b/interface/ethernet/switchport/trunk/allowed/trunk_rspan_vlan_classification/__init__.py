...
class trunk_rspan_vlan_classification(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/switchport/trunk/allowed/trunk-rspan-vlan-classification. Each member element of
  ...
  def _get_rspan_vlan(self):
    """
    Getter method for rspan_vlan, mapped from YANG variable /interface/ethernet/switchport/trunk/allowed/trunk_rspan_vlan_classification/rspan_vlan (container)
    """
    return self.__rspan_vlan
      
  def _set_rspan_vlan(self, v, load=False):
    """
    Setter method for rspan_vlan, mapped from YANG variable /interface/ethernet/switchport/trunk/allowed/trunk_rspan_vlan_classification/rspan_vlan (container)
