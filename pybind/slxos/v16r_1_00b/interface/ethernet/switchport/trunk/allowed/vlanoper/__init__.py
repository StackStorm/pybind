...
class vlanoper(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/switchport/trunk/allowed/vlanoper. Each member element of
...
Do not use in edit-config.
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /interface/ethernet/switchport/trunk/allowed/vlanoper/vlan (container)
    """
    return self.__vlan
      
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /interface/ethernet/switchport/trunk/allowed/vlanoper/vlan (container)
