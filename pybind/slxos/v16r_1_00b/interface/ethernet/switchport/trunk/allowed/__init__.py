...
class allowed(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/switchport/trunk/allowed. Each member element of
...
interface
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__vlan','__vlanoper','__rspan_vlan','__trunk_rspan_vlan_classification',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'switchport', u'trunk', u'allowed']
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /interface/ethernet/switchport/trunk/allowed/vlan (container)
    """
    return self.__vlan
      
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /interface/ethernet/switchport/trunk/allowed/vlan (container)
    ...
    """
    try:
      t = YANGDynClass(v,base=vlan.vlan, is_container='container', yang_name="vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Allow Dot1Q VLANs to Xmit/Rx through the\nLayer2 interface', u'sort-priority': u'97'}}, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """vlan must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=vlan.vlan, is_container='container', yang_name="vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Allow Dot1Q VLANs to Xmit/Rx through the\nLayer2 interface', u'sort-priority': u'97'}}, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='container', is_config=True)""",
        })
  ...
  def _get_vlanoper(self):
    """
    Getter method for vlanoper, mapped from YANG variable /interface/ethernet/switchport/trunk/allowed/vlanoper (container)
...
Do not use in edit-config.
    """
    try:
      t = YANGDynClass(v,base=vlanoper.vlanoper, is_container='container', yang_name="vlanoper", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'hidden': u'netconfonly'}}, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """vlanoper must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=vlanoper.vlanoper, is_container='container', yang_name="vlanoper", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'hidden': u'netconfonly'}}, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='container', is_config=True)""",
        })
  ...
  def _get_rspan_vlan(self):
    """
    Getter method for rspan_vlan, mapped from YANG variable /interface/ethernet/switchport/trunk/allowed/rspan_vlan (container)
  ...
  def _set_rspan_vlan(self, v, load=False):
    """
    Setter method for rspan_vlan, mapped from YANG variable /interface/ethernet/switchport/trunk/allowed/rspan_vlan (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_trunk_rspan_vlan_classification(self):
    """
    Getter method for trunk_rspan_vlan_classification, mapped from YANG variable /interface/ethernet/switchport/trunk/allowed/trunk_rspan_vlan_classification (container)
    """
    return self.__trunk_rspan_vlan_classification
      
  def _set_trunk_rspan_vlan_classification(self, v, load=False):
    """
    Setter method for trunk_rspan_vlan_classification, mapped from YANG variable /interface/ethernet/switchport/trunk/allowed/trunk_rspan_vlan_classification (container)
    If this variable is read-only (config: false) in the
