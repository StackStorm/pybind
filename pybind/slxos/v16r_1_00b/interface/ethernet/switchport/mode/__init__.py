...
class mode(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/switchport/mode. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'switchport', u'mode']
  ...
  def _get_vlan_mode(self):
    """
    Getter method for vlan_mode, mapped from YANG variable /interface/ethernet/switchport/mode/vlan_mode (l2-mode-type)
  ...
  def _set_vlan_mode(self, v, load=False):
    """
    Setter method for vlan_mode, mapped from YANG variable /interface/ethernet/switchport/mode/vlan_mode (l2-mode-type)
