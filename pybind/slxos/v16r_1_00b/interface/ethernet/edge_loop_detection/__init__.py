...
class edge_loop_detection(PybindBase):
  ...
  def _get_eldvlan(self):
    """
    Getter method for eldvlan, mapped from YANG variable /interface/ethernet/edge_loop_detection/eldvlan (ui32-eldvlan-range)
    """
    return self.__eldvlan
      
  def _set_eldvlan(self, v, load=False):
    """
    Setter method for eldvlan, mapped from YANG variable /interface/ethernet/edge_loop_detection/eldvlan (ui32-eldvlan-range)
    If this variable is read-only (config: false) in the
