...
class preferred(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ipv6/ipv6-nd-ra/ipv6-intf-cmds/nd/prefix/lifetime/preferred. Each member element of
  ...
  def _get_preferred_lifetime(self):
    """
    Getter method for preferred_lifetime, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/preferred_lifetime (common-def:time-interval-sec)
    """
    return self.__preferred_lifetime
      
  def _set_preferred_lifetime(self, v, load=False):
    """
    Setter method for preferred_lifetime, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/preferred_lifetime (common-def:time-interval-sec)
  ...
  def _get_preferred_infinite(self):
    """
    Getter method for preferred_infinite, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/preferred_infinite (empty)
    """
    return self.__preferred_infinite
      
  def _set_preferred_infinite(self, v, load=False):
    """
    Setter method for preferred_infinite, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/preferred_infinite (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_prefix_flags(self):
    """
    Getter method for prefix_flags, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/prefix_flags (container)
    """
    return self.__prefix_flags
      
  def _set_prefix_flags(self, v, load=False):
    """
    Setter method for prefix_flags, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/prefix_flags (container)
    If this variable is read-only (config: false) in the
