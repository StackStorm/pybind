...
class port_security(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/switchport/port-security. Each member element of
  ...
  def _get_port_sec_max(self):
    """
    Getter method for port_sec_max, mapped from YANG variable /interface/port_channel/switchport/port_security/port_sec_max (uint32)
  ...
  def _set_port_sec_max(self, v, load=False):
    """
    Setter method for port_sec_max, mapped from YANG variable /interface/port_channel/switchport/port_security/port_sec_max (uint32)
  ...
  def _get_port_sec_violation(self):
    """
    Getter method for port_sec_violation, mapped from YANG variable /interface/port_channel/switchport/port_security/port_sec_violation (port-sec-violation)
  ...
  def _get_port_secutiry_mac_address(self):
    """
    Getter method for port_secutiry_mac_address, mapped from YANG variable /interface/port_channel/switchport/port_security/port_secutiry_mac_address (list)
  ...
  def _set_port_secutiry_mac_address(self, v, load=False):
    """
    Setter method for port_secutiry_mac_address, mapped from YANG variable /interface/port_channel/switchport/port_security/port_secutiry_mac_address (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_sticky(self):
    """
    Getter method for sticky, mapped from YANG variable /interface/port_channel/switchport/port_security/sticky (container)
  ...
  def _set_sticky(self, v, load=False):
    """
    Setter method for sticky, mapped from YANG variable /interface/port_channel/switchport/port_security/sticky (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_shutdown_time(self):
    """
    Getter method for shutdown_time, mapped from YANG variable /interface/port_channel/switchport/port_security/shutdown_time (uint32)
  ...
  def _set_shutdown_time(self, v, load=False):
    """
    Setter method for shutdown_time, mapped from YANG variable /interface/port_channel/switchport/port_security/shutdown_time (uint32)
    If this variable is read-only (config: false) in the
