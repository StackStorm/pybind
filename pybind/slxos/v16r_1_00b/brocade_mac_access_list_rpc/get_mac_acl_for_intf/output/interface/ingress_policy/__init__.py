...
import __builtin__
class ingress_policy(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mac-access-list - based on the path /brocade_mac_access_list_rpc/get-mac-acl-for-intf/output/interface/ingress-policy. Each member element of
...
interface.
  ...
  _yang_name = 'ingress-policy'
  _rest_name = 'ingress-policy'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mac_access_list_rpc', u'get-mac-acl-for-intf', u'output', u'interface', u'ingress-policy']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'get-mac-acl-for-intf', u'output', u'interface', u'ingress-policy']

  def _get_policy_name(self):
    """
    Getter method for policy_name, mapped from YANG variable /brocade_mac_access_list_rpc/get_mac_acl_for_intf/output/interface/ingress_policy/policy_name (string)
  ...
  def _set_policy_name(self, v, load=False):
    """
    Setter method for policy_name, mapped from YANG variable /brocade_mac_access_list_rpc/get_mac_acl_for_intf/output/interface/ingress_policy/policy_name (string)
