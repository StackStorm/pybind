...
import __builtin__
import interface
class interface_eth(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-aaa - based on the path /rule/command/interface-eth. Each member element of
  ...
  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /rule/command/interface_eth/interface (container)
    """
    return self.__interface
      
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /rule/command/interface_eth/interface (container)
