...
import __builtin__
import copy
class copy_running(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-aaa - based on the path /rule/command/copy-running. Each member element of
  ...
  def _get_copy(self):
    """
    Getter method for copy, mapped from YANG variable /rule/command/copy_running/copy (container)
    """
    return self.__copy
      
  def _set_copy(self, v, load=False):
    """
    Setter method for copy, mapped from YANG variable /rule/command/copy_running/copy (container)
  ...
  __choices__ = {u'cmdlist': {u'copy-b': [u'copy']}}
