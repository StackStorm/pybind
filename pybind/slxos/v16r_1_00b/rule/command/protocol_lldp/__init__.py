...
import __builtin__
import protocol
class protocol_lldp(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-aaa - based on the path /rule/command/protocol-lldp. Each member element of
  ...
  def _get_protocol(self):
    """
    Getter method for protocol, mapped from YANG variable /rule/command/protocol_lldp/protocol (container)
    """
    return self.__protocol
      
  def _set_protocol(self, v, load=False):
    """
    Setter method for protocol, mapped from YANG variable /rule/command/protocol_lldp/protocol (container)
  ...
  __choices__ = {u'cmdlist': {u'protocol-c': [u'protocol']}}
