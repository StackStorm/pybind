...
import __builtin__
import qos_mpls
class exp_traffic_class_state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-qos-operational - based on the path /exp-traffic-class-state. Each member element of
  ...
  _yang_name = 'exp-traffic-class-state'
  _rest_name = 'exp-traffic-class-state'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'exp-traffic-class-state']
  ...
  def _set_qos_mpls(self, v, load=False):
    """
    Setter method for qos_mpls, mapped from YANG variable /exp_traffic_class_state/qos_mpls (list)
