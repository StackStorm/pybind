...
import __builtin__
import switch_status
class output(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-system-monitor-ext - based on the path /brocade_system_monitor_ext_rpc/show-system-monitor/output. Each member element of
  ...
  def _get_switch_status(self):
    """
    Getter method for switch_status, mapped from YANG variable /brocade_system_monitor_ext_rpc/show_system_monitor/output/switch_status (list)
    """
    return self.__switch_status
      
  def _set_switch_status(self, v, load=False):
    """
    Setter method for switch_status, mapped from YANG variable /brocade_system_monitor_ext_rpc/show_system_monitor/output/switch_status (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_switch_status is considered as a private
  ...
  _pyangbind_elements = {'switch_status': switch_status, }
