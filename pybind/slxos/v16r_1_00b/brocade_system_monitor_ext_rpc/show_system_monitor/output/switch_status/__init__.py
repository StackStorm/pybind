...
class switch_status(PybindBase):
  ...
  _pyangbind_elements = {'switch_name': switch_name, 'switch_ip': switch_ip, 'report_time': report_time, 'switch_state': switch_state, 'switch_state_reason': switch_state_reason, 'component_status': component_status, 'port_status': port_status, }
