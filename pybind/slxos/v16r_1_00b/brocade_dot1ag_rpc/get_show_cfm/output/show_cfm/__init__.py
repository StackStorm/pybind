...
import __builtin__
import show_cfm_domain_list
class show_cfm(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-dot1ag - based on the path /brocade_dot1ag_rpc/get-show-cfm/output/show-cfm. Each member element of
  ...
  def _get_show_cfm_domain_list(self):
    """
    Getter method for show_cfm_domain_list, mapped from YANG variable /brocade_dot1ag_rpc/get_show_cfm/output/show_cfm/show_cfm_domain_list (list)
    """
    return self.__show_cfm_domain_list
      
  def _set_show_cfm_domain_list(self, v, load=False):
    """
    Setter method for show_cfm_domain_list, mapped from YANG variable /brocade_dot1ag_rpc/get_show_cfm/output/show_cfm/show_cfm_domain_list (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_show_cfm_domain_list is considered as a private
  ...
  _pyangbind_elements = {'show_cfm_domain_list': show_cfm_domain_list, }
