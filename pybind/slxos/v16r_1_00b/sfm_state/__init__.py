...
class sfm_state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__mcast','__statistics','__links','__queue','__thresholds','__connectivity','__serdesmode',)
