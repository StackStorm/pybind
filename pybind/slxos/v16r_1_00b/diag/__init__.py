...
import __builtin__
import post
class diag(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-diagnostics - based on the path /diag. Each member element of
  ...
  def _set_post(self, v, load=False):
    """
    Setter method for post, mapped from YANG variable /diag/post (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_post is considered as a private
