...
class input(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__interface_type','__interface_name','__last_rcvd_ifindex',)
...
from the managed entity.
  ...
  __choices__ = {u'request-type': {u'get-next-request': [u'last_rcvd_ifindex'], u'get-request': [u'interface_type', u'interface_name']}}
  _pyangbind_elements = {'interface_type': interface_type, 'interface_name': interface_name, 'last_rcvd_ifindex': last_rcvd_ifindex, }
