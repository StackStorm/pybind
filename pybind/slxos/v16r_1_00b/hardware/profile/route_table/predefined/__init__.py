...
class predefined(PybindBase):
  ...
  from YANG module brocade-hardware - based on the path /hardware/profile/route-table/predefined. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__routing_profiletype = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'ipv4-min-v6': {'value': 3}, u'ipv6-max-route': {'value': 4}, u'default': {'value': 0}, u'ipv4-max-arp': {'value': 2}, u'ipv4-max-route': {'value': 1}, u'ipv6-max-nd': {'value': 5}},), is_leaf=True, yang_name="routing_profiletype", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-hardware', defining_module='brocade-hardware', yang_type='routing-profile-subtype', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'hardware', u'profile', u'route-table', u'predefined']
  ...
  def _set_routing_profiletype(self, v, load=False):
    """
    Setter method for routing_profiletype, mapped from YANG variable /hardware/profile/route_table/predefined/routing_profiletype (routing-profile-subtype)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'ipv4-min-v6': {'value': 3}, u'ipv6-max-route': {'value': 4}, u'default': {'value': 0}, u'ipv4-max-arp': {'value': 2}, u'ipv4-max-route': {'value': 1}, u'ipv6-max-nd': {'value': 5}},), is_leaf=True, yang_name="routing_profiletype", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-hardware', defining_module='brocade-hardware', yang_type='routing-profile-subtype', is_config=True)
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'ipv4-min-v6': {'value': 3}, u'ipv6-max-route': {'value': 4}, u'default': {'value': 0}, u'ipv4-max-arp': {'value': 2}, u'ipv4-max-route': {'value': 1}, u'ipv6-max-nd': {'value': 5}},), is_leaf=True, yang_name="routing_profiletype", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-hardware', defining_module='brocade-hardware', yang_type='routing-profile-subtype', is_config=True)""",
        })
  ...
  def _set_routing_parameter(self, v, load=False):
    """
    Setter method for routing_parameter, mapped from YANG variable /hardware/profile/route_table/predefined/routing_parameter (container)
    If this variable is read-only (config: false) in the
