...
class policy_map(PybindBase):
  ...
  from YANG module brocade-qos-mqc - based on the path /policy-map. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__name','__class_',)

  _yang_name = 'policy-map'
  _rest_name = 'policy-map'
  ...
  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /policy_map/name (map-name-type)
    """
    return self.__name
      
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /policy_map/name (map-name-type)
  ...
  _pyangbind_elements = {'name': name, 'class_': class_, }
