...
class set_cos_tc(PybindBase):
  ...
  from YANG module brocade-qos-mqc - based on the path /policy-map/class/set/set_cos_tc. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__cos','__traffic_class',)
