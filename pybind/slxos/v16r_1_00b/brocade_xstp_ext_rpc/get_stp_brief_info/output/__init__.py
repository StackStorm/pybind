...
import __builtin__
import spanning_tree_info
import last_instance
class output(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-xstp-ext - based on the path /brocade_xstp_ext_rpc/get-stp-brief-info/output. Each member element of
  ...
  def _get_spanning_tree_info(self):
    """
    Getter method for spanning_tree_info, mapped from YANG variable /brocade_xstp_ext_rpc/get_stp_brief_info/output/spanning_tree_info (container)
    """
    return self.__spanning_tree_info
      
  def _set_spanning_tree_info(self, v, load=False):
    """
    Setter method for spanning_tree_info, mapped from YANG variable /brocade_xstp_ext_rpc/get_stp_brief_info/output/spanning_tree_info (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_spanning_tree_info is considered as a private
  ...
  def _get_has_more(self):
    """
    Getter method for has_more, mapped from YANG variable /brocade_xstp_ext_rpc/get_stp_brief_info/output/has_more (boolean)
...
subsequent RPC call.
  ...
  def _set_has_more(self, v, load=False):
    """
    Setter method for has_more, mapped from YANG variable /brocade_xstp_ext_rpc/get_stp_brief_info/output/has_more (boolean)
    If this variable is read-only (config: false) in the
...
subsequent RPC call.
  ...
  def _get_last_instance(self):
    """
    Getter method for last_instance, mapped from YANG variable /brocade_xstp_ext_rpc/get_stp_brief_info/output/last_instance (container)
...
response.
  ...
  def _set_last_instance(self, v, load=False):
    """
    Setter method for last_instance, mapped from YANG variable /brocade_xstp_ext_rpc/get_stp_brief_info/output/last_instance (container)
    If this variable is read-only (config: false) in the
...
response.
  ...
  _pyangbind_elements = {'spanning_tree_info': spanning_tree_info, 'has_more': has_more, 'last_instance': last_instance, }
