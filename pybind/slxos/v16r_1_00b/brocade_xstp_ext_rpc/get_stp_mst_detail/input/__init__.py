...
class input(PybindBase):
  ...
  from YANG module brocade-xstp-ext - based on the path /brocade_xstp_ext_rpc/get-stp-mst-detail/input. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_xstp_ext_rpc', u'get-stp-mst-detail', u'input']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'get-stp-mst-detail', u'input']

  def _get_last_rcvd_instance(self):
    """
    Getter method for last_rcvd_instance, mapped from YANG variable /brocade_xstp_ext_rpc/get_stp_mst_detail/input/last_rcvd_instance (container)
    """
    return self.__last_rcvd_instance
      
  def _set_last_rcvd_instance(self, v, load=False):
    """
    Setter method for last_rcvd_instance, mapped from YANG variable /brocade_xstp_ext_rpc/get_stp_mst_detail/input/last_rcvd_instance (container)
