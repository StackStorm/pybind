...
class lag(PybindBase):
  ...
  from YANG module brocade-rbridge-lag - based on the path /load-balance-lag/lag. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'load-balance-lag', u'lag']
  ...
  def _set_hash(self, v, load=False):
    """
    Setter method for hash, mapped from YANG variable /load_balance_lag/lag/hash (container)
