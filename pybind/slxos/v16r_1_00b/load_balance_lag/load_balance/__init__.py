...
import __builtin__
import hash
class load_balance(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-rbridge-lag - based on the path /load-balance-lag/load-balance. Each member element of
  ...
  def _set_hash(self, v, load=False):
    """
    Setter method for hash, mapped from YANG variable /load_balance_lag/load_balance/hash (container)
