...
import __builtin__
import igmp_l3_interfaces_
class igmp_l3_interfaces(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mc-hms-operational - based on the path /igmp-snooping-state/igmp-l3-interfaces. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Igmp L3 interface List
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__interface_name','__igmp_l3_interfaces',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__igmp_l3_interfaces = YANGDynClass(base=YANGListType("interface_name",igmp_l3_interfaces_.igmp_l3_interfaces, yang_name="igmp-l3-interfaces", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='interface-name', extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-l3-interface', u'cli-suppress-show-path': None}}), is_container='list', yang_name="igmp-l3-interfaces", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-l3-interface', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mc-hms-operational', defining_module='brocade-mc-hms-operational', yang_type='list', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'igmp-snooping-state', u'igmp-l3-interfaces']
  ...
  def _get_interface_name(self):
    """
    Getter method for interface_name, mapped from YANG variable /igmp_snooping_state/igmp_l3_interfaces/interface_name (string)
  ...
  def _set_interface_name(self, v, load=False):
    """
    Setter method for interface_name, mapped from YANG variable /igmp_snooping_state/igmp_l3_interfaces/interface_name (string)
  ...
  def _get_igmp_l3_interfaces(self):
    """
    Getter method for igmp_l3_interfaces, mapped from YANG variable /igmp_snooping_state/igmp_l3_interfaces/igmp_l3_interfaces (list)
  ...
  def _set_igmp_l3_interfaces(self, v, load=False):
    """
    Setter method for igmp_l3_interfaces, mapped from YANG variable /igmp_snooping_state/igmp_l3_interfaces/igmp_l3_interfaces (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'interface_name': interface_name, 'igmp_l3_interfaces': igmp_l3_interfaces, }
