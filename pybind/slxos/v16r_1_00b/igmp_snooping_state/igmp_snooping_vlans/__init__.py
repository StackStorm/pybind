...
class igmp_snooping_vlans(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__vlan_id','__igmp_snooping_vlans',)
