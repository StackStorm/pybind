...
class pim_snp_sources(PybindBase):
  ...
  def _get_src_addr(self):
    """
    Getter method for src_addr, mapped from YANG variable /igmp_snooping_state/pim_snp_groups/pim_snp_groups/pim_snp_sources/src_addr (uint32)
  ...
  def _set_src_addr(self, v, load=False):
    """
    Setter method for src_addr, mapped from YANG variable /igmp_snooping_state/pim_snp_groups/pim_snp_groups/pim_snp_sources/src_addr (uint32)
