...
import __builtin__
import pim_snp_groups_
class pim_snp_groups(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mc-hms-operational - based on the path /igmp-snooping-state/pim-snp-groups. Each member element of
  ...
  def _get_vlan_id(self):
    """
    Getter method for vlan_id, mapped from YANG variable /igmp_snooping_state/pim_snp_groups/vlan_id (uint32)
  ...
  def _set_vlan_id(self, v, load=False):
    """
    Setter method for vlan_id, mapped from YANG variable /igmp_snooping_state/pim_snp_groups/vlan_id (uint32)
  ...
  def _get_pim_snp_groups(self):
    """
    Getter method for pim_snp_groups, mapped from YANG variable /igmp_snooping_state/pim_snp_groups/pim_snp_groups (list)
  ...
  def _set_pim_snp_groups(self, v, load=False):
    """
    Setter method for pim_snp_groups, mapped from YANG variable /igmp_snooping_state/pim_snp_groups/pim_snp_groups (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'vlan_id': vlan_id, 'pim_snp_groups': pim_snp_groups, }
