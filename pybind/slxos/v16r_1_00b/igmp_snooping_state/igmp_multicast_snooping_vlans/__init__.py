...
import __builtin__
import igmp_multicast_snooping_vlans_
class igmp_multicast_snooping_vlans(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mc-hms-operational - based on the path /igmp-snooping-state/igmp-multicast-snooping-vlans. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Multicast snooping vlan
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__vlan_id','__igmp_multicast_snooping_vlans',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'igmp-snooping-state', u'igmp-multicast-snooping-vlans']
  ...
  def _get_vlan_id(self):
    """
    Getter method for vlan_id, mapped from YANG variable /igmp_snooping_state/igmp_multicast_snooping_vlans/vlan_id (uint32)
  ...
  def _set_vlan_id(self, v, load=False):
    """
    Setter method for vlan_id, mapped from YANG variable /igmp_snooping_state/igmp_multicast_snooping_vlans/vlan_id (uint32)
  ...
  def _get_igmp_multicast_snooping_vlans(self):
    """
    Getter method for igmp_multicast_snooping_vlans, mapped from YANG variable /igmp_snooping_state/igmp_multicast_snooping_vlans/igmp_multicast_snooping_vlans (list)
  ...
  def _set_igmp_multicast_snooping_vlans(self, v, load=False):
    """
    Setter method for igmp_multicast_snooping_vlans, mapped from YANG variable /igmp_snooping_state/igmp_multicast_snooping_vlans/igmp_multicast_snooping_vlans (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'vlan_id': vlan_id, 'igmp_multicast_snooping_vlans': igmp_multicast_snooping_vlans, }
