...
import __builtin__
class fcoe_fsb(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-fcoe - based on the path /fcoe-fsb. Each member element of
  ...
  def _get_fcoe_fsb_enable(self):
    """
    Getter method for fcoe_fsb_enable, mapped from YANG variable /fcoe_fsb/fcoe_fsb_enable (empty)

    YANG Description: The presence of this leaf specifies that fsb
mode is enabled.
    """
    return self.__fcoe_fsb_enable
      
  def _set_fcoe_fsb_enable(self, v, load=False):
    """
    Setter method for fcoe_fsb_enable, mapped from YANG variable /fcoe_fsb/fcoe_fsb_enable (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_fcoe_fsb_enable is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_fcoe_fsb_enable() directly.
...
mode is enabled.
  ...
  _pyangbind_elements = {'fcoe_fsb_enable': fcoe_fsb_enable, }
