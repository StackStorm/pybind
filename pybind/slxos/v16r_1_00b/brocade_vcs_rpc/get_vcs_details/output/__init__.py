...
class output(PybindBase):
  ...
  from YANG module brocade-vcs - based on the path /brocade_vcs_rpc/get-vcs-details/output. Each member element of
  ...
  def _get_vcs_details(self):
    """
    Getter method for vcs_details, mapped from YANG variable /brocade_vcs_rpc/get_vcs_details/output/vcs_details (container)
    """
    return self.__vcs_details
      
  def _set_vcs_details(self, v, load=False):
    """
    Setter method for vcs_details, mapped from YANG variable /brocade_vcs_rpc/get_vcs_details/output/vcs_details (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_vcs_details is considered as a private
  ...
  _pyangbind_elements = {'vcs_details': vcs_details, }
