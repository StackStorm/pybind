...
import __builtin__
class xpath_strings(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-vcs - based on the path /brocade_vcs_rpc/get-last-config-update-time-for-xpaths/input/xpath-strings. Each member element of
  ...
  def _get_xpath_string(self):
    """
    Getter method for xpath_string, mapped from YANG variable /brocade_vcs_rpc/get_last_config_update_time_for_xpaths/input/xpath_strings/xpath_string (string)
    """
    return self.__xpath_string
      
  def _set_xpath_string(self, v, load=False):
    """
    Setter method for xpath_string, mapped from YANG variable /brocade_vcs_rpc/get_last_config_update_time_for_xpaths/input/xpath_strings/xpath_string (string)
  ...
  _pyangbind_elements = {'xpath_string': xpath_string, }
