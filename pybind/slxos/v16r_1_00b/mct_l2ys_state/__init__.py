...
class mct_l2ys_state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-l2sys-operational - based on the path /mct-l2ys-state. Each member element of
  ...
  def _get_show_cluster_mem_vlan(self):
    """
    Getter method for show_cluster_mem_vlan, mapped from YANG variable /mct_l2ys_state/show_cluster_mem_vlan (list)
    """
    return self.__show_cluster_mem_vlan
      
  def _set_show_cluster_mem_vlan(self, v, load=False):
    """
    Setter method for show_cluster_mem_vlan, mapped from YANG variable /mct_l2ys_state/show_cluster_mem_vlan (list)
  ...
  _pyangbind_elements = {'show_cluster_mem_vlan': show_cluster_mem_vlan, }
