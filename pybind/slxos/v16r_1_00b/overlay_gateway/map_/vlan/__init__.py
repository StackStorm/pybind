...
class vlan(PybindBase):
  ...
  from YANG module brocade-tunnels - based on the path /overlay-gateway/map/vlan. Each member element of
  ...
  def _get_vni(self):
    """
    Getter method for vni, mapped from YANG variable /overlay_gateway/map/vlan/vni (container)
    """
    return self.__vni
      
  def _set_vni(self, v, load=False):
    """
    Setter method for vni, mapped from YANG variable /overlay_gateway/map/vlan/vni (container)
