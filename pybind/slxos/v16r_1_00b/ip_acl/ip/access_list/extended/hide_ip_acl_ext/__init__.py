...
import __builtin__
import seq
class hide_ip_acl_ext(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-ip-access-list - based on the path /ip-acl/ip/access-list/extended/hide-ip-acl-ext. Each member element of
  ...
  def _get_seq(self):
    """
    Getter method for seq, mapped from YANG variable /ip_acl/ip/access_list/extended/hide_ip_acl_ext/seq (list)
    """
    return self.__seq
      
  def _set_seq(self, v, load=False):
    """
    Setter method for seq, mapped from YANG variable /ip_acl/ip/access_list/extended/hide_ip_acl_ext/seq (list)
