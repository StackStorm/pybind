...
import __builtin__
class radius_server_options(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-aaa - based on the path /radius-server/host/radius-server-options. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__auth_port','__protocol','__key','__encryption_level','__retries','__timeout',)

  _yang_name = 'radius-server-options'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'radius-server', u'host', u'radius-server-options']
  ...
  def _get_auth_port(self):
    """
    Getter method for auth_port, mapped from YANG variable /radius_server/host/radius_server_options/auth_port (rad-auth-port)
    """
    return self.__auth_port
      
  def _set_auth_port(self, v, load=False):
    """
    Setter method for auth_port, mapped from YANG variable /radius_server/host/radius_server_options/auth_port (rad-auth-port)
  ...
  def _get_protocol(self):
    """
    Getter method for protocol, mapped from YANG variable /radius_server/host/radius_server_options/protocol (rad-auth-protocols)
    """
    return self.__protocol
      
  def _set_protocol(self, v, load=False):
    """
    Setter method for protocol, mapped from YANG variable /radius_server/host/radius_server_options/protocol (rad-auth-protocols)
    If this variable is read-only (config: false) in the
  ...
  def _get_key(self):
    """
    Getter method for key, mapped from YANG variable /radius_server/host/radius_server_options/key (string)
    """
    return self.__key
      
  def _set_key(self, v, load=False):
    """
    Setter method for key, mapped from YANG variable /radius_server/host/radius_server_options/key (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_encryption_level(self):
    """
    Getter method for encryption_level, mapped from YANG variable /radius_server/host/radius_server_options/encryption_level (enumeration)
    """
    return self.__encryption_level
      
  def _set_encryption_level(self, v, load=False):
    """
    Setter method for encryption_level, mapped from YANG variable /radius_server/host/radius_server_options/encryption_level (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_retries(self):
    """
    Getter method for retries, mapped from YANG variable /radius_server/host/radius_server_options/retries (uint32)
    """
    return self.__retries
      
  def _set_retries(self, v, load=False):
    """
    Setter method for retries, mapped from YANG variable /radius_server/host/radius_server_options/retries (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _set_timeout(self, v, load=False):
    """
    Setter method for timeout, mapped from YANG variable /radius_server/host/radius_server_options/timeout (uint32)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'auth_port': auth_port, 'protocol': protocol, 'key': key, 'encryption_level': encryption_level, 'retries': retries, 'timeout': timeout, }
