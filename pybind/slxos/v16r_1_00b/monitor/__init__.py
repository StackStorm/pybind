...
class monitor(PybindBase):
  ...
  from YANG module brocade-span - based on the path /monitor. Each member element of
  ...
  def _get_session(self):
    """
    Getter method for session, mapped from YANG variable /monitor/session (list)
    """
    return self.__session
      
  def _set_session(self, v, load=False):
    """
    Setter method for session, mapped from YANG variable /monitor/session (list)
