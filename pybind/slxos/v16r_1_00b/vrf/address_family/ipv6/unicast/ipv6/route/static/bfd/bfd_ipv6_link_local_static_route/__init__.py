...
class bfd_ipv6_link_local_static_route(PybindBase):
  ...
  from YANG module brocade-vrf - based on the path /vrf/address-family/ipv6/unicast/ipv6/route/static/bfd/bfd-ipv6-link-local-static-route. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__bfd_ipv6_interval_attributes = YANGDynClass(base=bfd_ipv6_interval_attributes.bfd_ipv6_interval_attributes, is_container='container', presence=False, yang_name="bfd-ipv6-interval-attributes", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-incomplete-no': None, u'cli-compact-syntax': None, u'cli-drop-node-name': None, u'cli-sequence-commands': None, u'cli-incomplete-command': None, u'hidden': u'full'}}, namespace='urn:brocade.com:mgmt:brocade-ipv6-rtm', defining_module='brocade-ipv6-rtm', yang_type='container', is_config=True)
    self.__bfd_interface_type = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'ethernet': {'value': 1}, u'null': {'value': 5}, u've': {'value': 4}},), is_leaf=True, yang_name="bfd-interface-type", rest_name="bfd-interface-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Outgoing interface type'}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-ipv6-rtm', defining_module='brocade-ipv6-rtm', yang_type='enumeration', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ipv6', u'unicast', u'ipv6', u'route', u'static', u'bfd', u'bfd-ipv6-link-local-static-route']
  ...
  def _set_bfd_ipv6_link_local_dest(self, v, load=False):
    """
    Setter method for bfd_ipv6_link_local_dest, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route/bfd_ipv6_link_local_dest (inet:ipv6-address)
  ...
  def _set_bfd_ipv6_link_local_src(self, v, load=False):
    """
    Setter method for bfd_ipv6_link_local_src, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route/bfd_ipv6_link_local_src (inet:ipv6-address)
    If this variable is read-only (config: false) in the
  ...
  def _set_bfd_interface_type(self, v, load=False):
    """
    Setter method for bfd_interface_type, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route/bfd_interface_type (enumeration)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'ethernet': {'value': 1}, u'null': {'value': 5}, u've': {'value': 4}},), is_leaf=True, yang_name="bfd-interface-type", rest_name="bfd-interface-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Outgoing interface type'}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-ipv6-rtm', defining_module='brocade-ipv6-rtm', yang_type='enumeration', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """bfd_interface_type must be of a type compatible with enumeration""",
          'defined-type': "brocade-ipv6-rtm:enumeration",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'ethernet': {'value': 1}, u'null': {'value': 5}, u've': {'value': 4}},), is_leaf=True, yang_name="bfd-interface-type", rest_name="bfd-interface-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Outgoing interface type'}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-ipv6-rtm', defining_module='brocade-ipv6-rtm', yang_type='enumeration', is_config=True)""",
        })
  ...
  def _set_bfd_interface_name(self, v, load=False):
    """
    Setter method for bfd_interface_name, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route/bfd_interface_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _set_bfd_ipv6_interval_attributes(self, v, load=False):
    """
    Setter method for bfd_ipv6_interval_attributes, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route/bfd_ipv6_interval_attributes (container)
    If this variable is read-only (config: false) in the
