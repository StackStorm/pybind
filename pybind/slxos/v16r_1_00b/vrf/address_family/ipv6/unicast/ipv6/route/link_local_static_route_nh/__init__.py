...
class link_local_static_route_nh(PybindBase):
  ...
  from YANG module brocade-vrf - based on the path /vrf/address-family/ipv6/unicast/ipv6/route/link-local-static-route-nh. Each member element of
  ...
  def _get_link_local_static_route_dest(self):
    """
    Getter method for link_local_static_route_dest, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/link_local_static_route_nh/link_local_static_route_dest (inet:ipv6-prefix)
    """
    return self.__link_local_static_route_dest
      
  def _set_link_local_static_route_dest(self, v, load=False):
    """
    Setter method for link_local_static_route_dest, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/link_local_static_route_nh/link_local_static_route_dest (inet:ipv6-prefix)
  ...
  def _get_link_local_nexthop(self):
    """
    Getter method for link_local_nexthop, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/link_local_static_route_nh/link_local_nexthop (inet:ipv6-address)
    """
    return self.__link_local_nexthop
      
  def _set_link_local_nexthop(self, v, load=False):
    """
    Setter method for link_local_nexthop, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/link_local_static_route_nh/link_local_nexthop (inet:ipv6-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_link_local_route_oif_type(self):
    """
    Getter method for link_local_route_oif_type, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/link_local_static_route_nh/link_local_route_oif_type (enumeration)
    """
    return self.__link_local_route_oif_type
      
  def _set_link_local_route_oif_type(self, v, load=False):
    """
    Setter method for link_local_route_oif_type, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/link_local_static_route_nh/link_local_route_oif_type (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_link_local_route_oif_name(self):
    """
    Getter method for link_local_route_oif_name, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/link_local_static_route_nh/link_local_route_oif_name (string)
    """
    return self.__link_local_route_oif_name
      
  def _set_link_local_route_oif_name(self, v, load=False):
    """
    Setter method for link_local_route_oif_name, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/link_local_static_route_nh/link_local_route_oif_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_route_attributes(self):
    """
    Getter method for route_attributes, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/link_local_static_route_nh/route_attributes (container)
    """
    return self.__route_attributes
      
  def _set_route_attributes(self, v, load=False):
    """
    Setter method for route_attributes, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/link_local_static_route_nh/route_attributes (container)
    If this variable is read-only (config: false) in the
