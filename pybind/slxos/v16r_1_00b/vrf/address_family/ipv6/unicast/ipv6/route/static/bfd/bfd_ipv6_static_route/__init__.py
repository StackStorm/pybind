...
class bfd_ipv6_static_route(PybindBase):
  ...
  from YANG module brocade-vrf - based on the path /vrf/address-family/ipv6/unicast/ipv6/route/static/bfd/bfd-ipv6-static-route. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ipv6', u'unicast', u'ipv6', u'route', u'static', u'bfd', u'bfd-ipv6-static-route']
  ...
  def _set_bfd_ipv6_static_route_dest(self, v, load=False):
    """
    Setter method for bfd_ipv6_static_route_dest, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_static_route/bfd_ipv6_static_route_dest (inet:ipv6-address)
  ...
  def _set_bfd_ipv6_static_route_src(self, v, load=False):
    """
    Setter method for bfd_ipv6_static_route_src, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_static_route/bfd_ipv6_static_route_src (inet:ipv6-address)
    If this variable is read-only (config: false) in the
  ...
  def _set_bfd_ipv6_interval_attributes(self, v, load=False):
    """
    Setter method for bfd_ipv6_interval_attributes, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_static_route/bfd_ipv6_interval_attributes (container)
    If this variable is read-only (config: false) in the
