...
class redist_bgp(PybindBase):
  ...
  from YANG module brocade-isis-operational - based on the path /isis-state/router-isis-config/is-address-family-v6/redist-bgp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'isis-state', u'router-isis-config', u'is-address-family-v6', u'redist-bgp']
