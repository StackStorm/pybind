...
import __builtin__
class lsp_info(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-isis-operational - based on the path /isis-state/ipv4-routes/ipv4-route-entry/nh-info/lsp-info. Each member element of
  ...
  def _get_lsp_name(self):
    """
    Getter method for lsp_name, mapped from YANG variable /isis_state/ipv4_routes/ipv4_route_entry/nh_info/lsp_info/lsp_name (string)
  ...
  def _set_lsp_name(self, v, load=False):
    """
    Setter method for lsp_name, mapped from YANG variable /isis_state/ipv4_routes/ipv4_route_entry/nh_info/lsp_info/lsp_name (string)
