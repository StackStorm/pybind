...
BFD         Bidirectional Forwarding Detection (RFC 5880)
  ...
  _pyangbind_elements = {'nsx_controller': nsx_controller, 'overlay_gateway': overlay_gateway, }
...
class brocade_pim_operational(PybindBase):
  ...
  def _get_pim_global_state(self):
    """
    Getter method for pim_global_state, mapped from YANG variable /pim_global_state (container)
  ...
  def _set_pim_global_state(self, v, load=False):
    """
    Setter method for pim_global_state, mapped from YANG variable /pim_global_state (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'pim_global_state': pim_global_state, 'pim_anycast_state': pim_anycast_state, 'pim_ecmp_state': pim_ecmp_state, }
...
class brocade_dot1ag_operational(PybindBase):
  ...
  _pyangbind_elements = {'cfm_state': cfm_state, }
...
class brocade_nsm_operational(PybindBase):
  ...
  _pyangbind_elements = {'bridge_domain_state': bridge_domain_state, 'logical_interface_state': logical_interface_state, 'mct_state': mct_state, 'sub_interface_statistics_state': sub_interface_statistics_state, 'topology_group_state': topology_group_state, }
...
elements of this managed device.
  ...
  _pyangbind_elements = {'interface': interface, 'interface_vlan': interface_vlan, }
...
used derived YANG data types within the 'Broacde' name-space.
  ...
  _pyangbind_elements = {'show': show, 'ipv6': ipv6, 'routing_system': routing_system, }
...
class brocade_ssm_operational(PybindBase):
  ...
  def _get_acl_state(self):
    """
    Getter method for acl_state, mapped from YANG variable /acl_state (container)

    YANG Description:  Vxlan ACL information
    """
    return self.__acl_state
  ...
  def _get_overlay_transit_state(self):
    """
    Getter method for overlay_transit_state, mapped from YANG variable /overlay_transit_state (container)
  ...
  def _set_overlay_transit_state(self, v, load=False):
    """
    Setter method for overlay_transit_state, mapped from YANG variable /overlay_transit_state (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_vxlan_stats_acl_state(self):
    """
    Getter method for vxlan_stats_acl_state, mapped from YANG variable /vxlan_stats_acl_state (container)

    YANG Description:  Vxlan stats ACL information
    """
    return self.__vxlan_stats_acl_state
      
  def _set_vxlan_stats_acl_state(self, v, load=False):
    """
  ...
  vxlan_stats_acl_state = __builtin__.property(_get_vxlan_stats_acl_state, _set_vxlan_stats_acl_state)


  _pyangbind_elements = {'acl_state': acl_state, 'overlay_transit_state': overlay_transit_state, 'vxlan_stats_acl_state': vxlan_stats_acl_state, }
