...
class arp(PybindBase):
  ...
  from YANG module brocade-dai - based on the path /dai-config/arp. Each member element of
  ...
  def _get_access_list(self):
    """
    Getter method for access_list, mapped from YANG variable /dai_config/arp/access_list (list)
    """
    return self.__access_list
      
  def _set_access_list(self, v, load=False):
    """
    Setter method for access_list, mapped from YANG variable /dai_config/arp/access_list (list)
    ...
    try:
      ...
      raise ValueError({
          'error-string': """access_list must be of a type compatible with list""",
          'defined-type': "list",
