...
class permit(PybindBase):
  ...
  from YANG module brocade-dai - based on the path /dai-config/arp/access-list/permit. Each member element of
  ...
  def _get_permit_list(self):
    """
    Getter method for permit_list, mapped from YANG variable /dai_config/arp/access_list/permit/permit_list (list)
    """
    return self.__permit_list
      
  def _set_permit_list(self, v, load=False):
    """
    Setter method for permit_list, mapped from YANG variable /dai_config/arp/access_list/permit/permit_list (list)
  ...
  _pyangbind_elements = {'permit_list': permit_list, }
