...
class to(PybindBase):
  ...
  from YANG module brocade-qos-mpls - based on the path /qos-mpls/map/dscp-exp/dscp/to. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__exp',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos-mpls', u'map', u'dscp-exp', u'dscp', u'to']
  ...
  def _set_exp(self, v, load=False):
    """
    Setter method for exp, mapped from YANG variable /qos_mpls/map/dscp_exp/dscp/to/exp (uint32)
