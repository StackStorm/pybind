...
class exp(PybindBase):
  ...
  from YANG module brocade-qos-mpls - based on the path /qos-mpls/map/exp-dscp/exp. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__exp_in_values','__to',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos-mpls', u'map', u'exp-dscp', u'exp']
  ...
  def _set_exp_in_values(self, v, load=False):
    """
    Setter method for exp_in_values, mapped from YANG variable /qos_mpls/map/exp_dscp/exp/exp_in_values (uint32)
  ...
  def _set_to(self, v, load=False):
    """
    Setter method for to, mapped from YANG variable /qos_mpls/map/exp_dscp/exp/to (container)
    If this variable is read-only (config: false) in the
