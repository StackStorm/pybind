...
import __builtin__
import source
class acl_mirror(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-ip-access-list - based on the path /acl-mirror. Each member element of
  ...
  def _get_source(self):
    """
    Getter method for source, mapped from YANG variable /acl_mirror/source (list)
    """
  ...
  _pyangbind_elements = {'source': source, }
