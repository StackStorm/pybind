...
class route(PybindBase):
  ...
  from YANG module brocade-fabric-service - based on the path /fabric/route. Each member element of
...
such as multicast priority.
  ...
  def _get_mcast(self):
    """
    Getter method for mcast, mapped from YANG variable /fabric/route/mcast (container)
