...
class overlay(PybindBase):
  ...
  from YANG module brocade-vxlan-visibility - based on the path /overlay. Each member element of
  ...
  def _set_access_list(self, v, load=False):
    """
    Setter method for access_list, mapped from YANG variable /overlay/access_list (container)
