...
import __builtin__
import vxlan
class type(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-vxlan-visibility - based on the path /overlay/access-list/type. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__vxlan',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'overlay', u'access-list', u'type']
  ...
  def _set_vxlan(self, v, load=False):
    """
    Setter method for vxlan, mapped from YANG variable /overlay/access_list/type/vxlan (container)
  ...
  _pyangbind_elements = {'vxlan': vxlan, }
