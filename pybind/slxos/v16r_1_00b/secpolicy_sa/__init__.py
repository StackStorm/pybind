...
import __builtin__
import secpolicy
class secpolicy_sa(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-fc-auth - based on the path /secpolicy-sa. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__secpolicy',)

  _yang_name = 'secpolicy-sa'
  ...
  def _get_secpolicy(self):
    """
    Getter method for secpolicy, mapped from YANG variable /secpolicy_sa/secpolicy (container)
    """
    return self.__secpolicy
      
  def _set_secpolicy(self, v, load=False):
    """
    Setter method for secpolicy, mapped from YANG variable /secpolicy_sa/secpolicy (container)
  ...
  _pyangbind_elements = {'secpolicy': secpolicy, }
