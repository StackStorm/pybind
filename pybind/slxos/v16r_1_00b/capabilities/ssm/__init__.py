...
import __builtin__
class ssm(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-system-capabilities - based on the path /capabilities/ssm. Each member element of
  ...
  def _get_aclTrafficType(self):
    ...
    """
    return self.__aclTrafficType
      
  def _set_aclTrafficType(self, v, load=False):
    """
    Setter method for aclTrafficType, mapped from YANG variable /capabilities/ssm/aclTrafficType (boolean)
  ...
  _pyangbind_elements = {'aclTrafficType': aclTrafficType, }
