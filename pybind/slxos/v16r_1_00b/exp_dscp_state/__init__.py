...
import __builtin__
import qos_mpls
class exp_dscp_state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-qos-operational - based on the path /exp-dscp-state. Each member element of
  ...
  _yang_name = 'exp-dscp-state'
  _rest_name = 'exp-dscp-state'
