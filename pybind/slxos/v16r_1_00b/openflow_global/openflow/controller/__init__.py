...
import __builtin__
import passive
import active_controller
class controller(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-openflow - based on the path /openflow-global/openflow/controller. Each member element of
  ...
  def _get_controller_name(self):
    """
    Getter method for controller_name, mapped from YANG variable /openflow_global/openflow/controller/controller_name (openflow-controller-name-type)
  ...
  def _set_controller_name(self, v, load=False):
    """
    Setter method for controller_name, mapped from YANG variable /openflow_global/openflow/controller/controller_name (openflow-controller-name-type)
  ...
  def _get_passive(self):
    """
    Getter method for passive, mapped from YANG variable /openflow_global/openflow/controller/passive (container)
  ...
  def _set_passive(self, v, load=False):
    """
    Setter method for passive, mapped from YANG variable /openflow_global/openflow/controller/passive (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_active_controller(self):
    """
    Getter method for active_controller, mapped from YANG variable /openflow_global/openflow/controller/active_controller (container)
    """
    return self.__active_controller
      
  def _set_active_controller(self, v, load=False):
    """
    Setter method for active_controller, mapped from YANG variable /openflow_global/openflow/controller/active_controller (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_active_controller is considered as a private
    method. Backends looking to populate this variable should
  ...
  active_controller = __builtin__.property(_get_active_controller, _set_active_controller)


  _pyangbind_elements = {'controller_name': controller_name, 'passive': passive, 'active_controller': active_controller, }
