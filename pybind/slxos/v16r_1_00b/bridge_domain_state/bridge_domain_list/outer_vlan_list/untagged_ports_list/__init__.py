...
class untagged_ports_list(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__lif_name','__lif_ifindex','__outer_vlan','__flags','__ivid','__encap_id','__ingress_stats_id','__egress_stats_id','__op_state','__service_instance',)
