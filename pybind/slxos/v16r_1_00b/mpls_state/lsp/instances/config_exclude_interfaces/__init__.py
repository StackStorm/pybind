...
import __builtin__
class config_exclude_interfaces(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls-operational - based on the path /mpls-state/lsp/instances/config-exclude-interfaces. Each member element of
  ...
  def _get_exclude_interface_name(self):
    """
    Getter method for exclude_interface_name, mapped from YANG variable /mpls_state/lsp/instances/config_exclude_interfaces/exclude_interface_name (string)

    YANG Description: lsp_exclude_interface_name
    """
    return self.__exclude_interface_name
      
  def _set_exclude_interface_name(self, v, load=False):
    """
    Setter method for exclude_interface_name, mapped from YANG variable /mpls_state/lsp/instances/config_exclude_interfaces/exclude_interface_name (string)
  ...
  _pyangbind_elements = {'exclude_interface_name': exclude_interface_name, }
