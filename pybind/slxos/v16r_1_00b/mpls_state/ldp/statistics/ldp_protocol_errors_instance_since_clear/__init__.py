...
class ldp_protocol_errors_instance_since_clear(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls-operational - based on the path /mpls-state/ldp/statistics/ldp-protocol-errors-instance-since-clear. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__protocol_errors',)

  _yang_name = 'ldp-protocol-errors-instance-since-clear'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'mpls-state', u'ldp', u'statistics', u'ldp-protocol-errors-instance-since-clear']
  ...
  def _get_protocol_errors(self):
    """
    Getter method for protocol_errors, mapped from YANG variable /mpls_state/ldp/statistics/ldp_protocol_errors_instance_since_clear/protocol_errors (list)
  ...
  def _set_protocol_errors(self, v, load=False):
    """
    Setter method for protocol_errors, mapped from YANG variable /mpls_state/ldp/statistics/ldp_protocol_errors_instance_since_clear/protocol_errors (list)
