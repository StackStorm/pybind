...
class statistics(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__ldp_protocol_errors_instance_total','__ldp_protocol_stats_instance_total','__ldp_protocol_stats_instance_since_clear','__ldp_protocol_errors_instance_since_clear',)
