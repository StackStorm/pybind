...
class ldp_protocol_errors_instance_total(PybindBase):
  ...
  from YANG module brocade-mpls-operational - based on the path /mpls-state/ldp/statistics/ldp-protocol-errors-instance-total. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'mpls-state', u'ldp', u'statistics', u'ldp-protocol-errors-instance-total']
  ...
  def _get_protocol_errors(self):
    """
    Getter method for protocol_errors, mapped from YANG variable /mpls_state/ldp/statistics/ldp_protocol_errors_instance_total/protocol_errors (list)
  ...
  def _set_protocol_errors(self, v, load=False):
    """
    Setter method for protocol_errors, mapped from YANG variable /mpls_state/ldp/statistics/ldp_protocol_errors_instance_total/protocol_errors (list)
