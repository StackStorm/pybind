...
class ldp_protocol_stats_instance_total(PybindBase):
  ...
  from YANG module brocade-mpls-operational - based on the path /mpls-state/ldp/statistics/ldp-protocol-stats-instance-total. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'mpls-state', u'ldp', u'statistics', u'ldp-protocol-stats-instance-total']
  ...
  def _get_protocol_stats(self):
    """
    Getter method for protocol_stats, mapped from YANG variable /mpls_state/ldp/statistics/ldp_protocol_stats_instance_total/protocol_stats (list)
  ...
  def _set_protocol_stats(self, v, load=False):
    """
    Setter method for protocol_stats, mapped from YANG variable /mpls_state/ldp/statistics/ldp_protocol_stats_instance_total/protocol_stats (list)
