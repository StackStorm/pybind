...
class session_ldp_stats(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls-operational - based on the path /mpls-state/ldp/ldp-session/session-ldp-stats. Each member element of
  ...
  def _set_ldp_protocol_errors_instance_total(self, v, load=False):
    """
    Setter method for ldp_protocol_errors_instance_total, mapped from YANG variable /mpls_state/ldp/ldp_session/session_ldp_stats/ldp_protocol_errors_instance_total (container)
  ...
  def _set_ldp_protocol_stats_instance_total(self, v, load=False):
    """
    Setter method for ldp_protocol_stats_instance_total, mapped from YANG variable /mpls_state/ldp/ldp_session/session_ldp_stats/ldp_protocol_stats_instance_total (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'ldp_protocol_errors_instance_total': ldp_protocol_errors_instance_total, 'ldp_protocol_stats_instance_total': ldp_protocol_stats_instance_total, }
