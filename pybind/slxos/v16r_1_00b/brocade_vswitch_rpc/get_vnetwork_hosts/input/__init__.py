...
class input(PybindBase):
  ...
  from YANG module brocade-vswitch - based on the path /brocade_vswitch_rpc/get-vnetwork-hosts/input. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__vcenter','__datacenter','__name','__last_rcvd_instance',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__name = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'length': [u'1..80']}), is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='urn:brocade.com:mgmt:brocade-vswitch', defining_module='brocade-vswitch', yang_type='string', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_vswitch_rpc', u'get-vnetwork-hosts', u'input']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'get-vnetwork-hosts', u'input']

  def _get_vcenter(self):
    """
    Getter method for vcenter, mapped from YANG variable /brocade_vswitch_rpc/get_vnetwork_hosts/input/vcenter (string)
  ...
  def _set_vcenter(self, v, load=False):
    """
    Setter method for vcenter, mapped from YANG variable /brocade_vswitch_rpc/get_vnetwork_hosts/input/vcenter (string)
  ...
  def _get_datacenter(self):
    """
    Getter method for datacenter, mapped from YANG variable /brocade_vswitch_rpc/get_vnetwork_hosts/input/datacenter (string)
  ...
  def _set_datacenter(self, v, load=False):
    """
    Setter method for datacenter, mapped from YANG variable /brocade_vswitch_rpc/get_vnetwork_hosts/input/datacenter (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /brocade_vswitch_rpc/get_vnetwork_hosts/input/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /brocade_vswitch_rpc/get_vnetwork_hosts/input/name (string)
    If this variable is read-only (config: false) in the
    ...
    """
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'length': [u'1..80']}), is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='urn:brocade.com:mgmt:brocade-vswitch', defining_module='brocade-vswitch', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """name must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'length': [u'1..80']}), is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='urn:brocade.com:mgmt:brocade-vswitch', defining_module='brocade-vswitch', yang_type='string', is_config=True)""",
        })
  ...
  def _get_last_rcvd_instance(self):
    """
    Getter method for last_rcvd_instance, mapped from YANG variable /brocade_vswitch_rpc/get_vnetwork_hosts/input/last_rcvd_instance (uint32)
  ...
  def _set_last_rcvd_instance(self, v, load=False):
    """
    Setter method for last_rcvd_instance, mapped from YANG variable /brocade_vswitch_rpc/get_vnetwork_hosts/input/last_rcvd_instance (uint32)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'vcenter': vcenter, 'datacenter': datacenter, 'name': name, 'last_rcvd_instance': last_rcvd_instance, }
