...
class input(PybindBase):
  ...
  from YANG module brocade-vswitch - based on the path /brocade_vswitch_rpc/get-vnetwork-portgroups/input. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__name','__vcenter','__datacenter','__last_rcvd_instance',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_vswitch_rpc', u'get-vnetwork-portgroups', u'input']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'get-vnetwork-portgroups', u'input']

  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /brocade_vswitch_rpc/get_vnetwork_portgroups/input/name (string)
  ...
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /brocade_vswitch_rpc/get_vnetwork_portgroups/input/name (string)
  ...
  def _get_vcenter(self):
    """
    Getter method for vcenter, mapped from YANG variable /brocade_vswitch_rpc/get_vnetwork_portgroups/input/vcenter (string)
  ...
  def _set_vcenter(self, v, load=False):
    """
    Setter method for vcenter, mapped from YANG variable /brocade_vswitch_rpc/get_vnetwork_portgroups/input/vcenter (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_datacenter(self):
    """
    Getter method for datacenter, mapped from YANG variable /brocade_vswitch_rpc/get_vnetwork_portgroups/input/datacenter (string)
  ...
  def _set_datacenter(self, v, load=False):
    """
    Setter method for datacenter, mapped from YANG variable /brocade_vswitch_rpc/get_vnetwork_portgroups/input/datacenter (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_last_rcvd_instance(self):
    """
    Getter method for last_rcvd_instance, mapped from YANG variable /brocade_vswitch_rpc/get_vnetwork_portgroups/input/last_rcvd_instance (uint32)
  ...
  def _set_last_rcvd_instance(self, v, load=False):
    """
    Setter method for last_rcvd_instance, mapped from YANG variable /brocade_vswitch_rpc/get_vnetwork_portgroups/input/last_rcvd_instance (uint32)
    If this variable is read-only (config: false) in the
