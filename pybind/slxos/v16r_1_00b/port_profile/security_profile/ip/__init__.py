...
class ip(PybindBase):
  ...
  from YANG module brocade-port-profile - based on the path /port-profile/security-profile/ip. Each member element of
...
elements.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'port-profile', u'security-profile', u'ip']
  ...
  def _get_access_group(self):
    """
    Getter method for access_group, mapped from YANG variable /port_profile/security_profile/ip/access_group (container)
...
elements of IP access list.
  ...
  def _set_access_group(self, v, load=False):
    """
    Setter method for access_group, mapped from YANG variable /port_profile/security_profile/ip/access_group (container)
