...
class allowed(PybindBase):
  ...
  from YANG module brocade-port-profile - based on the path /port-profile/vlan-profile/switchport/trunk/allowed. Each member element of
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /port_profile/vlan_profile/switchport/trunk/allowed/vlan (container)
...
configuration elements for the port profile.
  ...
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /port_profile/vlan_profile/switchport/trunk/allowed/vlan (container)
