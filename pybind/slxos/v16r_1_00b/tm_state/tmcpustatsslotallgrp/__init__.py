...
class tmcpustatsslotallgrp(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__slot_id','__enquepkt','__enqueubytes','__discardpkt','__discardbytes','__currdepth','__maxdepth',)
