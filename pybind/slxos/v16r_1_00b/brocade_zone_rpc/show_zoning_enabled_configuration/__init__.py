...
import input
import output
class show_zoning_enabled_configuration(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-zone - based on the path /brocade_zone_rpc/show-zoning-enabled-configuration. Each member element of
...
database.
  ...
  def _get_input(self):
    """
    Getter method for input, mapped from YANG variable /brocade_zone_rpc/show_zoning_enabled_configuration/input (input)
    """
    return self.__input
      
  def _set_input(self, v, load=False):
    """
    Setter method for input, mapped from YANG variable /brocade_zone_rpc/show_zoning_enabled_configuration/input (input)
  ...
  def _get_output(self):
    """
    Getter method for output, mapped from YANG variable /brocade_zone_rpc/show_zoning_enabled_configuration/output (output)
    """
    return self.__output
      
  def _set_output(self, v, load=False):
    """
    Setter method for output, mapped from YANG variable /brocade_zone_rpc/show_zoning_enabled_configuration/output (output)
    If this variable is read-only (config: false) in the
