...
import __builtin__
import show_zoning_enabled_configuration
class brocade_zone(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-zone - based on the path /brocade_zone_rpc. Each member element of
  ...
  def _get_show_zoning_enabled_configuration(self):
    """
    Getter method for show_zoning_enabled_configuration, mapped from YANG variable /brocade_zone_rpc/show_zoning_enabled_configuration (rpc)

    YANG Description: This will display the Zoning Enabled-Configuration
database.
    """
    return self.__show_zoning_enabled_configuration
...
database.
  ...
  _pyangbind_elements = {'show_zoning_enabled_configuration': show_zoning_enabled_configuration, }
