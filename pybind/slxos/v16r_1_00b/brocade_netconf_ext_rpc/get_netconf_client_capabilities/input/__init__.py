...
class input(PybindBase):
  ...
  from YANG module brocade-netconf-ext - based on the path /brocade_netconf_ext_rpc/get-netconf-client-capabilities/input. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_netconf_ext_rpc', u'get-netconf-client-capabilities', u'input']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'get-netconf-client-capabilities', u'input']

  def _get_session_id(self):
    """
    Getter method for session_id, mapped from YANG variable /brocade_netconf_ext_rpc/get_netconf_client_capabilities/input/session_id (uint32)

    YANG Description: This specifies session id for which this function
...
specified means 'all' sessions.
  ...
  def _set_session_id(self, v, load=False):
    """
    Setter method for session_id, mapped from YANG variable /brocade_netconf_ext_rpc/get_netconf_client_capabilities/input/session_id (uint32)
