...
class server_ip(PybindBase):
  ...
  from YANG module brocade-qos-cee - based on the path /nas/server-ip. Each member element of
  ...
  def _set_server_ip(self, v, load=False):
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "brocade-qos-cee:nas-ip-prefix",
