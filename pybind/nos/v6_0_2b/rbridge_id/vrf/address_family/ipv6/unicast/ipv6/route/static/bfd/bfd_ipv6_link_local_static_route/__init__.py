...
class bfd_ipv6_link_local_static_route(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/vrf/address-family/ipv6/unicast/ipv6/route/static/bfd/bfd-ipv6-link-local-static-route. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__bfd_interface_type = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u've': {'value': 4}, u'fortygigabitethernet': {'value': 6}, u'gigabitethernet': {'value': 2}, u'tengigabitethernet': {'value': 1}, u'hundredgigabitethernet': {'value': 7}, u'null': {'value': 5}},), is_leaf=True, yang_name="bfd-interface-type", rest_name="bfd-interface-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Outgoing interface type'}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-ipv6-rtm', defining_module='brocade-ipv6-rtm', yang_type='enumeration', is_config=True)
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vrf', u'address-family', u'ipv6', u'unicast', u'ipv6', u'route', u'static', u'bfd']

  def _get_bfd_ipv6_link_local_dest(self):
    """
    Getter method for bfd_ipv6_link_local_dest, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route/bfd_ipv6_link_local_dest (inet:ipv6-address)
    """
    return self.__bfd_ipv6_link_local_dest
      
  def _set_bfd_ipv6_link_local_dest(self, v, load=False):
    """
    Setter method for bfd_ipv6_link_local_dest, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route/bfd_ipv6_link_local_dest (inet:ipv6-address)
  ...
  def _get_bfd_ipv6_link_local_src(self):
    """
    Getter method for bfd_ipv6_link_local_src, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route/bfd_ipv6_link_local_src (inet:ipv6-address)
    """
    return self.__bfd_ipv6_link_local_src
      
  def _set_bfd_ipv6_link_local_src(self, v, load=False):
    """
    Setter method for bfd_ipv6_link_local_src, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route/bfd_ipv6_link_local_src (inet:ipv6-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_bfd_interface_type(self):
    """
    Getter method for bfd_interface_type, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route/bfd_interface_type (enumeration)
    """
    return self.__bfd_interface_type
      
  def _set_bfd_interface_type(self, v, load=False):
    """
    Setter method for bfd_interface_type, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route/bfd_interface_type (enumeration)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u've': {'value': 4}, u'fortygigabitethernet': {'value': 6}, u'gigabitethernet': {'value': 2}, u'tengigabitethernet': {'value': 1}, u'hundredgigabitethernet': {'value': 7}, u'null': {'value': 5}},), is_leaf=True, yang_name="bfd-interface-type", rest_name="bfd-interface-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Outgoing interface type'}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-ipv6-rtm', defining_module='brocade-ipv6-rtm', yang_type='enumeration', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """bfd_interface_type must be of a type compatible with enumeration""",
          'defined-type': "brocade-ipv6-rtm:enumeration",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u've': {'value': 4}, u'fortygigabitethernet': {'value': 6}, u'gigabitethernet': {'value': 2}, u'tengigabitethernet': {'value': 1}, u'hundredgigabitethernet': {'value': 7}, u'null': {'value': 5}},), is_leaf=True, yang_name="bfd-interface-type", rest_name="bfd-interface-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Outgoing interface type'}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-ipv6-rtm', defining_module='brocade-ipv6-rtm', yang_type='enumeration', is_config=True)""",
        })
  ...
  def _get_bfd_interface_name(self):
    """
    Getter method for bfd_interface_name, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route/bfd_interface_name (string)
    """
    return self.__bfd_interface_name
      
  def _set_bfd_interface_name(self, v, load=False):
    """
    Setter method for bfd_interface_name, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route/bfd_interface_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_bfd_ipv6_interval_attributes(self):
    """
    Getter method for bfd_ipv6_interval_attributes, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route/bfd_ipv6_interval_attributes (container)
    """
    return self.__bfd_ipv6_interval_attributes
      
  def _set_bfd_ipv6_interval_attributes(self, v, load=False):
    """
    Setter method for bfd_ipv6_interval_attributes, mapped from YANG variable /rbridge_id/vrf/address_family/ipv6/unicast/ipv6/route/static/bfd/bfd_ipv6_link_local_static_route/bfd_ipv6_interval_attributes (container)
    If this variable is read-only (config: false) in the
