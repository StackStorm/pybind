...
class alert(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/threshold-monitor/sfp/policy/area/alert. Each member element of
  ...
  def _get_above(self):
    """
    Getter method for above, mapped from YANG variable /rbridge_id/threshold_monitor/sfp/policy/area/alert/above (container)
    """
    return self.__above
      
  def _set_above(self, v, load=False):
    """
    Setter method for above, mapped from YANG variable /rbridge_id/threshold_monitor/sfp/policy/area/alert/above (container)
  ...
  def _get_below(self):
    """
    Getter method for below, mapped from YANG variable /rbridge_id/threshold_monitor/sfp/policy/area/alert/below (container)
    """
    return self.__below
      
  def _set_below(self, v, load=False):
    """
    Setter method for below, mapped from YANG variable /rbridge_id/threshold_monitor/sfp/policy/area/alert/below (container)
    If this variable is read-only (config: false) in the
