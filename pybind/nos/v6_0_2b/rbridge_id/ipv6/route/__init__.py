...
class route(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/route. Each member element of
  ...
  def _get_static_route_nh(self):
    """
    Getter method for static_route_nh, mapped from YANG variable /rbridge_id/ipv6/route/static_route_nh (list)
    """
    return self.__static_route_nh
      
  def _set_static_route_nh(self, v, load=False):
    """
    Setter method for static_route_nh, mapped from YANG variable /rbridge_id/ipv6/route/static_route_nh (list)
  ...
  def _get_static_route_oif(self):
    """
    Getter method for static_route_oif, mapped from YANG variable /rbridge_id/ipv6/route/static_route_oif (list)
    """
    return self.__static_route_oif
      
  def _set_static_route_oif(self, v, load=False):
    """
    Setter method for static_route_oif, mapped from YANG variable /rbridge_id/ipv6/route/static_route_oif (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_link_local_static_route_nh(self):
    """
    Getter method for link_local_static_route_nh, mapped from YANG variable /rbridge_id/ipv6/route/link_local_static_route_nh (list)
    """
    return self.__link_local_static_route_nh
      
  def _set_link_local_static_route_nh(self, v, load=False):
    """
    Setter method for link_local_static_route_nh, mapped from YANG variable /rbridge_id/ipv6/route/link_local_static_route_nh (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_static_route_nh_vrf(self):
    """
    Getter method for static_route_nh_vrf, mapped from YANG variable /rbridge_id/ipv6/route/static_route_nh_vrf (list)
    """
    return self.__static_route_nh_vrf
      
  def _set_static_route_nh_vrf(self, v, load=False):
    """
    Setter method for static_route_nh_vrf, mapped from YANG variable /rbridge_id/ipv6/route/static_route_nh_vrf (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_link_local_static_route_nh_vrf(self):
    """
    Getter method for link_local_static_route_nh_vrf, mapped from YANG variable /rbridge_id/ipv6/route/link_local_static_route_nh_vrf (list)
    """
    return self.__link_local_static_route_nh_vrf
      
  def _set_link_local_static_route_nh_vrf(self, v, load=False):
    """
    Setter method for link_local_static_route_nh_vrf, mapped from YANG variable /rbridge_id/ipv6/route/link_local_static_route_nh_vrf (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_ipv6_static_route_oif_vrf(self):
    """
    Getter method for ipv6_static_route_oif_vrf, mapped from YANG variable /rbridge_id/ipv6/route/ipv6_static_route_oif_vrf (list)
    """
    return self.__ipv6_static_route_oif_vrf
      
  def _set_ipv6_static_route_oif_vrf(self, v, load=False):
    """
    Setter method for ipv6_static_route_oif_vrf, mapped from YANG variable /rbridge_id/ipv6/route/ipv6_static_route_oif_vrf (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_static(self):
    """
    Getter method for static, mapped from YANG variable /rbridge_id/ipv6/route/static (container)
    """
    return self.__static
      
  def _set_static(self, v, load=False):
    """
    Setter method for static, mapped from YANG variable /rbridge_id/ipv6/route/static (container)
    If this variable is read-only (config: false) in the
