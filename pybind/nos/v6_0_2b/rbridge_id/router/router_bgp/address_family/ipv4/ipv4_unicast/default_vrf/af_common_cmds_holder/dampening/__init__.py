...
class dampening(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/address-family/ipv4/ipv4-unicast/default-vrf/af-common-cmds-holder/dampening. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'address-family', u'ipv4', u'ipv4-unicast', u'default-vrf', u'af-common-cmds-holder', u'dampening']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'address-family', u'ipv4', u'unicast', u'dampening']

  def _get_dampening_flag(self):
    """
    Getter method for dampening_flag, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_common_cmds_holder/dampening/dampening_flag (empty)
  ...
  def _set_dampening_flag(self, v, load=False):
    """
    Setter method for dampening_flag, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_common_cmds_holder/dampening/dampening_flag (empty)
  ...
  def _get_values(self):
    """
    Getter method for values, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_common_cmds_holder/dampening/values (container)
    """
    return self.__values
      
  def _set_values(self, v, load=False):
    """
    Setter method for values, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_common_cmds_holder/dampening/values (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_dampening_route_map(self):
    """
    Getter method for dampening_route_map, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_common_cmds_holder/dampening/dampening_route_map (rmap-type)
    """
    return self.__dampening_route_map
      
  def _set_dampening_route_map(self, v, load=False):
    """
    Setter method for dampening_route_map, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_common_cmds_holder/dampening/dampening_route_map (rmap-type)
    If this variable is read-only (config: false) in the
