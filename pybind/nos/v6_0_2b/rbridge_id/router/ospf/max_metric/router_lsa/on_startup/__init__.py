...
class on_startup(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/ospf/max-metric/router-lsa/on-startup. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'ospf', u'max-metric', u'router-lsa', u'on-startup']
  ...
  def _get_time(self):
    """
    Getter method for time, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/time (uint32)
    """
    return self.__time
      
  def _set_time(self, v, load=False):
    """
    Setter method for time, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/time (uint32)
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'5 ..86400']}), is_leaf=True, yang_name="time", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'DECIMAL Amount of time to advertise maximum metric,range 5 to 86400 seconds', u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='uint32', is_config=True)""",
        })
  ...
  def _get_wait_for_bgp(self):
    """
    Getter method for wait_for_bgp, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/wait_for_bgp (empty)
    """
    return self.__wait_for_bgp
      
  def _set_wait_for_bgp(self, v, load=False):
    """
    Setter method for wait_for_bgp, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/wait_for_bgp (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_all_lsas_onstartup(self):
    """
    Getter method for all_lsas_onstartup, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/all_lsas_onstartup (empty)
    """
    return self.__all_lsas_onstartup
      
  def _set_all_lsas_onstartup(self, v, load=False):
    """
    Setter method for all_lsas_onstartup, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/all_lsas_onstartup (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_external_lsa_onstartup(self):
    """
    Getter method for external_lsa_onstartup, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/external_lsa_onstartup (container)
    """
  ...
  def _get_summary_lsa_onstartup(self):
    """
    Getter method for summary_lsa_onstartup, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/summary_lsa_onstartup (container)
    """
    return self.__summary_lsa_onstartup
      
  def _set_summary_lsa_onstartup(self, v, load=False):
    """
    Setter method for summary_lsa_onstartup, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/summary_lsa_onstartup (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_link_onstartup(self):
    """
    Getter method for link_onstartup, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/link_onstartup (container)
    """
    return self.__link_onstartup
      
  def _set_link_onstartup(self, v, load=False):
    """
    Setter method for link_onstartup, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/link_onstartup (container)
    If this variable is read-only (config: false) in the
