...
class area(PybindBase):
  ...
  from YANG module brocade-threshold-monitor - based on the path /threshold-monitor-hidden/threshold-monitor/security/policy/area. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__sec_area_value','__timebase','__threshold','__alert',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'threshold-monitor-hidden', u'threshold-monitor', u'security', u'policy', u'area']
  ...
  def _get_sec_area_value(self):
    """
    Getter method for sec_area_value, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/security/policy/area/sec_area_value (enumeration)
    """
    return self.__sec_area_value
      
  def _set_sec_area_value(self, v, load=False):
    """
    Setter method for sec_area_value, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/security/policy/area/sec_area_value (enumeration)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_sec_area_value is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_sec_area_value() directly.
    """
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'telnet-violation': {'value': 0}, u'login-violation': {'value': 11}},), is_leaf=True, yang_name="sec_area_value", rest_name="area", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Security Areas', u'alt-name': u'area', u'cli-expose-key-name': None, u'cli-incomplete-command': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-threshold-monitor', defining_module='brocade-threshold-monitor', yang_type='enumeration', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """sec_area_value must be of a type compatible with enumeration""",
          'defined-type': "brocade-threshold-monitor:enumeration",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'telnet-violation': {'value': 0}, u'login-violation': {'value': 11}},), is_leaf=True, yang_name="sec_area_value", rest_name="area", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Security Areas', u'alt-name': u'area', u'cli-expose-key-name': None, u'cli-incomplete-command': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-threshold-monitor', defining_module='brocade-threshold-monitor', yang_type='enumeration', is_config=True)""",
        })

    self.__sec_area_value = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_sec_area_value(self):
    self.__sec_area_value = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'telnet-violation': {'value': 0}, u'login-violation': {'value': 11}},), is_leaf=True, yang_name="sec_area_value", rest_name="area", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Security Areas', u'alt-name': u'area', u'cli-expose-key-name': None, u'cli-incomplete-command': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-threshold-monitor', defining_module='brocade-threshold-monitor', yang_type='enumeration', is_config=True)


  def _get_timebase(self):
    """
    Getter method for timebase, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/security/policy/area/timebase (supported-timebase)
    """
    return self.__timebase
      
  def _set_timebase(self, v, load=False):
    """
    Setter method for timebase, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/security/policy/area/timebase (supported-timebase)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """timebase must be of a type compatible with supported-timebase""",
  ...
  def _get_threshold(self):
    """
    Getter method for threshold, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/security/policy/area/threshold (container)
    """
    return self.__threshold
      
  def _set_threshold(self, v, load=False):
    """
    Setter method for threshold, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/security/policy/area/threshold (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_alert(self):
    """
    Getter method for alert, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/security/policy/area/alert (container)
    """
    return self.__alert
      
  def _set_alert(self, v, load=False):
    """
    Setter method for alert, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/security/policy/area/alert (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'sec_area_value': sec_area_value, 'timebase': timebase, 'threshold': threshold, 'alert': alert, }
