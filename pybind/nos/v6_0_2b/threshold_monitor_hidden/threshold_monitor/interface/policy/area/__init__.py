...
class area(PybindBase):
  ...
  from YANG module brocade-threshold-monitor - based on the path /threshold-monitor-hidden/threshold-monitor/interface/policy/area. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'threshold-monitor-hidden', u'threshold-monitor', u'interface', u'policy', u'area']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'threshold-monitor', u'interface', u'policy']

  def _get_type(self):
    """
    Getter method for type, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/interface/policy/area/type (enumeration)
    """
    return self.__type
      
  def _set_type(self, v, load=False):
    """
    Setter method for type, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/interface/policy/area/type (enumeration)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'Ethernet': {'value': 0}},), is_leaf=True, yang_name="type", rest_name="type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Interface types that can be configured independent of speed', u'cli-expose-key-name': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-threshold-monitor', defining_module='brocade-threshold-monitor', yang_type='enumeration', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """type must be of a type compatible with enumeration""",
          'defined-type': "brocade-threshold-monitor:enumeration",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'Ethernet': {'value': 0}},), is_leaf=True, yang_name="type", rest_name="type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Interface types that can be configured independent of speed', u'cli-expose-key-name': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-threshold-monitor', defining_module='brocade-threshold-monitor', yang_type='enumeration', is_config=True)""",
        })
  ...
  def _get_area_value(self):
    """
    Getter method for area_value, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/interface/policy/area/area_value (enumeration)
    """
    return self.__area_value
      
  def _set_area_value(self, v, load=False):
    """
    Setter method for area_value, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/interface/policy/area/area_value (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_threshold(self):
    """
    Getter method for threshold, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/interface/policy/area/threshold (container)
    """
    return self.__threshold
      
  def _set_threshold(self, v, load=False):
    """
    Setter method for threshold, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/interface/policy/area/threshold (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_alert(self):
    """
    Getter method for alert, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/interface/policy/area/alert (container)
    """
    return self.__alert
      
  def _set_alert(self, v, load=False):
    """
    Setter method for alert, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/interface/policy/area/alert (container)
    If this variable is read-only (config: false) in the
