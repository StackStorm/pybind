...
class servers(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/ipv6/interface-phy-dhcp-conf/dhcp/relay/servers. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'ipv6', u'interface-phy-dhcp-conf', u'dhcp', u'relay', u'servers']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'HundredGigabitEthernet', u'ipv6', u'dhcp', u'relay']

  def _get_relay_ip_addr(self):
    """
    Getter method for relay_ip_addr, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/interface_phy_dhcp_conf/dhcp/relay/servers/relay_ip_addr (dhcp-ipv6-address)
  ...
  def _set_relay_ip_addr(self, v, load=False):
    """
    Setter method for relay_ip_addr, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/interface_phy_dhcp_conf/dhcp/relay/servers/relay_ip_addr (dhcp-ipv6-address)
  ...
  def _get_server_vrf_name(self):
    """
    Getter method for server_vrf_name, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/interface_phy_dhcp_conf/dhcp/relay/servers/server_vrf_name (common-def:vrf-name)
  ...
  def _set_server_vrf_name(self, v, load=False):
    """
    Setter method for server_vrf_name, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/interface_phy_dhcp_conf/dhcp/relay/servers/server_vrf_name (common-def:vrf-name)
    If this variable is read-only (config: false) in the
  ...
  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/interface_phy_dhcp_conf/dhcp/relay/servers/interface (container)
  ...
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/interface_phy_dhcp_conf/dhcp/relay/servers/interface (container)
    If this variable is read-only (config: false) in the
