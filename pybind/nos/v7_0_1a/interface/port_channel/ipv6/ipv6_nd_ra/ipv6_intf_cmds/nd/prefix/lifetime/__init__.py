...
class lifetime(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/ipv6/ipv6-nd-ra/ipv6-intf-cmds/nd/prefix/lifetime. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ipv6', u'ipv6-nd-ra', u'ipv6-intf-cmds', u'nd', u'prefix', u'lifetime']
  ...
  def _get_no_advertise(self):
    """
    Getter method for no_advertise, mapped from YANG variable /interface/port_channel/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/no_advertise (empty)
    """
    return self.__no_advertise
      
  def _set_no_advertise(self, v, load=False):
    """
    Setter method for no_advertise, mapped from YANG variable /interface/port_channel/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/no_advertise (empty)
  ...
  def _get_valid_lifetime(self):
    """
    Getter method for valid_lifetime, mapped from YANG variable /interface/port_channel/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/valid_lifetime (common-def:time-interval-sec)
    """
    return self.__valid_lifetime
      
  def _set_valid_lifetime(self, v, load=False):
    """
    Setter method for valid_lifetime, mapped from YANG variable /interface/port_channel/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/valid_lifetime (common-def:time-interval-sec)
    If this variable is read-only (config: false) in the
  ...
  def _get_valid_infinite(self):
    """
    Getter method for valid_infinite, mapped from YANG variable /interface/port_channel/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/valid_infinite (empty)
    """
    return self.__valid_infinite
      
  def _set_valid_infinite(self, v, load=False):
    """
    Setter method for valid_infinite, mapped from YANG variable /interface/port_channel/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/valid_infinite (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_preferred(self):
    """
    Getter method for preferred, mapped from YANG variable /interface/port_channel/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred (container)
    """
    return self.__preferred
      
  def _set_preferred(self, v, load=False):
    """
    Setter method for preferred, mapped from YANG variable /interface/port_channel/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred (container)
    If this variable is read-only (config: false) in the
