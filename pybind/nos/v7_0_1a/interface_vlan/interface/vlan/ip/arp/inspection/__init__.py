...
class inspection(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface-vlan/interface/vlan/ip/arp/inspection. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface-vlan', u'interface', u'vlan', u'ip', u'arp', u'inspection']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Vlan', u'ip', u'arp', u'inspection']

  def _get_trust(self):
    """
    Getter method for trust, mapped from YANG variable /interface_vlan/interface/vlan/ip/arp/inspection/trust (empty)
    """
    return self.__trust
      
  def _set_trust(self, v, load=False):
    """
    Setter method for trust, mapped from YANG variable /interface_vlan/interface/vlan/ip/arp/inspection/trust (empty)
  ...
  def _get_filter(self):
    """
    Getter method for filter, mapped from YANG variable /interface_vlan/interface/vlan/ip/arp/inspection/filter (container)
    """
  ...
  def _get_logging(self):
    """
    Getter method for logging, mapped from YANG variable /interface_vlan/interface/vlan/ip/arp/inspection/logging (container)
    """
    return self.__logging
      
  def _set_logging(self, v, load=False):
    """
    Setter method for logging, mapped from YANG variable /interface_vlan/interface/vlan/ip/arp/inspection/logging (container)
    If this variable is read-only (config: false) in the
