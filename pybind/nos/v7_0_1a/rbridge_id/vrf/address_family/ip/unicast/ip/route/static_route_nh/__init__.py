...
class static_route_nh(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/vrf/address-family/ip/unicast/ip/route/static-route-nh. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vrf', u'address-family', u'ip', u'unicast', u'ip', u'route', u'static-route-nh']
  ...
  def _get_static_route_dest(self):
    """
    Getter method for static_route_dest, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static_route_nh/static_route_dest (inet:ipv4-prefix)
    """
    return self.__static_route_dest
      
  def _set_static_route_dest(self, v, load=False):
    """
    Setter method for static_route_dest, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static_route_nh/static_route_dest (inet:ipv4-prefix)
  ...
  def _get_static_route_next_hop(self):
    """
    Getter method for static_route_next_hop, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static_route_nh/static_route_next_hop (inet:ipv4-address)
    """
    return self.__static_route_next_hop
      
  def _set_static_route_next_hop(self, v, load=False):
    """
    Setter method for static_route_next_hop, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static_route_nh/static_route_next_hop (inet:ipv4-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_route_attributes(self):
    """
    Getter method for route_attributes, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static_route_nh/route_attributes (container)
    """
    return self.__route_attributes
      
  def _set_route_attributes(self, v, load=False):
    """
    Setter method for route_attributes, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static_route_nh/route_attributes (container)
    If this variable is read-only (config: false) in the
