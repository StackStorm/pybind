...
class rbridge_id(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__rbridge_id','__swbd_number','__interface_nodespecific','__ip','__ipv6','__router','__switch_attributes','__system_mode','__interface','__protocol','__fcoe_config','__root','__ag','__vrrp','__vrf','__system_max','__arp_entry','__host_table','__vcs','__bfd_session_setup_delay','__evpn_instance','__bp_rate_limit','__chassis','__clock','__crypto','__default_config','__event_handler','__fabric','__fcsp','__secpolicy','__hardware_profile','__http','__route_map','__filter_change_update_delay','__global_lc_holder','__logical_chassis','__maps','__openflow','__qos','__telnet','__ssh','__snmp_server','__system_monitor','__threshold_monitor','__vrrp_rbridge_global','__spanning_tree',)
