...
class name(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__name','__delay','__iterations','__interval','__run_mode','__trigger_mode','__trigger_function_container','__action_timeout',)
  ...
  _pyangbind_elements = {'name': name, 'delay': delay, 'iterations': iterations, 'interval': interval, 'run_mode': run_mode, 'trigger_mode': trigger_mode, 'trigger_function_container': trigger_function_container, 'action_timeout': action_timeout, }
