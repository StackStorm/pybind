...
class area(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__area_id','__normal','__nssa','__range','__stub','__prefix_list','__virtual_link',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__normal = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="normal", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='empty', is_config=True)
  ...
  def _set_normal(self, v, load=False):
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "empty",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="normal", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-ospf', defining_module='brocade-ospf', yang_type='empty', is_config=True)""",
        })
  ...
  def _get_prefix_list(self):
    """
    Getter method for prefix_list, mapped from YANG variable /rbridge_id/router/ospf/area/prefix_list (container)
  ...
  def _set_prefix_list(self, v, load=False):
    """
    Setter method for prefix_list, mapped from YANG variable /rbridge_id/router/ospf/area/prefix_list (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'area_id': area_id, 'normal': normal, 'nssa': nssa, 'range': range, 'stub': stub, 'prefix_list': prefix_list, 'virtual_link': virtual_link, }
