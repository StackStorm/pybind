...
class route(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /ip/rtm-config/route. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'ip', u'rtm-config', u'route']
  ...
  def _set_static_route_nh(self, v, load=False):
    """
    Setter method for static_route_nh, mapped from YANG variable /ip/rtm_config/route/static_route_nh (list)
  ...
  def _set_static_route_nh_vrf(self, v, load=False):
    """
    Setter method for static_route_nh_vrf, mapped from YANG variable /ip/rtm_config/route/static_route_nh_vrf (list)
    If this variable is read-only (config: false) in the
  ...
  def _set_static_route_oif_vrf(self, v, load=False):
    """
    Setter method for static_route_oif_vrf, mapped from YANG variable /ip/rtm_config/route/static_route_oif_vrf (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_static_route_oif(self):
    """
    Getter method for static_route_oif, mapped from YANG variable /ip/rtm_config/route/static_route_oif (list)
    """
    return self.__static_route_oif
      
  def _set_static_route_oif(self, v, load=False):
    """
    Setter method for static_route_oif, mapped from YANG variable /ip/rtm_config/route/static_route_oif (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_static(self):
    """
    Getter method for static, mapped from YANG variable /ip/rtm_config/route/static (container)
    """
    return self.__static
      
  def _set_static(self, v, load=False):
    """
    Setter method for static, mapped from YANG variable /ip/rtm_config/route/static (container)
    If this variable is read-only (config: false) in the
