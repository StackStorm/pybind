...
class preferred(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/ipv6/ipv6-nd-ra/ipv6-intf-cmds/nd/prefix/lifetime/preferred. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'ipv6', u'ipv6-nd-ra', u'ipv6-intf-cmds', u'nd', u'prefix', u'lifetime', u'preferred']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'HundredGigabitEthernet', u'ipv6', u'nd', u'prefix']

  def _get_preferred_lifetime(self):
    """
    Getter method for preferred_lifetime, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/preferred_lifetime (common-def:time-interval-sec)
    """
    return self.__preferred_lifetime
      
  def _set_preferred_lifetime(self, v, load=False):
    """
    Setter method for preferred_lifetime, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/preferred_lifetime (common-def:time-interval-sec)
    ...
    try:
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'0..4294967295']}), is_leaf=True, yang_name="preferred-lifetime", rest_name="", parent=self, choice=(u'ch-preferred-type', u'ca-preferred-lifetime'), path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configures preferred lifetime', u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-ipv6-nd-ra', defining_module='brocade-ipv6-nd-ra', yang_type='common-def:time-interval-sec', is_config=True)""",
        })
  ...
  def _get_preferred_infinite(self):
    """
    Getter method for preferred_infinite, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/preferred_infinite (empty)
    """
    return self.__preferred_infinite
      
  def _set_preferred_infinite(self, v, load=False):
    """
    Setter method for preferred_infinite, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/preferred_infinite (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_prefix_flags(self):
    """
    Getter method for prefix_flags, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/prefix_flags (container)
    """
    return self.__prefix_flags
      
  def _set_prefix_flags(self, v, load=False):
    """
    Setter method for prefix_flags, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/prefix_flags (container)
    If this variable is read-only (config: false) in the
