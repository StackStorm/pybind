...
class name(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__name','__delay','__iterations','__interval','__run_mode','__trigger_mode','__trigger_function','__action_timeout',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__action_timeout = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), default=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32)(0), is_leaf=True, yang_name="action-timeout", rest_name="action-timeout", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Number of minutes to elapse before action is aborted.'}}, namespace='urn:brocade.com:mgmt:brocade-event-handler', defining_module='brocade-event-handler', yang_type='uint32', is_config=True)
    ...
    self.__trigger_function = YANGDynClass(base=trigger_function.trigger_function, is_container='container', presence=False, yang_name="trigger-function", rest_name="trigger-function", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'info': u'Trigger-function controls how multiple triggers are interpreted to launch the action (default = OR).', u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-event-handler', defining_module='brocade-event-handler', yang_type='container', is_config=True)
  ...
  def _get_trigger_function(self):
    """
    Getter method for trigger_function, mapped from YANG variable /rbridge_id/event_handler/activate/name/trigger_function (container)
  ...
  def _set_trigger_function(self, v, load=False):
    """
    Setter method for trigger_function, mapped from YANG variable /rbridge_id/event_handler/activate/name/trigger_function (container)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=trigger_function.trigger_function, is_container='container', presence=False, yang_name="trigger-function", rest_name="trigger-function", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'info': u'Trigger-function controls how multiple triggers are interpreted to launch the action (default = OR).', u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-event-handler', defining_module='brocade-event-handler', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """trigger_function must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=trigger_function.trigger_function, is_container='container', presence=False, yang_name="trigger-function", rest_name="trigger-function", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'info': u'Trigger-function controls how multiple triggers are interpreted to launch the action (default = OR).', u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-event-handler', defining_module='brocade-event-handler', yang_type='container', is_config=True)""",
        })
  ...
  def _get_action_timeout(self):
    """
    Getter method for action_timeout, mapped from YANG variable /rbridge_id/event_handler/activate/name/action_timeout (uint32)
    """
    return self.__action_timeout
      
  def _set_action_timeout(self, v, load=False):
    """
    Setter method for action_timeout, mapped from YANG variable /rbridge_id/event_handler/activate/name/action_timeout (uint32)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'name': name, 'delay': delay, 'iterations': iterations, 'interval': interval, 'run_mode': run_mode, 'trigger_mode': trigger_mode, 'trigger_function': trigger_function, 'action_timeout': action_timeout, }
