...
class af_neighbor_capability(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/address-family/ipv6/ipv6-unicast/default-vrf/neighbor/af-ipv6-neighbor-address-holder/af-ipv6-neighbor-address/af-neighbor-capability. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'address-family', u'ipv6', u'ipv6-unicast', u'default-vrf', u'neighbor', u'af-ipv6-neighbor-address-holder', u'af-ipv6-neighbor-address', u'af-neighbor-capability']
  ...
  def _get_orf(self):
    """
    Getter method for orf, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/neighbor/af_ipv6_neighbor_address_holder/af_ipv6_neighbor_address/af_neighbor_capability/orf (container)
    """
    return self.__orf
      
  def _set_orf(self, v, load=False):
    """
    Setter method for orf, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/neighbor/af_ipv6_neighbor_address_holder/af_ipv6_neighbor_address/af_neighbor_capability/orf (container)
  ...
  def _get_additional_paths(self):
    """
    Getter method for additional_paths, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/neighbor/af_ipv6_neighbor_address_holder/af_ipv6_neighbor_address/af_neighbor_capability/additional_paths (container)
    """
    return self.__additional_paths
      
  def _set_additional_paths(self, v, load=False):
    """
    Setter method for additional_paths, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/neighbor/af_ipv6_neighbor_address_holder/af_ipv6_neighbor_address/af_neighbor_capability/additional_paths (container)
    If this variable is read-only (config: false) in the
