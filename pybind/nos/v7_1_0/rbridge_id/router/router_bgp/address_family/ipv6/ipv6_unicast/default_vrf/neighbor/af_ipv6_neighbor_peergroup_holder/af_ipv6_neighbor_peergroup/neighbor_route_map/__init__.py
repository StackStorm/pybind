...
class neighbor_route_map(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/address-family/ipv6/ipv6-unicast/default-vrf/neighbor/af-ipv6-neighbor-peergroup-holder/af-ipv6-neighbor-peergroup/neighbor-route-map. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'address-family', u'ipv6', u'ipv6-unicast', u'default-vrf', u'neighbor', u'af-ipv6-neighbor-peergroup-holder', u'af-ipv6-neighbor-peergroup', u'neighbor-route-map']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'address-family', u'ipv6', u'unicast', u'neighbor', u'route-map']

  def _get_neighbor_route_map_direction_in(self):
    """
    Getter method for neighbor_route_map_direction_in, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/neighbor/af_ipv6_neighbor_peergroup_holder/af_ipv6_neighbor_peergroup/neighbor_route_map/neighbor_route_map_direction_in (container)
    """
    return self.__neighbor_route_map_direction_in
      
  def _set_neighbor_route_map_direction_in(self, v, load=False):
    """
    Setter method for neighbor_route_map_direction_in, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/neighbor/af_ipv6_neighbor_peergroup_holder/af_ipv6_neighbor_peergroup/neighbor_route_map/neighbor_route_map_direction_in (container)
  ...
  def _get_neighbor_route_map_direction_out(self):
    """
    Getter method for neighbor_route_map_direction_out, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/neighbor/af_ipv6_neighbor_peergroup_holder/af_ipv6_neighbor_peergroup/neighbor_route_map/neighbor_route_map_direction_out (container)
    """
    return self.__neighbor_route_map_direction_out
      
  def _set_neighbor_route_map_direction_out(self, v, load=False):
    """
    Setter method for neighbor_route_map_direction_out, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/neighbor/af_ipv6_neighbor_peergroup_holder/af_ipv6_neighbor_peergroup/neighbor_route_map/neighbor_route_map_direction_out (container)
    If this variable is read-only (config: false) in the
