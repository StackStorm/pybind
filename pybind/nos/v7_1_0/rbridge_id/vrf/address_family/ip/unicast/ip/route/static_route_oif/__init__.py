...
class static_route_oif(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/vrf/address-family/ip/unicast/ip/route/static-route-oif. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__static_route_oif_type = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'port-channel': {'value': 8}, u've': {'value': 4}, u'fortygigabitethernet': {'value': 6}, u'gigabitethernet': {'value': 2}, u'tengigabitethernet': {'value': 1}, u'hundredgigabitethernet': {'value': 7}, u'null': {'value': 5}},), is_leaf=True, yang_name="static-route-oif-type", rest_name="static-route-oif-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Outgoing interface type'}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-rtm', defining_module='brocade-rtm', yang_type='enumeration', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vrf', u'address-family', u'ip', u'unicast', u'ip', u'route', u'static-route-oif']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vrf', u'address-family', u'ipv4', u'unicast', u'ip', u'route']

  def _get_static_route_dest(self):
    """
    Getter method for static_route_dest, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static_route_oif/static_route_dest (inet:ipv4-prefix)
    """
    return self.__static_route_dest
      
  def _set_static_route_dest(self, v, load=False):
    """
    Setter method for static_route_dest, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static_route_oif/static_route_dest (inet:ipv4-prefix)
  ...
  def _get_static_route_oif_type(self):
    """
    Getter method for static_route_oif_type, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static_route_oif/static_route_oif_type (enumeration)
    """
    return self.__static_route_oif_type
      
  def _set_static_route_oif_type(self, v, load=False):
    """
    Setter method for static_route_oif_type, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static_route_oif/static_route_oif_type (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_static_route_oif_name(self):
    """
    Getter method for static_route_oif_name, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static_route_oif/static_route_oif_name (string)
    """
    return self.__static_route_oif_name
      
  def _set_static_route_oif_name(self, v, load=False):
    """
    Setter method for static_route_oif_name, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static_route_oif/static_route_oif_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_route_attributes(self):
    """
    Getter method for route_attributes, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static_route_oif/route_attributes (container)
    """
    return self.__route_attributes
      
  def _set_route_attributes(self, v, load=False):
    """
    Setter method for route_attributes, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static_route_oif/route_attributes (container)
    If this variable is read-only (config: false) in the
