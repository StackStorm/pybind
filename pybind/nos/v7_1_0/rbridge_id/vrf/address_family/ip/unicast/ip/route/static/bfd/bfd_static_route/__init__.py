...
class bfd_static_route(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/vrf/address-family/ip/unicast/ip/route/static/bfd/bfd-static-route. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vrf', u'address-family', u'ip', u'unicast', u'ip', u'route', u'static', u'bfd', u'bfd-static-route']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vrf', u'address-family', u'ipv4', u'unicast', u'ip', u'route', u'static', u'bfd']

  def _get_bfd_static_route_dest(self):
    """
    Getter method for bfd_static_route_dest, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static/bfd/bfd_static_route/bfd_static_route_dest (inet:ipv4-address)
    """
    return self.__bfd_static_route_dest
      
  def _set_bfd_static_route_dest(self, v, load=False):
    """
    Setter method for bfd_static_route_dest, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static/bfd/bfd_static_route/bfd_static_route_dest (inet:ipv4-address)
  ...
  def _get_bfd_static_route_src(self):
    """
    Getter method for bfd_static_route_src, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static/bfd/bfd_static_route/bfd_static_route_src (inet:ipv4-address)
    """
    return self.__bfd_static_route_src
      
  def _set_bfd_static_route_src(self, v, load=False):
    """
    Setter method for bfd_static_route_src, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static/bfd/bfd_static_route/bfd_static_route_src (inet:ipv4-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_bfd_interval_attributes(self):
    """
    Getter method for bfd_interval_attributes, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static/bfd/bfd_static_route/bfd_interval_attributes (container)
    """
    return self.__bfd_interval_attributes
      
  def _set_bfd_interval_attributes(self, v, load=False):
    """
    Setter method for bfd_interval_attributes, mapped from YANG variable /rbridge_id/vrf/address_family/ip/unicast/ip/route/static/bfd/bfd_static_route/bfd_interval_attributes (container)
    If this variable is read-only (config: false) in the
