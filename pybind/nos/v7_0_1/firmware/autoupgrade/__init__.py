...
import __builtin__
class autoupgrade(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-firmware - based on the path /firmware/autoupgrade. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__enable',)

  _yang_name = 'autoupgrade'
  _rest_name = 'auto-upgrade'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'firmware', u'autoupgrade']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'firmware', u'auto-upgrade']

  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /firmware/autoupgrade/enable (empty)
    """
    return self.__enable
      
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /firmware/autoupgrade/enable (empty)
