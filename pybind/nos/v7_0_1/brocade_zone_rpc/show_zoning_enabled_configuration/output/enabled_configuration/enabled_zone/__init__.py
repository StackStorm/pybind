...
import __builtin__
import member_entry
class enabled_zone(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-zone - based on the path /brocade_zone_rpc/show-zoning-enabled-configuration/output/enabled-configuration/enabled-zone. Each member element of
  ...
  def _get_zone_name(self):
    """
    Getter method for zone_name, mapped from YANG variable /brocade_zone_rpc/show_zoning_enabled_configuration/output/enabled_configuration/enabled_zone/zone_name (string)
    """
    return self.__zone_name
      
  def _set_zone_name(self, v, load=False):
    """
    Setter method for zone_name, mapped from YANG variable /brocade_zone_rpc/show_zoning_enabled_configuration/output/enabled_configuration/enabled_zone/zone_name (string)
  ...
  def _get_member_entry(self):
    """
    Getter method for member_entry, mapped from YANG variable /brocade_zone_rpc/show_zoning_enabled_configuration/output/enabled_configuration/enabled_zone/member_entry (list)
    """
    return self.__member_entry
      
  def _set_member_entry(self, v, load=False):
    """
    Setter method for member_entry, mapped from YANG variable /brocade_zone_rpc/show_zoning_enabled_configuration/output/enabled_configuration/enabled_zone/member_entry (list)
    If this variable is read-only (config: false) in the
