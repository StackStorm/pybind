...
class lacp(PybindBase):
  ...
  from YANG module brocade-hardware - based on the path /hardware/custom-profile/kap-custom-profile/lacp. Each member element of
  ...
  def _get_lacp_hello_interval(self):
    """
    Getter method for lacp_hello_interval, mapped from YANG variable /hardware/custom_profile/kap_custom_profile/lacp/lacp_hello_interval (lacp-kap-intervaltype)
    """
    return self.__lacp_hello_interval
      
  def _set_lacp_hello_interval(self, v, load=False):
    """
    Setter method for lacp_hello_interval, mapped from YANG variable /hardware/custom_profile/kap_custom_profile/lacp/lacp_hello_interval (lacp-kap-intervaltype)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_lacp_hello_interval is considered as a private
  ...
  def _get_lacp_num_entry(self):
    """
    Getter method for lacp_num_entry, mapped from YANG variable /hardware/custom_profile/kap_custom_profile/lacp/lacp_num_entry (uint32)
    """
    return self.__lacp_num_entry
      
  def _set_lacp_num_entry(self, v, load=False):
    """
    Setter method for lacp_num_entry, mapped from YANG variable /hardware/custom_profile/kap_custom_profile/lacp/lacp_num_entry (uint32)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_lacp_num_entry is considered as a private
    method. Backends looking to populate this variable should
  ...
  _pyangbind_elements = {'lacp_hello_interval': lacp_hello_interval, 'lacp_num_entry': lacp_num_entry, }
