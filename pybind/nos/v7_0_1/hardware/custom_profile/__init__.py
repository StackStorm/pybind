...
import __builtin__
import kap_custom_profile
class custom_profile(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-hardware - based on the path /hardware/custom-profile. Each member element of
  ...
  def _get_kap_custom_profile(self):
    """
    Getter method for kap_custom_profile, mapped from YANG variable /hardware/custom_profile/kap_custom_profile (list)
    """
    return self.__kap_custom_profile
  ...
  _pyangbind_elements = {'kap_custom_profile': kap_custom_profile, }
