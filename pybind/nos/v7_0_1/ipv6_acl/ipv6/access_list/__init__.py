...
class access_list(PybindBase):
  ...
  from YANG module brocade-ipv6-access-list - based on the path /ipv6-acl/ipv6/access-list. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__standard','__extended',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'ipv6-acl', u'ipv6', u'access-list']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'ipv6', u'access-list']

  def _get_standard(self):
    """
    Getter method for standard, mapped from YANG variable /ipv6_acl/ipv6/access_list/standard (list)
    """
  ...
  def _get_extended(self):
    """
    Getter method for extended, mapped from YANG variable /ipv6_acl/ipv6/access_list/extended (list)
    """
    return self.__extended
      
  def _set_extended(self, v, load=False):
    """
    Setter method for extended, mapped from YANG variable /ipv6_acl/ipv6/access_list/extended (list)
    If this variable is read-only (config: false) in the
