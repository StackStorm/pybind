...
class clock_time(PybindBase):
  ...
  def _get_rbridge_id_out(self):
    """
    Getter method for rbridge_id_out, mapped from YANG variable /brocade_clock_rpc/show_clock/output/clock_time/rbridge_id_out (common-def:rbridge-id-type)
    """
    return self.__rbridge_id_out
      
  def _set_rbridge_id_out(self, v, load=False):
    """
    Setter method for rbridge_id_out, mapped from YANG variable /brocade_clock_rpc/show_clock/output/clock_time/rbridge_id_out (common-def:rbridge-id-type)
  ...
  _pyangbind_elements = {'rbridge_id_out': rbridge_id_out, 'current_time': current_time, 'timezone': timezone, }
