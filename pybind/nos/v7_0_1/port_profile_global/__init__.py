...
import __builtin__
import port_profile
class port_profile_global(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-port-profile - based on the path /port-profile-global. Each member element of
...
to activate and MAC for a port profile.
  ...
  def _get_port_profile(self):
    """
    Getter method for port_profile, mapped from YANG variable /port_profile_global/port_profile (list)
...
associated to the port profile.  
  ...
  def _set_port_profile(self, v, load=False):
    """
    Setter method for port_profile, mapped from YANG variable /port_profile_global/port_profile (list)
