...
class group(PybindBase):
  ...
  from YANG module brocade-aaa - based on the path /ldap-server/maprole/group. Each member element of
  ...
  def _get_ad_group(self):
    """
    Getter method for ad_group, mapped from YANG variable /ldap_server/maprole/group/ad_group (string)
    """
    return self.__ad_group
      
  def _set_ad_group(self, v, load=False):
    """
    Setter method for ad_group, mapped from YANG variable /ldap_server/maprole/group/ad_group (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_ad_group is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_ad_group() directly.
    """
  ...
  def _get_switch_role(self):
    """
    Getter method for switch_role, mapped from YANG variable /ldap_server/maprole/group/switch_role (string)
    """
    return self.__switch_role
      
  def _set_switch_role(self, v, load=False):
    """
    Setter method for switch_role, mapped from YANG variable /ldap_server/maprole/group/switch_role (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_switch_role is considered as a private
    method. Backends looking to populate this variable should
  ...
  _pyangbind_elements = {'ad_group': ad_group, 'switch_role': switch_role, }
