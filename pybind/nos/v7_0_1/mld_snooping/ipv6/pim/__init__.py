...
class pim(PybindBase):
  ...
  from YANG module brocade-mld-snooping - based on the path /mld-snooping/ipv6/pim. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'mld-snooping', u'ipv6', u'pim']
  ...
  def _get_snooping(self):
    """
    Getter method for snooping, mapped from YANG variable /mld_snooping/ipv6/pim/snooping (container)
    """
    return self.__snooping
      
  def _set_snooping(self, v, load=False):
    """
    Setter method for snooping, mapped from YANG variable /mld_snooping/ipv6/pim/snooping (container)
