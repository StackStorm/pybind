...
class vlan(PybindBase):
  ...
  from YANG module brocade-vlan - based on the path /vlan. Each member element of
  ...
  def _get_classifier(self):
    """
    Getter method for classifier, mapped from YANG variable /vlan/classifier (container)
    """
    return self.__classifier
      
  def _set_classifier(self, v, load=False):
    """
    Setter method for classifier, mapped from YANG variable /vlan/classifier (container)
  ...
  def _get_dot1q(self):
    """
    Getter method for dot1q, mapped from YANG variable /vlan/dot1q (container)
    """
    return self.__dot1q
      
  def _set_dot1q(self, v, load=False):
    """
    Setter method for dot1q, mapped from YANG variable /vlan/dot1q (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_dot1q is considered as a private
    method. Backends looking to populate this variable should
  ...
  _pyangbind_elements = {'classifier': classifier, 'dot1q': dot1q, }
