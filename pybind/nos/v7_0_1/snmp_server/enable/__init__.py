...
class enable(PybindBase):
  ...
  from YANG module brocade-snmp - based on the path /snmp-server/enable. Each member element of
  ...
  def _get_trap(self):
    """
    Getter method for trap, mapped from YANG variable /snmp_server/enable/trap (container)
    """
    return self.__trap
