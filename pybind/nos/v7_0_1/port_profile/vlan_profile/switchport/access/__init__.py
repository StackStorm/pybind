...
class access(PybindBase):
  ...
  from YANG module brocade-port-profile - based on the path /port-profile/vlan-profile/switchport/access. Each member element of
...
access mode.
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /port_profile/vlan_profile/switchport/access/vlan (container)
...
configuration elements.
  ...
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /port_profile/vlan_profile/switchport/access/vlan (container)
