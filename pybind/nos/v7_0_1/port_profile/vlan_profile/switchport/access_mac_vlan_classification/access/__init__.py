...
class access(PybindBase):
  ...
  from YANG module brocade-port-profile - based on the path /port-profile/vlan-profile/switchport/access-mac-vlan-classification/access. Each member element of
...
interface.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'port-profile', u'vlan-profile', u'switchport', u'access-mac-vlan-classification', u'access']
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /port_profile/vlan_profile/switchport/access_mac_vlan_classification/access/vlan (list)
    """
    return self.__vlan
      
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /port_profile/vlan_profile/switchport/access_mac_vlan_classification/access/vlan (list)
