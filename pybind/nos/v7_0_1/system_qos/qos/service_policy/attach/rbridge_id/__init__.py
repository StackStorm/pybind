...
class rbridge_id(PybindBase):
  ...
  from YANG module brocade-policer - based on the path /system-qos/qos/service-policy/attach/rbridge-id. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system-qos', u'qos', u'service-policy', u'attach', u'rbridge-id']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'service-policy', u'attach', u'rbridge-id']

  def _get_add_(self):
    """
    Getter method for add_, mapped from YANG variable /system_qos/qos/service_policy/attach/rbridge_id/add (container)
    """
    return self.__add_
      
  def _set_add_(self, v, load=False):
    """
    Setter method for add_, mapped from YANG variable /system_qos/qos/service_policy/attach/rbridge_id/add (container)
    ...
    try:
      ...
      raise ValueError({
          'error-string': """add_ must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=add_.add_, is_container='container', yang_name="add", rest_name="add", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Add rbridges', u'cli-suppress-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-policer', defining_module='brocade-policer', yang_type='container', is_config=True)""",
        })
  ...
  def _get_remove_(self):
    """
    Getter method for remove_, mapped from YANG variable /system_qos/qos/service_policy/attach/rbridge_id/remove (container)
    """
    return self.__remove_
      
  def _set_remove_(self, v, load=False):
    """
    Setter method for remove_, mapped from YANG variable /system_qos/qos/service_policy/attach/rbridge_id/remove (container)
    If this variable is read-only (config: false) in the
