...
class system(PybindBase):
  ...
  from YANG module brocade-tunnels - based on the path /tunnel-settings/system. Each member element of
  ...
  def _get_tunnel(self):
    """
    Getter method for tunnel, mapped from YANG variable /tunnel_settings/system/tunnel (container)
    """
    return self.__tunnel
      
  def _set_tunnel(self, v, load=False):
    """
    Setter method for tunnel, mapped from YANG variable /tunnel_settings/system/tunnel (container)
