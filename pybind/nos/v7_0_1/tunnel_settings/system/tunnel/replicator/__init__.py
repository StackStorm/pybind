...
import __builtin__
class replicator(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-tunnels - based on the path /tunnel-settings/system/tunnel/replicator. Each member element of
  ...
  def _get_load_balance(self):
    """
    Getter method for load_balance, mapped from YANG variable /tunnel_settings/system/tunnel/replicator/load_balance (empty)
    """
    return self.__load_balance
      
  def _set_load_balance(self, v, load=False):
    """
    Setter method for load_balance, mapped from YANG variable /tunnel_settings/system/tunnel/replicator/load_balance (empty)
  ...
  _pyangbind_elements = {'load_balance': load_balance, }
