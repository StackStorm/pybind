...
class input(PybindBase):
  ...
  from YANG module brocade-mac-access-list - based on the path /brocade_mac_access_list_rpc/get-mac-acl-for-intf/input. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__interface_type','__interface_name','__direction',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_mac_access_list_rpc', u'get-mac-acl-for-intf', u'input']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'get-mac-acl-for-intf', u'input']

  def _get_interface_type(self):
    """
    Getter method for interface_type, mapped from YANG variable /brocade_mac_access_list_rpc/get_mac_acl_for_intf/input/interface_type (enumeration)
...
represents error scenario and should not be used.
  ...
  def _set_interface_type(self, v, load=False):
    """
    Setter method for interface_type, mapped from YANG variable /brocade_mac_access_list_rpc/get_mac_acl_for_intf/input/interface_type (enumeration)
...
represents error scenario and should not be used.
  ...
  def _get_interface_name(self):
    """
    Getter method for interface_name, mapped from YANG variable /brocade_mac_access_list_rpc/get_mac_acl_for_intf/input/interface_name (union)
...
'interface-type' must fail with an error.
  ...
  def _set_interface_name(self, v, load=False):
    """
    Setter method for interface_name, mapped from YANG variable /brocade_mac_access_list_rpc/get_mac_acl_for_intf/input/interface_name (union)
    If this variable is read-only (config: false) in the
...
'interface-type' must fail with an error.
  ...
  def _get_direction(self):
    """
    Getter method for direction, mapped from YANG variable /brocade_mac_access_list_rpc/get_mac_acl_for_intf/input/direction (enumeration)

    YANG Description: To mention the direction in which ACLs are applied
...
Ingress direction, when direction is not specified
  ...
  def _set_direction(self, v, load=False):
    """
    Setter method for direction, mapped from YANG variable /brocade_mac_access_list_rpc/get_mac_acl_for_intf/input/direction (enumeration)
    If this variable is read-only (config: false) in the
...
Ingress direction, when direction is not specified
  ...
  _pyangbind_elements = {'interface_type': interface_type, 'interface_name': interface_name, 'direction': direction, }
