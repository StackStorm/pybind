...
import __builtin__
class virtual_fabric(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-vcs - based on the path /vcs/virtual-fabric. Each member element of
  ...
  def _get_vfab_enable(self):
    """
    Getter method for vfab_enable, mapped from YANG variable /vcs/virtual_fabric/vfab_enable (empty)

    YANG Description: Enable virtual fabric
    """
    return self.__vfab_enable
      
  def _set_vfab_enable(self, v, load=False):
    """
    Setter method for vfab_enable, mapped from YANG variable /vcs/virtual_fabric/vfab_enable (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_vfab_enable is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_vfab_enable() directly.
  ...
  _pyangbind_elements = {'vfab_enable': vfab_enable, }
