...
class ip(PybindBase):
  ...
  from YANG module brocade-vcs - based on the path /vcs/virtual/ip. Each member element of
  ...
  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /vcs/virtual/ip/address (list)
    """
    return self.__address
      
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /vcs/virtual/ip/address (list)
