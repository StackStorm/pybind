...
class switch_attributes(PybindBase):
  ...
  def _get_rbridge_id(self):
    """
    Getter method for rbridge_id, mapped from YANG variable /system/switch_attributes/rbridge_id (list)
    """
    return self.__rbridge_id
      
  def _set_rbridge_id(self, v, load=False):
    """
    Setter method for rbridge_id, mapped from YANG variable /system/switch_attributes/rbridge_id (list)
