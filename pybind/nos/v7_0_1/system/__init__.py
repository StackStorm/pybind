...
class system(PybindBase):
  ...
  from YANG module brocade-ras - based on the path /system. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__switch_attributes',)
  ...
  _pyangbind_elements = {'switch_attributes': switch_attributes, }
