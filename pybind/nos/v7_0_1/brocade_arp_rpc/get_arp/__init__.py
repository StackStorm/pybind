...
import input
import output
class get_arp(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-arp - based on the path /brocade_arp_rpc/get-arp. Each member element of
...
the ARP entries of the managed entity are returned.
  ...
  def _get_input(self):
    """
    Getter method for input, mapped from YANG variable /brocade_arp_rpc/get_arp/input (input)
    """
    return self.__input
      
  def _set_input(self, v, load=False):
    """
    Setter method for input, mapped from YANG variable /brocade_arp_rpc/get_arp/input (input)
  ...
  def _get_output(self):
    """
    Getter method for output, mapped from YANG variable /brocade_arp_rpc/get_arp/output (output)
    """
    return self.__output
      
  def _set_output(self, v, load=False):
    """
    Setter method for output, mapped from YANG variable /brocade_arp_rpc/get_arp/output (output)
    If this variable is read-only (config: false) in the
