...
class permit(PybindBase):
  ...
  from YANG module brocade-dai - based on the path /arp/access-list/permit. Each member element of
  ...
  def _get_permit_list(self):
    """
    Getter method for permit_list, mapped from YANG variable /arp/access_list/permit/permit_list (list)
    """
