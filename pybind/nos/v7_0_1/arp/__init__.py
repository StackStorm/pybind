...
class arp(PybindBase):
  ...
  from YANG module brocade-dai - based on the path /arp. Each member element of
  ...
  def _get_access_list(self):
    """
    Getter method for access_list, mapped from YANG variable /arp/access_list (list)
    """
    return self.__access_list
      
  def _set_access_list(self, v, load=False):
    """
    Setter method for access_list, mapped from YANG variable /arp/access_list (list)
