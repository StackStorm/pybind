...
import __builtin__
import get_flexports
class brocade_hardware(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-hardware - based on the path /brocade_hardware_rpc. Each member element of
...
of the connectors.
  ...
  def _get_get_flexports(self):
    """
    Getter method for get_flexports, mapped from YANG variable /brocade_hardware_rpc/get_flexports (rpc)
    """
    return self.__get_flexports
  ...
  _pyangbind_elements = {'get_flexports': get_flexports, }
