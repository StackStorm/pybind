...
import __builtin__
import flexport_list
class output(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-hardware - based on the path /brocade_hardware_rpc/get-flexports/output. Each member element of
  ...
  def _get_flexport_list(self):
    """
    Getter method for flexport_list, mapped from YANG variable /brocade_hardware_rpc/get_flexports/output/flexport_list (list)
    """
    return self.__flexport_list
      
  def _set_flexport_list(self, v, load=False):
    """
    Setter method for flexport_list, mapped from YANG variable /brocade_hardware_rpc/get_flexports/output/flexport_list (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_flexport_list is considered as a private
  ...
  _pyangbind_elements = {'flexport_list': flexport_list, }
