...
import __builtin__
import aaa
class aaa_config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-aaa - based on the path /aaa-config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__aaa',)

  _yang_name = 'aaa-config'
  ...
  def _get_aaa(self):
    """
    Getter method for aaa, mapped from YANG variable /aaa_config/aaa (container)
    """
    return self.__aaa
      
  def _set_aaa(self, v, load=False):
    """
    Setter method for aaa, mapped from YANG variable /aaa_config/aaa (container)
