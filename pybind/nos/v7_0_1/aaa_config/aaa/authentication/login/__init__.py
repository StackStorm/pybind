...
class login(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__first = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'default': {'value': 0}, u'tacacs+': {'value': 2}, u'local': {'value': 4}, u'radius': {'value': 1}, u'ldap': {'value': 3}},), is_leaf=True, yang_name="first", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Primary source of authentication', u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-aaa', defining_module='brocade-aaa', yang_type='enumeration', is_config=True)
  ...
  def _set_first(self, v, load=False):
    ...
    try:
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'default': {'value': 0}, u'tacacs+': {'value': 2}, u'local': {'value': 4}, u'radius': {'value': 1}, u'ldap': {'value': 3}},), is_leaf=True, yang_name="first", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Primary source of authentication', u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-aaa', defining_module='brocade-aaa', yang_type='enumeration', is_config=True)""",
        })
