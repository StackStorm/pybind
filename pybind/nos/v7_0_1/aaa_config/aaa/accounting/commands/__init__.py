...
import __builtin__
import defaultacc
class commands(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-aaa - based on the path /aaa-config/aaa/accounting/commands. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'aaa-config', u'aaa', u'accounting', u'commands']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'aaa', u'accounting', u'commands']

  def _get_defaultacc(self):
    """
    Getter method for defaultacc, mapped from YANG variable /aaa_config/aaa/accounting/commands/defaultacc (container)
    """
    return self.__defaultacc
      
  def _set_defaultacc(self, v, load=False):
    """
    Setter method for defaultacc, mapped from YANG variable /aaa_config/aaa/accounting/commands/defaultacc (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_defaultacc is considered as a private
  ...
  _pyangbind_elements = {'defaultacc': defaultacc, }
