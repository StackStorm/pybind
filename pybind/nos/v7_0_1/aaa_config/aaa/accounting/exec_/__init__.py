...
import __builtin__
import defaultacc
class exec_(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-aaa - based on the path /aaa-config/aaa/accounting/exec. Each member element of
  ...
  def _get_defaultacc(self):
    """
    Getter method for defaultacc, mapped from YANG variable /aaa_config/aaa/accounting/exec/defaultacc (container)
    """
    return self.__defaultacc
      
  def _set_defaultacc(self, v, load=False):
    """
    Setter method for defaultacc, mapped from YANG variable /aaa_config/aaa/accounting/exec/defaultacc (container)
