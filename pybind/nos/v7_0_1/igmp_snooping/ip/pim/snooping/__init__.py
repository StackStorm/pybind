...
class snooping(PybindBase):
  ...
  from YANG module brocade-igmp-snooping - based on the path /igmp-snooping/ip/pim/snooping. Each member element of
  ...
  def _get_pimv4_enable(self):
    """
    Getter method for pimv4_enable, mapped from YANG variable /igmp_snooping/ip/pim/snooping/pimv4_enable (empty)
    """
    return self.__pimv4_enable
      
  def _set_pimv4_enable(self, v, load=False):
    """
    Setter method for pimv4_enable, mapped from YANG variable /igmp_snooping/ip/pim/snooping/pimv4_enable (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_pimv4_enable is considered as a private
  ...
  _pyangbind_elements = {'pimv4_enable': pimv4_enable, }
