...
class snooping(PybindBase):
  ...
  from YANG module brocade-igmp-snooping - based on the path /igmp-snooping/ip/igmp/snooping. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__enable = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="enable", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'IGMP Enable', u'cli-full-command': None, u'cli-suppress-show-conf-path': None}}, namespace='urn:brocade.com:mgmt:brocade-igmp-snooping', defining_module='brocade-igmp-snooping', yang_type='empty', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'igmp-snooping', u'ip', u'igmp', u'snooping']
  ...
  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /igmp_snooping/ip/igmp/snooping/enable (empty)
    """
    return self.__enable
      
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /igmp_snooping/ip/igmp/snooping/enable (empty)
