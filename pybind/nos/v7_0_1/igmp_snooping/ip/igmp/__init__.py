...
class igmp(PybindBase):
  ...
  def _get_snooping(self):
    """
    Getter method for snooping, mapped from YANG variable /igmp_snooping/ip/igmp/snooping (container)
    """
    return self.__snooping
      
  def _set_snooping(self, v, load=False):
    """
    Setter method for snooping, mapped from YANG variable /igmp_snooping/ip/igmp/snooping (container)
