...
class mac(PybindBase):
  ...
  from YANG module brocade-mac-access-list - based on the path /mac. Each member element of
  ...
  def _get_access_list(self):
    """
    Getter method for access_list, mapped from YANG variable /mac/access_list (container)
    """
    return self.__access_list
      
  def _set_access_list(self, v, load=False):
    """
    Setter method for access_list, mapped from YANG variable /mac/access_list (container)
