...
class standard(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__name','__hide_mac_acl_std',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__hide_mac_acl_std = YANGDynClass(base=hide_mac_acl_std.hide_mac_acl_std, is_container='container', yang_name="hide-mac-acl-std", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'hidden': u'wyser-write-hook'}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='container', is_config=True)
  ...
  def _set_hide_mac_acl_std(self, v, load=False):
    ...
    """
    try:
      t = YANGDynClass(v,base=hide_mac_acl_std.hide_mac_acl_std, is_container='container', yang_name="hide-mac-acl-std", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'hidden': u'wyser-write-hook'}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """hide_mac_acl_std must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=hide_mac_acl_std.hide_mac_acl_std, is_container='container', yang_name="hide-mac-acl-std", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'hidden': u'wyser-write-hook'}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='container', is_config=True)""",
        })
