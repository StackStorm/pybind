...
class seq(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__seq_id','__action','__source','__srchost','__src_mac_addr_mask','__dst','__dsthost','__dst_mac_addr_mask','__ethertype','__vlan','__count','__log',)
