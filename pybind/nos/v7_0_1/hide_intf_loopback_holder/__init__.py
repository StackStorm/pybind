...
import __builtin__
import interface
class hide_intf_loopback_holder(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-intf-loopback - based on the path /hide-intf-loopback-holder. Each member element of
...
managed objects from rest of the interface types.
  ...
  _yang_name = 'hide-intf-loopback-holder'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'hide-intf-loopback-holder']
  ...
  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /hide_intf_loopback_holder/interface (container)
...
device.
  ...
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /hide_intf_loopback_holder/interface (container)
