...
class interface(PybindBase):
  ...
  from YANG module brocade-intf-loopback - based on the path /hide-intf-loopback-holder/interface. Each member element of
...
device.
  ...
  def _get_loopback(self):
    """
    Getter method for loopback, mapped from YANG variable /hide_intf_loopback_holder/interface/loopback (list)
    """
    return self.__loopback
      
  def _set_loopback(self, v, load=False):
    """
    Setter method for loopback, mapped from YANG variable /hide_intf_loopback_holder/interface/loopback (list)
  ...
  _pyangbind_elements = {'loopback': loopback, }
