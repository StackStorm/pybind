...
class mark(PybindBase):
  ...
  from YANG module brocade-qos - based on the path /qos/map/dscp-traffic-class/mark. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__to = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['-2147483648..2147483647']}, int_size=32), restriction_dict={'range': [u'0 .. 7']}), is_leaf=True, yang_name="to", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-qos', defining_module='brocade-qos', yang_type='int32', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'map', u'dscp-traffic-class', u'mark']
  ...
  def _get_dscp_in_values(self):
    """
    Getter method for dscp_in_values, mapped from YANG variable /qos/map/dscp_traffic_class/mark/dscp_in_values (UI32DscpMutationRange)
    """
    return self.__dscp_in_values
      
  def _set_dscp_in_values(self, v, load=False):
    """
    Setter method for dscp_in_values, mapped from YANG variable /qos/map/dscp_traffic_class/mark/dscp_in_values (UI32DscpMutationRange)
  ...
  def _get_to(self):
    """
    Getter method for to, mapped from YANG variable /qos/map/dscp_traffic_class/mark/to (int32)
    """
    return self.__to
      
  def _set_to(self, v, load=False):
    """
    Setter method for to, mapped from YANG variable /qos/map/dscp_traffic_class/mark/to (int32)
    If this variable is read-only (config: false) in the
