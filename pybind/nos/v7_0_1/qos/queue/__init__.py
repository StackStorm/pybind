...
class queue(PybindBase):
  ...
  from YANG module brocade-qos - based on the path /qos/queue. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__multicast','__scheduler',)
  ...
  def _get_multicast(self):
    """
    Getter method for multicast, mapped from YANG variable /qos/queue/multicast (container)
    """
    return self.__multicast
      
  def _set_multicast(self, v, load=False):
    """
    Setter method for multicast, mapped from YANG variable /qos/queue/multicast (container)
  ...
  def _get_scheduler(self):
    """
    Getter method for scheduler, mapped from YANG variable /qos/queue/scheduler (container)
    """
    return self.__scheduler
      
  def _set_scheduler(self, v, load=False):
    """
    Setter method for scheduler, mapped from YANG variable /qos/queue/scheduler (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'multicast': multicast, 'scheduler': scheduler, }
