...
class multicast(PybindBase):
  ...
  from YANG module brocade-qos - based on the path /qos/queue/multicast. Each member element of
  ...
  def _get_scheduler(self):
    """
    Getter method for scheduler, mapped from YANG variable /qos/queue/multicast/scheduler (container)
    """
    return self.__scheduler
      
  def _set_scheduler(self, v, load=False):
    """
    Setter method for scheduler, mapped from YANG variable /qos/queue/multicast/scheduler (container)
