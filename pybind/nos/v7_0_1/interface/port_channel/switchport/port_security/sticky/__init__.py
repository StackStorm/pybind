...
class sticky(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/switchport/port-security/sticky. Each member element of
  ...
  def _get_sticky_flag(self):
    """
    Getter method for sticky_flag, mapped from YANG variable /interface/port_channel/switchport/port_security/sticky/sticky_flag (empty)
  ...
  def _set_sticky_flag(self, v, load=False):
    """
    Setter method for sticky_flag, mapped from YANG variable /interface/port_channel/switchport/port_security/sticky/sticky_flag (empty)
  ...
  def _get_port_secutiry_mac_address(self):
    """
    Getter method for port_secutiry_mac_address, mapped from YANG variable /interface/port_channel/switchport/port_security/sticky/port_secutiry_mac_address (list)
  ...
  def _set_port_secutiry_mac_address(self, v, load=False):
    """
    Setter method for port_secutiry_mac_address, mapped from YANG variable /interface/port_channel/switchport/port_security/sticky/port_secutiry_mac_address (list)
    If this variable is read-only (config: false) in the
