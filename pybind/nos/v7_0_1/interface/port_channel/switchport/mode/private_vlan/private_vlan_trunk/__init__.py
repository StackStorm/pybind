...
class private_vlan_trunk(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/switchport/mode/private-vlan/private-vlan-trunk. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'switchport', u'mode', u'private-vlan', u'private-vlan-trunk']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Port-channel', u'switchport', u'mode', u'private-vlan', u'trunk']

  def _get_trunk_basic(self):
    """
    Getter method for trunk_basic, mapped from YANG variable /interface/port_channel/switchport/mode/private_vlan/private_vlan_trunk/trunk_basic (empty)
    """
    return self.__trunk_basic
      
  def _set_trunk_basic(self, v, load=False):
    """
    Setter method for trunk_basic, mapped from YANG variable /interface/port_channel/switchport/mode/private_vlan/private_vlan_trunk/trunk_basic (empty)
  ...
  def _get_trunk_promiscuous(self):
    """
    Getter method for trunk_promiscuous, mapped from YANG variable /interface/port_channel/switchport/mode/private_vlan/private_vlan_trunk/trunk_promiscuous (empty)
    """
    return self.__trunk_promiscuous
      
  def _set_trunk_promiscuous(self, v, load=False):
    """
    Setter method for trunk_promiscuous, mapped from YANG variable /interface/port_channel/switchport/mode/private_vlan/private_vlan_trunk/trunk_promiscuous (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_trunk_host(self):
    """
    Getter method for trunk_host, mapped from YANG variable /interface/port_channel/switchport/mode/private_vlan/private_vlan_trunk/trunk_host (empty)
    """
    return self.__trunk_host
      
  def _set_trunk_host(self, v, load=False):
    """
    Setter method for trunk_host, mapped from YANG variable /interface/port_channel/switchport/mode/private_vlan/private_vlan_trunk/trunk_host (empty)
    If this variable is read-only (config: false) in the
