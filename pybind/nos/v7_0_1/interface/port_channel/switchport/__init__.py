...
class switchport(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__mode','__port_security','__access','__access_mac_group_vlan_classification','__access_mac_vlan_classification','__trunk_private_vlan_classification','__trunk','__private_vlan',)
