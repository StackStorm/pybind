...
class vlanoper(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/switchport/trunk/allowed/vlanoper. Each member element of
...
Do not use in edit-config.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'switchport', u'trunk', u'allowed', u'vlanoper']
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /interface/port_channel/switchport/trunk/allowed/vlanoper/vlan (container)
    """
    return self.__vlan
      
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /interface/port_channel/switchport/trunk/allowed/vlanoper/vlan (container)
