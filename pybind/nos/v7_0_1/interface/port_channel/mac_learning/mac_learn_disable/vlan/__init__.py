...
class vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/mac-learning/mac-learn-disable/vlan. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'mac-learning', u'mac-learn-disable', u'vlan']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Port-channel', u'mac-learning', u'disable', u'vlan']

  def _get_mac_learning_vlan_add(self):
    """
    Getter method for mac_learning_vlan_add, mapped from YANG variable /interface/port_channel/mac_learning/mac_learn_disable/vlan/mac_learning_vlan_add (ui32-range-8091)
    """
    return self.__mac_learning_vlan_add
      
  def _set_mac_learning_vlan_add(self, v, load=False):
    """
    Setter method for mac_learning_vlan_add, mapped from YANG variable /interface/port_channel/mac_learning/mac_learn_disable/vlan/mac_learning_vlan_add (ui32-range-8091)
  ...
  def _get_mac_learning_vlan_remove(self):
    """
    Getter method for mac_learning_vlan_remove, mapped from YANG variable /interface/port_channel/mac_learning/mac_learn_disable/vlan/mac_learning_vlan_remove (ui32-range-8091)
    """
    return self.__mac_learning_vlan_remove
      
  def _set_mac_learning_vlan_remove(self, v, load=False):
    """
    Setter method for mac_learning_vlan_remove, mapped from YANG variable /interface/port_channel/mac_learning/mac_learn_disable/vlan/mac_learning_vlan_remove (ui32-range-8091)
    If this variable is read-only (config: false) in the
