...
class mac_learning(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/mac-learning. Each member element of
  ...
  def _get_mac_learn_disable(self):
    """
    Getter method for mac_learn_disable, mapped from YANG variable /interface/port_channel/mac_learning/mac_learn_disable (container)
    """
    return self.__mac_learn_disable
      
  def _set_mac_learn_disable(self, v, load=False):
    """
    Setter method for mac_learn_disable, mapped from YANG variable /interface/port_channel/mac_learning/mac_learn_disable (container)
