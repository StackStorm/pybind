...
class snmp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/snmp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'snmp']
  ...
  def _get_trap(self):
    """
    Getter method for trap, mapped from YANG variable /interface/port_channel/snmp/trap (container)
  ...
  def _set_trap(self, v, load=False):
    """
    Setter method for trap, mapped from YANG variable /interface/port_channel/snmp/trap (container)
