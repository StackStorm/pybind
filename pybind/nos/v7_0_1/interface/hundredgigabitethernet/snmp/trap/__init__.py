...
class trap(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/snmp/trap. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: SNMP Trap configuration
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__link_snmp_trap_status',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'snmp', u'trap']
  ...
  def _get_link_snmp_trap_status(self):
    """
    Getter method for link_snmp_trap_status, mapped from YANG variable /interface/hundredgigabitethernet/snmp/trap/link_snmp_trap_status (empty)
  ...
  def _set_link_snmp_trap_status(self, v, load=False):
    """
    Setter method for link_snmp_trap_status, mapped from YANG variable /interface/hundredgigabitethernet/snmp/trap/link_snmp_trap_status (empty)
