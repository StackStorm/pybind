...
class snmp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/snmp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'snmp']
  ...
  def _get_trap(self):
    """
    Getter method for trap, mapped from YANG variable /interface/hundredgigabitethernet/snmp/trap (container)
  ...
  def _set_trap(self, v, load=False):
    """
    Setter method for trap, mapped from YANG variable /interface/hundredgigabitethernet/snmp/trap (container)
