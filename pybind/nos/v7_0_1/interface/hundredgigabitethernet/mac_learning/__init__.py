...
class mac_learning(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/mac-learning. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'mac-learning']
  ...
  def _get_mac_learn_disable(self):
    """
    Getter method for mac_learn_disable, mapped from YANG variable /interface/hundredgigabitethernet/mac_learning/mac_learn_disable (container)
    """
    return self.__mac_learn_disable
      
  def _set_mac_learn_disable(self, v, load=False):
    """
    Setter method for mac_learn_disable, mapped from YANG variable /interface/hundredgigabitethernet/mac_learning/mac_learn_disable (container)
