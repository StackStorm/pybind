...
import __builtin__
import access
class access_mac_rspan_vlan_classification(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/switchport/access-mac-rspan-vlan-classification. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__access',)

  _yang_name = 'access-mac-rspan-vlan-classification'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'switchport', u'access-mac-rspan-vlan-classification']
  ...
  def _get_access(self):
    """
    Getter method for access, mapped from YANG variable /interface/hundredgigabitethernet/switchport/access_mac_rspan_vlan_classification/access (container)
  ...
  def _set_access(self, v, load=False):
    """
    Setter method for access, mapped from YANG variable /interface/hundredgigabitethernet/switchport/access_mac_rspan_vlan_classification/access (container)
