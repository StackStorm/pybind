...
class access_mac_vlan_classification(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/switchport/access-mac-vlan-classification. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'switchport', u'access-mac-vlan-classification']
  ...
  def _get_access(self):
    """
    Getter method for access, mapped from YANG variable /interface/hundredgigabitethernet/switchport/access_mac_vlan_classification/access (container)
...
interface.
  ...
  def _set_access(self, v, load=False):
    """
    Setter method for access, mapped from YANG variable /interface/hundredgigabitethernet/switchport/access_mac_vlan_classification/access (container)
