...
class trunk_rspan_vlan_classification(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/switchport/trunk/allowed/trunk-rspan-vlan-classification. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'switchport', u'trunk', u'allowed', u'trunk-rspan-vlan-classification']
  ...
  def _get_rspan_vlan(self):
    """
    Getter method for rspan_vlan, mapped from YANG variable /interface/hundredgigabitethernet/switchport/trunk/allowed/trunk_rspan_vlan_classification/rspan_vlan (container)
    """
    return self.__rspan_vlan
      
  def _set_rspan_vlan(self, v, load=False):
    """
    Setter method for rspan_vlan, mapped from YANG variable /interface/hundredgigabitethernet/switchport/trunk/allowed/trunk_rspan_vlan_classification/rspan_vlan (container)
