...
class private_vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/switchport/private-vlan. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Set Private-Vlan Configuration
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__trunk','__host_association','__association','__mapping',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'switchport', u'private-vlan']
  ...
  def _get_trunk(self):
    """
    Getter method for trunk, mapped from YANG variable /interface/hundredgigabitethernet/switchport/private_vlan/trunk (container)
  ...
  def _set_trunk(self, v, load=False):
    """
    Setter method for trunk, mapped from YANG variable /interface/hundredgigabitethernet/switchport/private_vlan/trunk (container)
  ...
  def _get_host_association(self):
    """
    Getter method for host_association, mapped from YANG variable /interface/hundredgigabitethernet/switchport/private_vlan/host_association (container)
  ...
  def _set_host_association(self, v, load=False):
    """
    Setter method for host_association, mapped from YANG variable /interface/hundredgigabitethernet/switchport/private_vlan/host_association (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_association(self):
    """
    Getter method for association, mapped from YANG variable /interface/hundredgigabitethernet/switchport/private_vlan/association (container)
  ...
  def _set_association(self, v, load=False):
    """
    Setter method for association, mapped from YANG variable /interface/hundredgigabitethernet/switchport/private_vlan/association (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_mapping(self):
    """
    Getter method for mapping, mapped from YANG variable /interface/hundredgigabitethernet/switchport/private_vlan/mapping (list)
  ...
  def _set_mapping(self, v, load=False):
    """
    Setter method for mapping, mapped from YANG variable /interface/hundredgigabitethernet/switchport/private_vlan/mapping (list)
    If this variable is read-only (config: false) in the
