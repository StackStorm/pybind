...
class mapping(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/switchport/private-vlan/mapping. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'switchport', u'private-vlan', u'mapping']
  ...
  def _get_promis_pri_pvlan(self):
    """
    Getter method for promis_pri_pvlan, mapped from YANG variable /interface/hundredgigabitethernet/switchport/private_vlan/mapping/promis_pri_pvlan (vlan-type)
    """
    return self.__promis_pri_pvlan
      
  def _set_promis_pri_pvlan(self, v, load=False):
    """
    Setter method for promis_pri_pvlan, mapped from YANG variable /interface/hundredgigabitethernet/switchport/private_vlan/mapping/promis_pri_pvlan (vlan-type)
  ...
  def _get_oper(self):
    """
    Getter method for oper, mapped from YANG variable /interface/hundredgigabitethernet/switchport/private_vlan/mapping/oper (secVlan-opp-type)
    """
    return self.__oper
      
  def _set_oper(self, v, load=False):
    """
    Setter method for oper, mapped from YANG variable /interface/hundredgigabitethernet/switchport/private_vlan/mapping/oper (secVlan-opp-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_promis_sec_pvlan_range(self):
    """
    Getter method for promis_sec_pvlan_range, mapped from YANG variable /interface/hundredgigabitethernet/switchport/private_vlan/mapping/promis_sec_pvlan_range (ui32-range-8091)
    """
    return self.__promis_sec_pvlan_range
      
  def _set_promis_sec_pvlan_range(self, v, load=False):
    """
    Setter method for promis_sec_pvlan_range, mapped from YANG variable /interface/hundredgigabitethernet/switchport/private_vlan/mapping/promis_sec_pvlan_range (ui32-range-8091)
    If this variable is read-only (config: false) in the
