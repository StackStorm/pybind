...
class private_vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/switchport/trunk-private-vlan-classification/private-vlan. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'switchport', u'trunk-private-vlan-classification', u'private-vlan']
  ...
  def _get_trunk(self):
    """
    Getter method for trunk, mapped from YANG variable /interface/hundredgigabitethernet/switchport/trunk_private_vlan_classification/private_vlan/trunk (container)
    """
    return self.__trunk
      
  def _set_trunk(self, v, load=False):
    """
    Setter method for trunk, mapped from YANG variable /interface/hundredgigabitethernet/switchport/trunk_private_vlan_classification/private_vlan/trunk (container)
