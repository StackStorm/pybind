...
class fec(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/fec. Each member element of
  ...
  def _get_fec_enable(self):
    """
    Getter method for fec_enable, mapped from YANG variable /interface/hundredgigabitethernet/fec/fec_enable (empty)
    """
    return self.__fec_enable
      
  def _set_fec_enable(self, v, load=False):
    """
    Setter method for fec_enable, mapped from YANG variable /interface/hundredgigabitethernet/fec/fec_enable (empty)
  ...
  _pyangbind_elements = {'fec_enable': fec_enable, }
