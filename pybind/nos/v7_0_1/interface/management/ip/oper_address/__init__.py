...
class oper_address(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/management/ip/oper-address. Each member element of
  ...
  def _get_oper_ip_address(self):
    """
    Getter method for oper_ip_address, mapped from YANG variable /interface/management/ip/oper_address/oper_ip_address (common-def:ipv4-address-prefix-type)

    YANG Description: The assigned IPv4 address.
    """
    return self.__oper_ip_address
      
  def _set_oper_ip_address(self, v, load=False):
    """
    Setter method for oper_ip_address, mapped from YANG variable /interface/management/ip/oper_address/oper_ip_address (common-def:ipv4-address-prefix-type)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_oper_ip_address is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_oper_ip_address() directly.
  ...
  _pyangbind_elements = {'oper_ip_address': oper_ip_address, }
