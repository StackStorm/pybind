...
class mode(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/switchport/mode. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'switchport', u'mode']
  ...
  def _get_vlan_mode(self):
    """
    Getter method for vlan_mode, mapped from YANG variable /interface/fortygigabitethernet/switchport/mode/vlan_mode (l2-mode-type)
  ...
  def _set_vlan_mode(self, v, load=False):
    """
    Setter method for vlan_mode, mapped from YANG variable /interface/fortygigabitethernet/switchport/mode/vlan_mode (l2-mode-type)
  ...
  def _get_private_vlan(self):
    """
    Getter method for private_vlan, mapped from YANG variable /interface/fortygigabitethernet/switchport/mode/private_vlan (container)
    """
    return self.__private_vlan
      
  def _set_private_vlan(self, v, load=False):
    """
    Setter method for private_vlan, mapped from YANG variable /interface/fortygigabitethernet/switchport/mode/private_vlan (container)
    If this variable is read-only (config: false) in the
