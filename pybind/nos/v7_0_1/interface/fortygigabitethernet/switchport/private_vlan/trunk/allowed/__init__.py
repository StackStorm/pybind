...
class allowed(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/switchport/private-vlan/trunk/allowed. Each member element of
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /interface/fortygigabitethernet/switchport/private_vlan/trunk/allowed/vlan (container)
  ...
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /interface/fortygigabitethernet/switchport/private_vlan/trunk/allowed/vlan (container)
