...
class rspan_access(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/switchport/access/rspan-access. Each member element of
...
interface.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'switchport', u'access', u'rspan-access']
  ...
  def _get_rspan_access_vlan(self):
    """
    Getter method for rspan_access_vlan, mapped from YANG variable /interface/fortygigabitethernet/switchport/access/rspan_access/rspan_access_vlan (vlan-type)
  ...
  def _set_rspan_access_vlan(self, v, load=False):
    """
    Setter method for rspan_access_vlan, mapped from YANG variable /interface/fortygigabitethernet/switchport/access/rspan_access/rspan_access_vlan (vlan-type)
