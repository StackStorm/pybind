...
class trunk_vlan_classification(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/switchport/trunk/trunk-vlan-classification. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'switchport', u'trunk', u'trunk-vlan-classification']
  ...
  def _get_allowed(self):
    """
    Getter method for allowed, mapped from YANG variable /interface/fortygigabitethernet/switchport/trunk/trunk_vlan_classification/allowed (container)
...
interface
  ...
  def _set_allowed(self, v, load=False):
    """
    Setter method for allowed, mapped from YANG variable /interface/fortygigabitethernet/switchport/trunk/trunk_vlan_classification/allowed (container)
