...
class tunable_optics(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/tunable-optics. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'tunable-optics']
  ...
  def _get_sfpp(self):
    """
    Getter method for sfpp, mapped from YANG variable /interface/fortygigabitethernet/tunable_optics/sfpp (container)
    """
    return self.__sfpp
      
  def _set_sfpp(self, v, load=False):
    """
    Setter method for sfpp, mapped from YANG variable /interface/fortygigabitethernet/tunable_optics/sfpp (container)
