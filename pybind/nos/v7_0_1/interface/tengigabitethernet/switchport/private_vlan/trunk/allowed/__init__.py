...
class allowed(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/switchport/private-vlan/trunk/allowed. Each member element of
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /interface/tengigabitethernet/switchport/private_vlan/trunk/allowed/vlan (container)
  ...
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /interface/tengigabitethernet/switchport/private_vlan/trunk/allowed/vlan (container)
