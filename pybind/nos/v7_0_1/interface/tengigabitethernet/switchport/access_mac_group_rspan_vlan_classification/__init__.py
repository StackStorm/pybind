...
class access_mac_group_rspan_vlan_classification(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/switchport/access-mac-group-rspan-vlan-classification. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'switchport', u'access-mac-group-rspan-vlan-classification']
  ...
  def _get_access(self):
    """
    Getter method for access, mapped from YANG variable /interface/tengigabitethernet/switchport/access_mac_group_rspan_vlan_classification/access (container)
  ...
  def _set_access(self, v, load=False):
    """
    Setter method for access, mapped from YANG variable /interface/tengigabitethernet/switchport/access_mac_group_rspan_vlan_classification/access (container)
