...
class private_vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/switchport/trunk-private-vlan-classification/private-vlan. Each member element of
  ...
  def _get_trunk(self):
    """
    Getter method for trunk, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk_private_vlan_classification/private_vlan/trunk (container)
    """
    return self.__trunk
      
  def _set_trunk(self, v, load=False):
    """
    Setter method for trunk, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk_private_vlan_classification/private_vlan/trunk (container)
