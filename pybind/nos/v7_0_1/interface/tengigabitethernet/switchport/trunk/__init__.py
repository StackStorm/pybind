...
class trunk(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/switchport/trunk. Each member element of
  ...
  def _get_allowed(self):
    """
    Getter method for allowed, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed (container)
...
interface
  ...
  def _set_allowed(self, v, load=False):
    """
    Setter method for allowed, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed (container)
...
interface
  ...
  def _get_trunk_vlan_classification(self):
    """
    Getter method for trunk_vlan_classification, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/trunk_vlan_classification (container)
    """
    return self.__trunk_vlan_classification
      
  def _set_trunk_vlan_classification(self, v, load=False):
    """
    Setter method for trunk_vlan_classification, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/trunk_vlan_classification (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_default_vlan_config(self):
    """
    Getter method for default_vlan_config, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/default_vlan_config (container)
    """
    return self.__default_vlan_config
      
  def _set_default_vlan_config(self, v, load=False):
    """
    Setter method for default_vlan_config, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/default_vlan_config (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_tag(self):
    """
    Getter method for tag, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/tag (container)
...
trunk port.
  ...
  def _set_tag(self, v, load=False):
    """
    Setter method for tag, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/tag (container)
    If this variable is read-only (config: false) in the
...
trunk port.
  ...
  def _get_native_vlan_classification(self):
    """
    Getter method for native_vlan_classification, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/native_vlan_classification (container)
    """
    return self.__native_vlan_classification
      
  def _set_native_vlan_classification(self, v, load=False):
    """
    Setter method for native_vlan_classification, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/native_vlan_classification (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_native_vlan_xtagged_config(self):
    """
    Getter method for native_vlan_xtagged_config, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/native_vlan_xtagged_config (container)
    """
    return self.__native_vlan_xtagged_config
      
  def _set_native_vlan_xtagged_config(self, v, load=False):
    """
    Setter method for native_vlan_xtagged_config, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/native_vlan_xtagged_config (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_native_vlan_untagged_config(self):
    """
    Getter method for native_vlan_untagged_config, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/native_vlan_untagged_config (container)
    """
    return self.__native_vlan_untagged_config
      
  def _set_native_vlan_untagged_config(self, v, load=False):
    """
    Setter method for native_vlan_untagged_config, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/native_vlan_untagged_config (container)
    If this variable is read-only (config: false) in the
