...
class rspan_vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/switchport/trunk/allowed/trunk-rspan-vlan-classification/rspan-vlan. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'switchport', u'trunk', u'allowed', u'trunk-rspan-vlan-classification', u'rspan-vlan']
  ...
  def _get_add_(self):
    """
    Getter method for add_, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed/trunk_rspan_vlan_classification/rspan_vlan/add (list)
    """
    return self.__add_
      
  def _set_add_(self, v, load=False):
    """
    Setter method for add_, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed/trunk_rspan_vlan_classification/rspan_vlan/add (list)
  ...
  def _get_remove_(self):
    """
    Getter method for remove_, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed/trunk_rspan_vlan_classification/rspan_vlan/remove (list)
    """
    return self.__remove_
      
  def _set_remove_(self, v, load=False):
    """
    Setter method for remove_, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed/trunk_rspan_vlan_classification/rspan_vlan/remove (list)
    If this variable is read-only (config: false) in the
