...
class allowed(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/switchport/trunk/allowed. Each member element of
...
interface
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'switchport', u'trunk', u'allowed']
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed/vlan (container)
    """
    return self.__vlan
      
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed/vlan (container)
  ...
  def _get_vlanoper(self):
    """
    Getter method for vlanoper, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed/vlanoper (container)
...
Do not use in edit-config.
  ...
  def _set_vlanoper(self, v, load=False):
    """
    Setter method for vlanoper, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed/vlanoper (container)
    If this variable is read-only (config: false) in the
...
Do not use in edit-config.
  ...
  def _get_rspan_vlan(self):
    """
    Getter method for rspan_vlan, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed/rspan_vlan (container)
  ...
  def _set_rspan_vlan(self, v, load=False):
    """
    Setter method for rspan_vlan, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed/rspan_vlan (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_trunk_rspan_vlan_classification(self):
    """
    Getter method for trunk_rspan_vlan_classification, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed/trunk_rspan_vlan_classification (container)
    """
    return self.__trunk_rspan_vlan_classification
      
  def _set_trunk_rspan_vlan_classification(self, v, load=False):
    """
    Setter method for trunk_rspan_vlan_classification, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed/trunk_rspan_vlan_classification (container)
    If this variable is read-only (config: false) in the
