...
class vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/switchport/trunk/allowed/vlanoper/vlan. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'switchport', u'trunk', u'allowed', u'vlanoper', u'vlan']
  ...
  def _get_add_(self):
    """
    Getter method for add_, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed/vlanoper/vlan/add (ui32-vlan-range)
    """
    return self.__add_
      
  def _set_add_(self, v, load=False):
    """
    Setter method for add_, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed/vlanoper/vlan/add (ui32-vlan-range)
  ...
  def _get_remove_(self):
    """
    Getter method for remove_, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed/vlanoper/vlan/remove (ui32-vlan-range)
    """
    return self.__remove_
      
  def _set_remove_(self, v, load=False):
    """
    Setter method for remove_, mapped from YANG variable /interface/tengigabitethernet/switchport/trunk/allowed/vlanoper/vlan/remove (ui32-vlan-range)
    If this variable is read-only (config: false) in the
