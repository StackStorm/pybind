...
class tunable_optics(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/tunable-optics. Each member element of
  ...
  def _get_sfpp(self):
    """
    Getter method for sfpp, mapped from YANG variable /interface/tengigabitethernet/tunable_optics/sfpp (container)
    """
    return self.__sfpp
      
  def _set_sfpp(self, v, load=False):
    """
    Setter method for sfpp, mapped from YANG variable /interface/tengigabitethernet/tunable_optics/sfpp (container)
