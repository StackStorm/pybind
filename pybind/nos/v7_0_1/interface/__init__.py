...
grouped under this container.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__gigabitethernet','__tengigabitethernet','__fortygigabitethernet','__hundredgigabitethernet','__port_channel','__management','__fc_port',)
