...
class trap(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/snmp/trap. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'snmp', u'trap']
  ...
  def _get_link_snmp_trap_status(self):
    """
    Getter method for link_snmp_trap_status, mapped from YANG variable /interface/gigabitethernet/snmp/trap/link_snmp_trap_status (empty)
  ...
  def _set_link_snmp_trap_status(self, v, load=False):
    """
    Setter method for link_snmp_trap_status, mapped from YANG variable /interface/gigabitethernet/snmp/trap/link_snmp_trap_status (empty)
