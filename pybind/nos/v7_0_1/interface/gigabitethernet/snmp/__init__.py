...
class snmp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/snmp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'snmp']
  ...
  def _get_trap(self):
    """
    Getter method for trap, mapped from YANG variable /interface/gigabitethernet/snmp/trap (container)
  ...
  def _set_trap(self, v, load=False):
    """
    Setter method for trap, mapped from YANG variable /interface/gigabitethernet/snmp/trap (container)
