...
class edge_loop_detection(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/edge-loop-detection. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'edge-loop-detection']
  ...
  def _get_eldprio(self):
    """
    Getter method for eldprio, mapped from YANG variable /interface/gigabitethernet/edge_loop_detection/eldprio (uint32)
    """
    return self.__eldprio
      
  def _set_eldprio(self, v, load=False):
    """
    Setter method for eldprio, mapped from YANG variable /interface/gigabitethernet/edge_loop_detection/eldprio (uint32)
  ...
  def _get_eldvlan(self):
    """
    Getter method for eldvlan, mapped from YANG variable /interface/gigabitethernet/edge_loop_detection/eldvlan (ui32-eldvlan-range)
    """
    return self.__eldvlan
      
  def _set_eldvlan(self, v, load=False):
    """
    Setter method for eldvlan, mapped from YANG variable /interface/gigabitethernet/edge_loop_detection/eldvlan (ui32-eldvlan-range)
    If this variable is read-only (config: false) in the
