...
class trunk(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/switchport/private-vlan/trunk. Each member element of
  ...
  def _get_pvlan_tag(self):
    """
    Getter method for pvlan_tag, mapped from YANG variable /interface/gigabitethernet/switchport/private_vlan/trunk/pvlan_tag (container)
...
trunk port.
  ...
  def _set_pvlan_tag(self, v, load=False):
    """
    Setter method for pvlan_tag, mapped from YANG variable /interface/gigabitethernet/switchport/private_vlan/trunk/pvlan_tag (container)
...
trunk port.
  ...
  def _get_native(self):
    """
    Getter method for native, mapped from YANG variable /interface/gigabitethernet/switchport/private_vlan/trunk/native (container)
...
Layer2 trunk interface
  ...
  def _set_native(self, v, load=False):
    """
    Setter method for native, mapped from YANG variable /interface/gigabitethernet/switchport/private_vlan/trunk/native (container)
    If this variable is read-only (config: false) in the
...
Layer2 trunk interface
  ...
  def _get_allowed(self):
    """
    Getter method for allowed, mapped from YANG variable /interface/gigabitethernet/switchport/private_vlan/trunk/allowed (container)
  ...
  def _set_allowed(self, v, load=False):
    """
    Setter method for allowed, mapped from YANG variable /interface/gigabitethernet/switchport/private_vlan/trunk/allowed (container)
    If this variable is read-only (config: false) in the
