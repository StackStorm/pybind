...
class access(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/switchport/access-mac-vlan-classification/access. Each member element of
...
interface.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'switchport', u'access-mac-vlan-classification', u'access']
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /interface/gigabitethernet/switchport/access_mac_vlan_classification/access/vlan (list)
    """
    return self.__vlan
      
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /interface/gigabitethernet/switchport/access_mac_vlan_classification/access/vlan (list)
