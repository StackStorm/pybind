...
class switchport(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__access_mac_rspan_vlan_classification = YANGDynClass(base=access_mac_rspan_vlan_classification.access_mac_rspan_vlan_classification, is_container='container', yang_name="access-mac-rspan-vlan-classification", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='container', is_config=True)
  ...
  def _get_mode(self):
    """
    Getter method for mode, mapped from YANG variable /interface/gigabitethernet/switchport/mode (container)
  ...
  def _set_mode(self, v, load=False):
    """
    Setter method for mode, mapped from YANG variable /interface/gigabitethernet/switchport/mode (container)
  ...
  def _get_port_security(self):
    """
    Getter method for port_security, mapped from YANG variable /interface/gigabitethernet/switchport/port_security (container)
  ...
  def _set_port_security(self, v, load=False):
    """
    Setter method for port_security, mapped from YANG variable /interface/gigabitethernet/switchport/port_security (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_access(self):
    """
    Getter method for access, mapped from YANG variable /interface/gigabitethernet/switchport/access (container)
...
interface.
  ...
  def _set_access(self, v, load=False):
    """
    Setter method for access, mapped from YANG variable /interface/gigabitethernet/switchport/access (container)
    If this variable is read-only (config: false) in the
...
interface.
  ...
  def _get_access_mac_group_vlan_classification(self):
    """
    Getter method for access_mac_group_vlan_classification, mapped from YANG variable /interface/gigabitethernet/switchport/access_mac_group_vlan_classification (container)
    """
    return self.__access_mac_group_vlan_classification
      
  def _set_access_mac_group_vlan_classification(self, v, load=False):
    """
    Setter method for access_mac_group_vlan_classification, mapped from YANG variable /interface/gigabitethernet/switchport/access_mac_group_vlan_classification (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_access_mac_vlan_classification(self):
    """
    Getter method for access_mac_vlan_classification, mapped from YANG variable /interface/gigabitethernet/switchport/access_mac_vlan_classification (container)
    """
    return self.__access_mac_vlan_classification
      
  def _set_access_mac_vlan_classification(self, v, load=False):
    """
    Setter method for access_mac_vlan_classification, mapped from YANG variable /interface/gigabitethernet/switchport/access_mac_vlan_classification (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_trunk_private_vlan_classification(self):
    """
    Getter method for trunk_private_vlan_classification, mapped from YANG variable /interface/gigabitethernet/switchport/trunk_private_vlan_classification (container)
    """
    return self.__trunk_private_vlan_classification
      
  def _set_trunk_private_vlan_classification(self, v, load=False):
    """
    Setter method for trunk_private_vlan_classification, mapped from YANG variable /interface/gigabitethernet/switchport/trunk_private_vlan_classification (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_trunk(self):
    """
    Getter method for trunk, mapped from YANG variable /interface/gigabitethernet/switchport/trunk (container)
  ...
  def _set_trunk(self, v, load=False):
    """
    Setter method for trunk, mapped from YANG variable /interface/gigabitethernet/switchport/trunk (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_private_vlan(self):
    """
    Getter method for private_vlan, mapped from YANG variable /interface/gigabitethernet/switchport/private_vlan (container)
  ...
  def _set_private_vlan(self, v, load=False):
    """
    Setter method for private_vlan, mapped from YANG variable /interface/gigabitethernet/switchport/private_vlan (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_access_mac_rspan_vlan_classification(self):
    """
    Getter method for access_mac_rspan_vlan_classification, mapped from YANG variable /interface/gigabitethernet/switchport/access_mac_rspan_vlan_classification (container)
    """
    return self.__access_mac_rspan_vlan_classification
      
  def _set_access_mac_rspan_vlan_classification(self, v, load=False):
    """
    Setter method for access_mac_rspan_vlan_classification, mapped from YANG variable /interface/gigabitethernet/switchport/access_mac_rspan_vlan_classification (container)
    If this variable is read-only (config: false) in the
    ...
    """
    try:
      t = YANGDynClass(v,base=access_mac_rspan_vlan_classification.access_mac_rspan_vlan_classification, is_container='container', yang_name="access-mac-rspan-vlan-classification", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """access_mac_rspan_vlan_classification must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=access_mac_rspan_vlan_classification.access_mac_rspan_vlan_classification, is_container='container', yang_name="access-mac-rspan-vlan-classification", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='container', is_config=True)""",
        })
  ...
  def _get_access_mac_group_rspan_vlan_classification(self):
    """
    Getter method for access_mac_group_rspan_vlan_classification, mapped from YANG variable /interface/gigabitethernet/switchport/access_mac_group_rspan_vlan_classification (container)
    """
  ...
  def _set_access_mac_group_rspan_vlan_classification(self, v, load=False):
    """
    Setter method for access_mac_group_rspan_vlan_classification, mapped from YANG variable /interface/gigabitethernet/switchport/access_mac_group_rspan_vlan_classification (container)
    If this variable is read-only (config: false) in the
