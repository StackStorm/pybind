...
class allowed(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/switchport/trunk-private-vlan-classification/private-vlan/trunk/allowed. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'switchport', u'trunk-private-vlan-classification', u'private-vlan', u'trunk', u'allowed']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'GigabitEthernet', u'switchport', u'private-vlan', u'trunk', u'allowed']

  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /interface/gigabitethernet/switchport/trunk_private_vlan_classification/private_vlan/trunk/allowed/vlan (container)
    """
    return self.__vlan
      
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /interface/gigabitethernet/switchport/trunk_private_vlan_classification/private_vlan/trunk/allowed/vlan (container)
