...
class allowed(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/switchport/trunk/trunk-vlan-classification/allowed. Each member element of
...
interface
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'switchport', u'trunk', u'trunk-vlan-classification', u'allowed']
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /interface/gigabitethernet/switchport/trunk/trunk_vlan_classification/allowed/vlan (container)
    """
    return self.__vlan
      
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /interface/gigabitethernet/switchport/trunk/trunk_vlan_classification/allowed/vlan (container)
