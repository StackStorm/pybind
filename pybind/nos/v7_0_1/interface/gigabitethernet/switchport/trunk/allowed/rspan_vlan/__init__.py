...
class rspan_vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/switchport/trunk/allowed/rspan-vlan. Each member element of
  ...
  def _get_add_rspan_trunk_vlan(self):
    """
    Getter method for add_rspan_trunk_vlan, mapped from YANG variable /interface/gigabitethernet/switchport/trunk/allowed/rspan_vlan/add_rspan_trunk_vlan (ui32-1k-vlan-range)
  ...
  def _set_add_rspan_trunk_vlan(self, v, load=False):
    """
    Setter method for add_rspan_trunk_vlan, mapped from YANG variable /interface/gigabitethernet/switchport/trunk/allowed/rspan_vlan/add_rspan_trunk_vlan (ui32-1k-vlan-range)
  ...
  def _get_remove_rspan_trunk_vlan(self):
    """
    Getter method for remove_rspan_trunk_vlan, mapped from YANG variable /interface/gigabitethernet/switchport/trunk/allowed/rspan_vlan/remove_rspan_trunk_vlan (ui32-1k-vlan-range)
  ...
  def _set_remove_rspan_trunk_vlan(self, v, load=False):
    """
    Setter method for remove_rspan_trunk_vlan, mapped from YANG variable /interface/gigabitethernet/switchport/trunk/allowed/rspan_vlan/remove_rspan_trunk_vlan (ui32-1k-vlan-range)
    If this variable is read-only (config: false) in the
