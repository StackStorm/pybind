...
class sticky(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/switchport/port-security/sticky. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'switchport', u'port-security', u'sticky']
  ...
  def _get_sticky_flag(self):
    """
    Getter method for sticky_flag, mapped from YANG variable /interface/gigabitethernet/switchport/port_security/sticky/sticky_flag (empty)
  ...
  def _set_sticky_flag(self, v, load=False):
    """
    Setter method for sticky_flag, mapped from YANG variable /interface/gigabitethernet/switchport/port_security/sticky/sticky_flag (empty)
  ...
  def _get_port_secutiry_mac_address(self):
    """
    Getter method for port_secutiry_mac_address, mapped from YANG variable /interface/gigabitethernet/switchport/port_security/sticky/port_secutiry_mac_address (list)
  ...
  def _set_port_secutiry_mac_address(self, v, load=False):
    """
    Setter method for port_secutiry_mac_address, mapped from YANG variable /interface/gigabitethernet/switchport/port_security/sticky/port_secutiry_mac_address (list)
    If this variable is read-only (config: false) in the
