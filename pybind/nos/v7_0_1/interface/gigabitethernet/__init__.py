...
all the rbridges in the cluster.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__name','__ifindex','__description','__shutdown','__channel_group','__mtu','__switchport_basic','__switchport','__mac_learning','__vrf','__ipv6','__snmp','__track','__bfd','__edge_loop_detection','__tunable_optics',)
...
datagram that can be sent on the interface.
  ...
  def _get_tunable_optics(self):
    """
    Getter method for tunable_optics, mapped from YANG variable /interface/gigabitethernet/tunable_optics (container)
    """
    return self.__tunable_optics
      
  def _set_tunable_optics(self, v, load=False):
    """
    Setter method for tunable_optics, mapped from YANG variable /interface/gigabitethernet/tunable_optics (container)
    If this variable is read-only (config: false) in the
