...
import __builtin__
class member_zone(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-zone - based on the path /zoning/defined-configuration/cfg/member-zone. Each member element of
  ...
  def _get_zone_name(self):
    """
    Getter method for zone_name, mapped from YANG variable /zoning/defined_configuration/cfg/member_zone/zone_name (string)

    YANG Description: Use the member-zone command to add one
...
can be removed at a time.
  ...
  def _set_zone_name(self, v, load=False):
    """
    Setter method for zone_name, mapped from YANG variable /zoning/defined_configuration/cfg/member_zone/zone_name (string)
...
can be removed at a time.
  ...
  _pyangbind_elements = {'zone_name': zone_name, }
