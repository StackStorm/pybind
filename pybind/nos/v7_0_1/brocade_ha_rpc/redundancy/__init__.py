...
import input
import output
class redundancy(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-ha - based on the path /brocade_ha_rpc/redundancy. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__input','__output',)

  _yang_name = 'redundancy'
  _rest_name = 'redundancy'
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__output = YANGDynClass(base=output.output, is_leaf=True, yang_name="output", rest_name="output", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-ha', defining_module='brocade-ha', yang_type='output', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_ha_rpc', u'redundancy']
  ...
  def _get_input(self):
    """
    Getter method for input, mapped from YANG variable /brocade_ha_rpc/redundancy/input (input)
    """
    return self.__input
      
  def _set_input(self, v, load=False):
    """
    Setter method for input, mapped from YANG variable /brocade_ha_rpc/redundancy/input (input)
  ...
  def _get_output(self):
    """
    Getter method for output, mapped from YANG variable /brocade_ha_rpc/redundancy/output (output)
    """
    return self.__output
      
  def _set_output(self, v, load=False):
    """
    Setter method for output, mapped from YANG variable /brocade_ha_rpc/redundancy/output (output)
    If this variable is read-only (config: false) in the
    ...
    """
    try:
      t = YANGDynClass(v,base=output.output, is_leaf=True, yang_name="output", rest_name="output", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-ha', defining_module='brocade-ha', yang_type='output', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """output must be of a type compatible with output""",
          'defined-type': "brocade-ha:output",
          'generated-type': """YANGDynClass(base=output.output, is_leaf=True, yang_name="output", rest_name="output", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-ha', defining_module='brocade-ha', yang_type='output', is_config=True)""",
        })
