...
import __builtin__
import input
class reload(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-ha - based on the path /brocade_ha_rpc/reload. Each member element of
  ...
  def _get_input(self):
    """
    Getter method for input, mapped from YANG variable /brocade_ha_rpc/reload/input (input)
    """
    return self.__input
      
  def _set_input(self, v, load=False):
    """
    Setter method for input, mapped from YANG variable /brocade_ha_rpc/reload/input (input)
