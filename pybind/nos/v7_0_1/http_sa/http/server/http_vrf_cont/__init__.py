...
import __builtin__
import use_vrf
class http_vrf_cont(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-http-config - based on the path /http-sa/http/server/http-vrf-cont. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__use_vrf',)

  _yang_name = 'http-vrf-cont'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'http-sa', u'http', u'server', u'http-vrf-cont']
  ...
  def _get_use_vrf(self):
    """
    Getter method for use_vrf, mapped from YANG variable /http_sa/http/server/http_vrf_cont/use_vrf (list)
    """
    return self.__use_vrf
      
  def _set_use_vrf(self, v, load=False):
    """
    Setter method for use_vrf, mapped from YANG variable /http_sa/http/server/http_vrf_cont/use_vrf (list)
