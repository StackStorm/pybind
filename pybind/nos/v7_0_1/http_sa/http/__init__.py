...
class http(PybindBase):
  ...
  from YANG module brocade-http-config - based on the path /http-sa/http. Each member element of
  ...
  def _get_server(self):
    """
    Getter method for server, mapped from YANG variable /http_sa/http/server (container)
    """
    return self.__server
      
  def _set_server(self, v, load=False):
    """
    Setter method for server, mapped from YANG variable /http_sa/http/server (container)
