...
class class_(PybindBase):
  ...
  from YANG module brocade-ras - based on the path /logging/auditlog/class. Each member element of
  ...
  def _get_class_(self):
    """
    Getter method for class_, mapped from YANG variable /logging/auditlog/class/class (audit-class)
    """
    return self.__class_
      
  def _set_class_(self, v, load=False):
    """
    Setter method for class_, mapped from YANG variable /logging/auditlog/class/class (audit-class)
