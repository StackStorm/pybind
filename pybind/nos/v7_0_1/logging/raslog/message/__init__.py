...
class message(PybindBase):
  ...
  from YANG module brocade-ras - based on the path /logging/raslog/message. Each member element of
  ...
  def _get_msgId(self):
    """
    Getter method for msgId, mapped from YANG variable /logging/raslog/message/msgId (list)
    """
    return self.__msgId
      
  def _set_msgId(self, v, load=False):
    """
    Setter method for msgId, mapped from YANG variable /logging/raslog/message/msgId (list)
  ...
  _pyangbind_elements = {'msgId': msgId, }
