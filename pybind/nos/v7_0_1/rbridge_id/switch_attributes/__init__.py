...
class switch_attributes(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/switch-attributes. Each member element of
  ...
  def _get_chassis_name(self):
    """
    Getter method for chassis_name, mapped from YANG variable /rbridge_id/switch_attributes/chassis_name (string)
    """
    return self.__chassis_name
      
  def _set_chassis_name(self, v, load=False):
    """
    Setter method for chassis_name, mapped from YANG variable /rbridge_id/switch_attributes/chassis_name (string)
  ...
  def _get_host_name(self):
    """
    Getter method for host_name, mapped from YANG variable /rbridge_id/switch_attributes/host_name (string)
    """
    return self.__host_name
      
  def _set_host_name(self, v, load=False):
    """
    Setter method for host_name, mapped from YANG variable /rbridge_id/switch_attributes/host_name (string)
    If this variable is read-only (config: false) in the
