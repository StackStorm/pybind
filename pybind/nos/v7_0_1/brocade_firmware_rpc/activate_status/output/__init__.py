...
class output(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__overall_status','__overall_error_msg','__activate_entries',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__activate_entries = YANGDynClass(base=YANGListType(False,activate_entries.activate_entries, yang_name="activate-entries", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='False', extensions=None), is_container='list', yang_name="activate-entries", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-firmware', defining_module='brocade-firmware', yang_type='list', is_config=True)
