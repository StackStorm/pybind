...
import __builtin__
class usb(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-firmware - based on the path /brocade_firmware_rpc/firmware-download/input/usb. Each member element of
  ...
  def _get_directory(self):
    """
    Getter method for directory, mapped from YANG variable /brocade_firmware_rpc/firmware_download/input/usb/directory (string)
    """
    return self.__directory
      
  def _set_directory(self, v, load=False):
    """
    Setter method for directory, mapped from YANG variable /brocade_firmware_rpc/firmware_download/input/usb/directory (string)
  ...
  __choices__ = {u'protocol-type': {u'usb-protocol': [u'directory']}}
  _pyangbind_elements = {'directory': directory, }
