...
class input(PybindBase):
  ...
  from YANG module brocade-firmware - based on the path /brocade_firmware_rpc/logical-chassis-fwdl-status/input. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_firmware_rpc', u'logical-chassis-fwdl-status', u'input']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'logical-chassis-fwdl-status', u'input']

  def _get_rbridge_id(self):
    """
    Getter method for rbridge_id, mapped from YANG variable /brocade_firmware_rpc/logical_chassis_fwdl_status/input/rbridge_id (rbridge-ids-all-type)
    """
    return self.__rbridge_id
      
  def _set_rbridge_id(self, v, load=False):
    """
    Setter method for rbridge_id, mapped from YANG variable /brocade_firmware_rpc/logical_chassis_fwdl_status/input/rbridge_id (rbridge-ids-all-type)
