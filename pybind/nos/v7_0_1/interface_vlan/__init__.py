...
class interface_vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface-vlan. Each member element of
...
elements of this managed device.
  ...
  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /interface_vlan/interface (container)
...
device.
  ...
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /interface_vlan/interface (container)
