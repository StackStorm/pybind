...
import __builtin__
import last_received_interface_info
class input(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-port-profile-ext - based on the path /brocade_port_profile_ext_rpc/get-port-profile-for-intf/input. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__rbridge_id','__interface_type','__interface_name','__last_received_interface_info',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_port_profile_ext_rpc', u'get-port-profile-for-intf', u'input']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'get-port-profile-for-intf', u'input']

  def _get_rbridge_id(self):
    """
    Getter method for rbridge_id, mapped from YANG variable /brocade_port_profile_ext_rpc/get_port_profile_for_intf/input/rbridge_id (uint32)
...
from all rbridges
  ...
  def _set_rbridge_id(self, v, load=False):
    """
    Setter method for rbridge_id, mapped from YANG variable /brocade_port_profile_ext_rpc/get_port_profile_for_intf/input/rbridge_id (uint32)
...
from all rbridges
    """
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="rbridge-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='urn:brocade.com:mgmt:brocade-port-profile-ext', defining_module='brocade-port-profile-ext', yang_type='uint32', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """rbridge_id must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="rbridge-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='urn:brocade.com:mgmt:brocade-port-profile-ext', defining_module='brocade-port-profile-ext', yang_type='uint32', is_config=True)""",
        })
  ...
  def _get_interface_type(self):
    """
    Getter method for interface_type, mapped from YANG variable /brocade_port_profile_ext_rpc/get_port_profile_for_intf/input/interface_type (enumeration)
...
represents error scenario and should not be used.
  ...
  def _set_interface_type(self, v, load=False):
    """
    Setter method for interface_type, mapped from YANG variable /brocade_port_profile_ext_rpc/get_port_profile_for_intf/input/interface_type (enumeration)
    If this variable is read-only (config: false) in the
...
represents error scenario and should not be used.
  ...
  def _get_interface_name(self):
    """
    Getter method for interface_name, mapped from YANG variable /brocade_port_profile_ext_rpc/get_port_profile_for_intf/input/interface_name (union)
...
'interface-type' must fail with an error.
  ...
  def _set_interface_name(self, v, load=False):
    """
    Setter method for interface_name, mapped from YANG variable /brocade_port_profile_ext_rpc/get_port_profile_for_intf/input/interface_name (union)
    If this variable is read-only (config: false) in the
...
'interface-type' must fail with an error.
  ...
  def _get_last_received_interface_info(self):
    """
    Getter method for last_received_interface_info, mapped from YANG variable /brocade_port_profile_ext_rpc/get_port_profile_for_intf/input/last_received_interface_info (container)
...
and interface type are not specified.
    """
    return self.__last_received_interface_info
      
  def _set_last_received_interface_info(self, v, load=False):
    """
    Setter method for last_received_interface_info, mapped from YANG variable /brocade_port_profile_ext_rpc/get_port_profile_for_intf/input/last_received_interface_info (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_last_received_interface_info is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_last_received_interface_info() directly.
...
and interface type are not specified.
    """
    try:
      t = YANGDynClass(v,base=last_received_interface_info.last_received_interface_info, is_container='container', yang_name="last-received-interface-info", parent=self, choice=(u'request-type', u'getnext-request'), path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-port-profile-ext', defining_module='brocade-port-profile-ext', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """last_received_interface_info must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=last_received_interface_info.last_received_interface_info, is_container='container', yang_name="last-received-interface-info", parent=self, choice=(u'request-type', u'getnext-request'), path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-port-profile-ext', defining_module='brocade-port-profile-ext', yang_type='container', is_config=True)""",
        })

    self.__last_received_interface_info = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_last_received_interface_info(self):
    self.__last_received_interface_info = YANGDynClass(base=last_received_interface_info.last_received_interface_info, is_container='container', yang_name="last-received-interface-info", parent=self, choice=(u'request-type', u'getnext-request'), path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-port-profile-ext', defining_module='brocade-port-profile-ext', yang_type='container', is_config=True)
  ...
  last_received_interface_info = __builtin__.property(_get_last_received_interface_info, _set_last_received_interface_info)

  __choices__ = {u'request-type': {u'getnext-request': [u'last_received_interface_info'], u'get-request': [u'interface_type', u'interface_name']}}
  _pyangbind_elements = {'rbridge_id': rbridge_id, 'interface_type': interface_type, 'interface_name': interface_name, 'last_received_interface_info': last_received_interface_info, }
