...
class chassis(PybindBase):
  ...
  from YANG module brocade-chassis - based on the path /chassis. Each member element of
  ...
  def _get_fan(self):
    """
    Getter method for fan, mapped from YANG variable /chassis/fan (container)
    """
    return self.__fan
      
  def _set_fan(self, v, load=False):
    """
    Setter method for fan, mapped from YANG variable /chassis/fan (container)
