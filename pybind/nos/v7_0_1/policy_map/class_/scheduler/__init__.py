...
class scheduler(PybindBase):
  ...
  from YANG module brocade-policer - based on the path /policy-map/class/scheduler. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__strict_priority',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__strict_priority = YANGDynClass(base=strict_priority.strict_priority, is_container='container', yang_name="strict-priority", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'info': u'Configure Strict Priority Queues', u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-policer', defining_module='brocade-policer', yang_type='container', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'policy-map', u'class', u'scheduler']
  ...
  def _get_strict_priority(self):
    """
    Getter method for strict_priority, mapped from YANG variable /policy_map/class/scheduler/strict_priority (container)
    """
    return self.__strict_priority
      
  def _set_strict_priority(self, v, load=False):
    """
    Setter method for strict_priority, mapped from YANG variable /policy_map/class/scheduler/strict_priority (container)
