...
class set_(PybindBase):
  ...
  from YANG module brocade-policer - based on the path /policy-map/class/set. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__set_cos_tc','__set_dscp',)
  ...
  def _set_set_dscp(self, v, load=False):
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=set_dscp.set_dscp, is_container='container', yang_name="set_dscp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Differentiated Services Code Point', u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-policer', defining_module='brocade-policer', yang_type='container', is_config=True)""",
        })
