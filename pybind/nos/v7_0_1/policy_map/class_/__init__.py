...
class class_(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__cl_name','__police','__set_','__span','__map_','__shape','__scheduler','__priority_mapping_table',)
