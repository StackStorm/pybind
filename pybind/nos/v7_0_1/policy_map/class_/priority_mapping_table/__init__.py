...
import __builtin__
import import_
class priority_mapping_table(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-policer - based on the path /policy-map/class/priority-mapping-table. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__import_',)

  _yang_name = 'priority-mapping-table'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'policy-map', u'class', u'priority-mapping-table']
  ...
  def _get_import_(self):
    """
    Getter method for import_, mapped from YANG variable /policy_map/class/priority_mapping_table/import (container)
    """
    return self.__import_
      
  def _set_import_(self, v, load=False):
    """
    Setter method for import_, mapped from YANG variable /policy_map/class/priority_mapping_table/import (container)
  ...
  _pyangbind_elements = {'import_': import_, }
