...
class output(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__show_fibrechannel_interface',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__show_fibrechannel_interface = YANGDynClass(base=YANGListType("portsgroup_rbridgeid",show_fibrechannel_interface.show_fibrechannel_interface, yang_name="show-fibrechannel-interface", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='portsgroup-rbridgeid', extensions=None), is_container='list', yang_name="show-fibrechannel-interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-fabric-service', defining_module='brocade-fabric-service', yang_type='list', is_config=True)
