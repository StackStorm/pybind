...
class interface(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__tengigabitethernet_rmm','__gigabitethernet_rmm','__fortygigabitethernet_rmm','__hundredgigabitethernet_rmm','__port_channel_rmm','__vlan_rmm','__loopback','__ve',)
