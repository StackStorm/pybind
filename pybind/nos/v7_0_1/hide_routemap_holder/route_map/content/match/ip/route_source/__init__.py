...
class route_source(PybindBase):
  ...
  from YANG module brocade-ip-policy - based on the path /hide-routemap-holder/route-map/content/match/ip/route-source. Each member element of
  ...
  def _get_prefix_list_rmrs(self):
    """
    Getter method for prefix_list_rmrs, mapped from YANG variable /hide_routemap_holder/route_map/content/match/ip/route_source/prefix_list_rmrs (string)

    YANG Description: IP prefix-list
    """
    return self.__prefix_list_rmrs
      
  def _set_prefix_list_rmrs(self, v, load=False):
    """
    Setter method for prefix_list_rmrs, mapped from YANG variable /hide_routemap_holder/route_map/content/match/ip/route_source/prefix_list_rmrs (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_prefix_list_rmrs is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_prefix_list_rmrs() directly.
  ...
  _pyangbind_elements = {'prefix_list_rmrs': prefix_list_rmrs, }
