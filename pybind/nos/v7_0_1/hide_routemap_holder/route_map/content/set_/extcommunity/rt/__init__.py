...
class rt(PybindBase):
  ...
  from YANG module brocade-ip-policy - based on the path /hide-routemap-holder/route-map/content/set/extcommunity/rt. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Route Target extended community
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__ASN_NN_rt',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'hide-routemap-holder', u'route-map', u'content', u'set', u'extcommunity', u'rt']
  ...
  def _get_ASN_NN_rt(self):
    """
    Getter method for ASN_NN_rt, mapped from YANG variable /hide_routemap_holder/route_map/content/set/extcommunity/rt/ASN_NN_rt (ext-community-rt-expr-t)
    """
    return self.__ASN_NN_rt
      
  def _set_ASN_NN_rt(self, v, load=False):
    """
    Setter method for ASN_NN_rt, mapped from YANG variable /hide_routemap_holder/route_map/content/set/extcommunity/rt/ASN_NN_rt (ext-community-rt-expr-t)
