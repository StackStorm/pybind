...
class next_vrf_list(PybindBase):
  ...
  from YANG module brocade-ip-policy - based on the path /hide-routemap-holder/route-map/content/set/ipv6/next-vrf/next-vrf-list. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'hide-routemap-holder', u'route-map', u'content', u'set', u'ipv6', u'next-vrf', u'next-vrf-list']
  ...
  def _get_vrf(self):
    """
    Getter method for vrf, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ipv6/next_vrf/next_vrf_list/vrf (string)
    """
    return self.__vrf
      
  def _set_vrf(self, v, load=False):
    """
    Setter method for vrf, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ipv6/next_vrf/next_vrf_list/vrf (string)
  ...
  def _get_next_hop(self):
    """
    Getter method for next_hop, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ipv6/next_vrf/next_vrf_list/next_hop (inet:ipv6-address)
    """
    return self.__next_hop
      
  def _set_next_hop(self, v, load=False):
    """
    Setter method for next_hop, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ipv6/next_vrf/next_vrf_list/next_hop (inet:ipv6-address)
    If this variable is read-only (config: false) in the
