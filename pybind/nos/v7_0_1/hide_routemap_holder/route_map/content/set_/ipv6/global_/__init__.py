...
class global_(PybindBase):
  ...
  from YANG module brocade-ip-policy - based on the path /hide-routemap-holder/route-map/content/set/ipv6/global. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Next hop Global IPV6 address.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__next_global_hop',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'hide-routemap-holder', u'route-map', u'content', u'set', u'ipv6', u'global']
  ...
  def _get_next_global_hop(self):
    """
    Getter method for next_global_hop, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ipv6/global/next_global_hop (list)
    """
    return self.__next_global_hop
      
  def _set_next_global_hop(self, v, load=False):
    """
    Setter method for next_global_hop, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ipv6/global/next_global_hop (list)
