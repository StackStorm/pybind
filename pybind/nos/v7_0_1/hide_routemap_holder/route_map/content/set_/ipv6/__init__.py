...
class ipv6(PybindBase):
  ...
  from YANG module brocade-ip-policy - based on the path /hide-routemap-holder/route-map/content/set/ipv6. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Internet Protocol (IPv6).
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__interface','__global_','__next_ip','__next_vrf',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'hide-routemap-holder', u'route-map', u'content', u'set', u'ipv6']
  ...
  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ipv6/interface (container)
  ...
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ipv6/interface (container)
  ...
  def _get_global_(self):
    """
    Getter method for global_, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ipv6/global (container)
  ...
  def _set_global_(self, v, load=False):
    """
    Setter method for global_, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ipv6/global (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_next_ip(self):
    """
    Getter method for next_ip, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ipv6/next_ip (container)
    """
    return self.__next_ip
      
  def _set_next_ip(self, v, load=False):
    """
    Setter method for next_ip, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ipv6/next_ip (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_next_vrf(self):
    """
    Getter method for next_vrf, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ipv6/next_vrf (container)
    """
    return self.__next_vrf
      
  def _set_next_vrf(self, v, load=False):
    """
    Setter method for next_vrf, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ipv6/next_vrf (container)
    If this variable is read-only (config: false) in the
