...
class local_preference(PybindBase):
  ...
  from YANG module brocade-ip-policy - based on the path /hide-routemap-holder/route-map/content/set/local-preference. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: BGP local preference path attribute
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__local_preference_value',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'hide-routemap-holder', u'route-map', u'content', u'set', u'local-preference']
  ...
  def _get_local_preference_value(self):
    """
    Getter method for local_preference_value, mapped from YANG variable /hide_routemap_holder/route_map/content/set/local_preference/local_preference_value (uint32)
    """
    return self.__local_preference_value
      
  def _set_local_preference_value(self, v, load=False):
    """
    Setter method for local_preference_value, mapped from YANG variable /hide_routemap_holder/route_map/content/set/local_preference/local_preference_value (uint32)
