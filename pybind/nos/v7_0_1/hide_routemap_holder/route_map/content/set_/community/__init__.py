...
class community(PybindBase):
  ...
  from YANG module brocade-ip-policy - based on the path /hide-routemap-holder/route-map/content/set/community. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__set_community_expr',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'hide-routemap-holder', u'route-map', u'content', u'set', u'community']
  ...
  def _get_set_community_expr(self):
    """
    Getter method for set_community_expr, mapped from YANG variable /hide_routemap_holder/route_map/content/set/community/set_community_expr (set-community-expr-t)
    """
    return self.__set_community_expr
      
  def _set_set_community_expr(self, v, load=False):
    """
    Setter method for set_community_expr, mapped from YANG variable /hide_routemap_holder/route_map/content/set/community/set_community_expr (set-community-expr-t)
