...
class distance(PybindBase):
  ...
  from YANG module brocade-ip-policy - based on the path /hide-routemap-holder/route-map/content/set/distance. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Distance
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__dist_rms',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'hide-routemap-holder', u'route-map', u'content', u'set', u'distance']
  ...
  def _get_dist_rms(self):
    """
    Getter method for dist_rms, mapped from YANG variable /hide_routemap_holder/route_map/content/set/distance/dist_rms (distance-t)
    """
    return self.__dist_rms
      
  def _set_dist_rms(self, v, load=False):
    """
    Setter method for dist_rms, mapped from YANG variable /hide_routemap_holder/route_map/content/set/distance/dist_rms (distance-t)
