...
class ip(PybindBase):
  ...
  from YANG module brocade-ip-policy - based on the path /hide-routemap-holder/route-map/content/set/ip. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Internet Protocol (IP).
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__dscp','__interface','__next_hop','__global_','__next_ip','__next_vrf',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'hide-routemap-holder', u'route-map', u'content', u'set', u'ip']
  ...
  def _get_dscp(self):
    """
    Getter method for dscp, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ip/dscp (container)
  ...
  def _set_dscp(self, v, load=False):
    """
    Setter method for dscp, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ip/dscp (container)
  ...
  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ip/interface (container)
  ...
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ip/interface (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_next_hop(self):
    """
    Getter method for next_hop, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ip/next_hop (container)
  ...
  def _set_next_hop(self, v, load=False):
    """
    Setter method for next_hop, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ip/next_hop (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_global_(self):
    """
    Getter method for global_, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ip/global (container)
  ...
  def _set_global_(self, v, load=False):
    """
    Setter method for global_, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ip/global (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_next_ip(self):
    """
    Getter method for next_ip, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ip/next_ip (container)
    """
    return self.__next_ip
      
  def _set_next_ip(self, v, load=False):
    """
    Setter method for next_ip, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ip/next_ip (container)
    If this variable is read-only (config: false) in the
    ...
    """
    try:
      t = YANGDynClass(v,base=next_ip.next_ip, is_container='container', yang_name="next-ip", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """next_ip must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=next_ip.next_ip, is_container='container', yang_name="next-ip", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='container', is_config=True)""",
        })
  ...
  def _get_next_vrf(self):
    """
    Getter method for next_vrf, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ip/next_vrf (container)
    """
    return self.__next_vrf
      
  def _set_next_vrf(self, v, load=False):
    """
    Setter method for next_vrf, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ip/next_vrf (container)
    If this variable is read-only (config: false) in the
