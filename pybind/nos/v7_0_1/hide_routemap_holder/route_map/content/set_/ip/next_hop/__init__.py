...
class next_hop(PybindBase):
  ...
  from YANG module brocade-ip-policy - based on the path /hide-routemap-holder/route-map/content/set/ip/next-hop. Each member element of
  ...
  def _get_peer_address(self):
    """
    Getter method for peer_address, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ip/next_hop/peer_address (empty)
  ...
  def _set_peer_address(self, v, load=False):
    """
    Setter method for peer_address, mapped from YANG variable /hide_routemap_holder/route_map/content/set/ip/next_hop/peer_address (empty)
  ...
  _pyangbind_elements = {'peer_address': peer_address, }
