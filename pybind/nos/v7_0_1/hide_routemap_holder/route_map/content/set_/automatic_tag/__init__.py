...
import __builtin__
class automatic_tag(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-ip-policy - based on the path /hide-routemap-holder/route-map/content/set/automatic-tag. Each member element of
  ...
  def _get_tag_empty(self):
    """
    Getter method for tag_empty, mapped from YANG variable /hide_routemap_holder/route_map/content/set/automatic_tag/tag_empty (empty)
    """
    return self.__tag_empty
      
  def _set_tag_empty(self, v, load=False):
    """
    Setter method for tag_empty, mapped from YANG variable /hide_routemap_holder/route_map/content/set/automatic_tag/tag_empty (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_tag_empty is considered as a private
  ...
  _pyangbind_elements = {'tag_empty': tag_empty, }
