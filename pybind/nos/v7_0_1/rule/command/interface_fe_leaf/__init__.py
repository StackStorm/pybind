...
import __builtin__
import interface
class interface_fe_leaf(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-aaa - based on the path /rule/command/interface-fe-leaf. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__interface',)

  _yang_name = 'interface-fe-leaf'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rule', u'command', u'interface-fe-leaf']
  ...
  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /rule/command/interface_fe_leaf/interface (container)
    """
    return self.__interface
      
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /rule/command/interface_fe_leaf/interface (container)
  ...
  __choices__ = {u'cmdlist': {u'interface-u': [u'interface']}}
