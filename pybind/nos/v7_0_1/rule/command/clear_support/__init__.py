...
import __builtin__
import clear
class clear_support(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-aaa - based on the path /rule/command/clear-support. Each member element of
  ...
  def _get_clear(self):
    """
    Getter method for clear, mapped from YANG variable /rule/command/clear_support/clear (container)
    """
    return self.__clear
      
  def _set_clear(self, v, load=False):
    """
    Setter method for clear, mapped from YANG variable /rule/command/clear_support/clear (container)
  ...
  __choices__ = {u'cmdlist': {u'clear-c': [u'clear']}}
