...
class egress(PybindBase):
  ...
  from YANG module brocade-trilloam - based on the path /brocade_trilloam_rpc/l2traceroute-result/output/l2-hop-results/l2-hop/egress. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_trilloam_rpc', u'l2traceroute-result', u'output', u'l2-hop-results', u'l2-hop', u'egress']
  ...
  def _rest_path(self):
    ...
    if hasattr(self, "_parent"):
      ...
      return [u'l2traceroute-result', u'output', u'l2-hop-results', u'l2-hop', u'egress']

  def _get_interface_type(self):
    """
    Getter method for interface_type, mapped from YANG variable /brocade_trilloam_rpc/l2traceroute_result/output/l2_hop_results/l2_hop/egress/interface_type (enumeration)
...
represents error scenario and should not be used.
  ...
  def _set_interface_type(self, v, load=False):
    """
    Setter method for interface_type, mapped from YANG variable /brocade_trilloam_rpc/l2traceroute_result/output/l2_hop_results/l2_hop/egress/interface_type (enumeration)
...
represents error scenario and should not be used.
  ...
  def _get_interface_name(self):
    """
    Getter method for interface_name, mapped from YANG variable /brocade_trilloam_rpc/l2traceroute_result/output/l2_hop_results/l2_hop/egress/interface_name (union)
...
'interface-type' must fail with an error.
  ...
  def _set_interface_name(self, v, load=False):
    """
    Setter method for interface_name, mapped from YANG variable /brocade_trilloam_rpc/l2traceroute_result/output/l2_hop_results/l2_hop/egress/interface_name (union)
    If this variable is read-only (config: false) in the
