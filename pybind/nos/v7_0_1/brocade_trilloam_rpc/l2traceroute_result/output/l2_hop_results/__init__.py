...
import __builtin__
import l2_hop
class l2_hop_results(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-trilloam - based on the path /brocade_trilloam_rpc/l2traceroute-result/output/l2-hop-results. Each member element of
  ...
  def _get_l2_hop(self):
    """
    Getter method for l2_hop, mapped from YANG variable /brocade_trilloam_rpc/l2traceroute_result/output/l2_hop_results/l2_hop (container)
    """
    return self.__l2_hop
      
  def _set_l2_hop(self, v, load=False):
    """
    Setter method for l2_hop, mapped from YANG variable /brocade_trilloam_rpc/l2traceroute_result/output/l2_hop_results/l2_hop (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_l2_hop is considered as a private
  ...
  _pyangbind_elements = {'l2_hop': l2_hop, }
