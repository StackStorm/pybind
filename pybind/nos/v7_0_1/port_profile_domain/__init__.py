...
import __builtin__
import profile
class port_profile_domain(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-port-profile - based on the path /port-profile-domain. Each member element of
  ...
  def _get_port_profile_domain_name(self):
    """
    Getter method for port_profile_domain_name, mapped from YANG variable /port_profile_domain/port_profile_domain_name (port-profile-domain-name-type)
    """
    return self.__port_profile_domain_name
      
  def _set_port_profile_domain_name(self, v, load=False):
    """
    Setter method for port_profile_domain_name, mapped from YANG variable /port_profile_domain/port_profile_domain_name (port-profile-domain-name-type)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_port_profile_domain_name is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_port_profile_domain_name() directly.
    """
  ...
  def _get_profile(self):
    """
    Getter method for profile, mapped from YANG variable /port_profile_domain/profile (list)
    """
    return self.__profile
      
  def _set_profile(self, v, load=False):
    """
    Setter method for profile, mapped from YANG variable /port_profile_domain/profile (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'port_profile_domain_name': port_profile_domain_name, 'profile': profile, }
