...
import alias
import user
class alias_config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-aaa - based on the path /alias-config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__alias','__user',)

  _yang_name = 'alias-config'
  ...
  def _get_alias(self):
    """
    Getter method for alias, mapped from YANG variable /alias_config/alias (list)
    """
    return self.__alias
      
  def _set_alias(self, v, load=False):
    """
    Setter method for alias, mapped from YANG variable /alias_config/alias (list)
  ...
  def _get_user(self):
    """
    Getter method for user, mapped from YANG variable /alias_config/user (list)
    """
    return self.__user
      
  def _set_user(self, v, load=False):
    """
    Setter method for user, mapped from YANG variable /alias_config/user (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'alias': alias, 'user': user, }
