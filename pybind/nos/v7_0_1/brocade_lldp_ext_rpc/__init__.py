...
import __builtin__
import get_lldp_neighbor_detail
class brocade_lldp_ext(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-lldp-ext - based on the path /brocade_lldp_ext_rpc. Each member element of
 ...
 - Defining RPCs to retrieve lldp neighbors 
  ...
  def _get_get_lldp_neighbor_detail(self):
    """
    Getter method for get_lldp_neighbor_detail, mapped from YANG variable /brocade_lldp_ext_rpc/get_lldp_neighbor_detail (rpc)
...
details of all the interfaces of the managed entity.
    """
    return self.__get_lldp_neighbor_detail
      
  def _set_get_lldp_neighbor_detail(self, v, load=False):
    """
    Setter method for get_lldp_neighbor_detail, mapped from YANG variable /brocade_lldp_ext_rpc/get_lldp_neighbor_detail (rpc)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_get_lldp_neighbor_detail is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_get_lldp_neighbor_detail() directly.
...
details of all the interfaces of the managed entity.
  ...
  _pyangbind_elements = {'get_lldp_neighbor_detail': get_lldp_neighbor_detail, }
