...
import __builtin__
class autoupload(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-ras - based on the path /support/autoupload. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__enable',)

  _yang_name = 'autoupload'
  _rest_name = 'autoupload'
  ...
  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /support/autoupload/enable (empty)
    """
    return self.__enable
      
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /support/autoupload/enable (empty)
