...
class enable(PybindBase):
  ...
  from YANG module brocade-tunnels - based on the path /overlay-gateway/enable. Each member element of
  ...
  def _get_statistics(self):
    """
    Getter method for statistics, mapped from YANG variable /overlay_gateway/enable/statistics (container)
    """
    return self.__statistics
      
  def _set_statistics(self, v, load=False):
    """
    Setter method for statistics, mapped from YANG variable /overlay_gateway/enable/statistics (container)
  ...
  _pyangbind_elements = {'statistics': statistics, }
