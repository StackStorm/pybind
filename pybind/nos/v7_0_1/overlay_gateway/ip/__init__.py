...
class ip(PybindBase):
  ...
  from YANG module brocade-tunnels - based on the path /overlay-gateway/ip. Each member element of
  ...
  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /overlay_gateway/ip/interface (container)
    """
    return self.__interface
      
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /overlay_gateway/ip/interface (container)
