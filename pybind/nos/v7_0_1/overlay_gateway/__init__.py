...
class overlay_gateway(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__gw_type = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'nsx': {'value': 3}, u'hardware-vtep': {'value': 1}, u'layer2-extension': {'value': 2}},), is_leaf=True, yang_name="gw-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure the type of Overlay Gateway.', u'alt-name': u'type', u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-tunnels', defining_module='brocade-tunnels', yang_type='overlay-gw-type', is_config=True)
  ...
  def _set_gw_type(self, v, load=False):
    ...
    """
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'nsx': {'value': 3}, u'hardware-vtep': {'value': 1}, u'layer2-extension': {'value': 2}},), is_leaf=True, yang_name="gw-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure the type of Overlay Gateway.', u'alt-name': u'type', u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-tunnels', defining_module='brocade-tunnels', yang_type='overlay-gw-type', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """gw_type must be of a type compatible with overlay-gw-type""",
          'defined-type': "brocade-tunnels:overlay-gw-type",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'nsx': {'value': 3}, u'hardware-vtep': {'value': 1}, u'layer2-extension': {'value': 2}},), is_leaf=True, yang_name="gw-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure the type of Overlay Gateway.', u'alt-name': u'type', u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-tunnels', defining_module='brocade-tunnels', yang_type='overlay-gw-type', is_config=True)""",
        })
  ...
  def _get_attach(self):
    """
    Getter method for attach, mapped from YANG variable /overlay_gateway/attach (container)
    """
    return self.__attach
      
  def _set_attach(self, v, load=False):
    """
    Setter method for attach, mapped from YANG variable /overlay_gateway/attach (container)
    If this variable is read-only (config: false) in the
...
setup. Site is identified by a name.
  ...
  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /overlay_gateway/enable (container)
    """
    return self.__enable
      
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /overlay_gateway/enable (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_monitor(self):
    """
    Getter method for monitor, mapped from YANG variable /overlay_gateway/monitor (list)
    """
  ...
  def _get_sflow(self):
    """
    Getter method for sflow, mapped from YANG variable /overlay_gateway/sflow (list)
    """
    return self.__sflow
...
associated tunnels will also be inactive (oper down).
  ...
  _pyangbind_elements = {'name': name, 'gw_type': gw_type, 'ip': ip, 'attach': attach, 'map_': map_, 'site': site, 'enable': enable, 'monitor': monitor, 'sflow': sflow, 'access_lists': access_lists, 'activate': activate, }
