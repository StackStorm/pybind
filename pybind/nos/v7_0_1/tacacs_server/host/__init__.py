...
class host(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__hostname','__use_vrf','__port','__protocol','__key','__encryption_level','__retries','__timeout',)
