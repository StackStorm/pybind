...
class input(PybindBase):
  ...
  from YANG module brocade-nameserver - based on the path /brocade_nameserver_rpc/get-nameserver-detail/input. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_nameserver_rpc', u'get-nameserver-detail', u'input']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'get-nameserver-detail', u'input']

  def _get_rbridge_id(self):
    """
    Getter method for rbridge_id, mapped from YANG variable /brocade_nameserver_rpc/get_nameserver_detail/input/rbridge_id (common-def:rbridge-id-type)

    YANG Description: This specifies the rbridge-id of switch to
retrieve information from.
  ...
  def _set_rbridge_id(self, v, load=False):
    """
    Setter method for rbridge_id, mapped from YANG variable /brocade_nameserver_rpc/get_nameserver_detail/input/rbridge_id (common-def:rbridge-id-type)
