...
import __builtin__
import use_vrf
class ssh_vrf_cont(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-sec-services - based on the path /ssh-sa/ssh/server/ssh-vrf-cont. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__use_vrf',)

  _yang_name = 'ssh-vrf-cont'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'ssh-sa', u'ssh', u'server', u'ssh-vrf-cont']
  ...
  def _get_use_vrf(self):
    """
    Getter method for use_vrf, mapped from YANG variable /ssh_sa/ssh/server/ssh_vrf_cont/use_vrf (list)
    """
    return self.__use_vrf
      
  def _set_use_vrf(self, v, load=False):
    """
    Setter method for use_vrf, mapped from YANG variable /ssh_sa/ssh/server/ssh_vrf_cont/use_vrf (list)
